...
class CustomNormaliser(StainNormaliser):
    ...
    Examples:
        >>> from tiatoolbox.tools.stain_norm import CustomNormaliser
...
class RuifrokNormaliser(StainNormaliser):
    ...
    Examples:
        >>> from tiatoolbox.tools.stain_norm import RuifrokNormaliser
...
class MacenkoNormaliser(StainNormaliser):
    ...
    Examples:
        >>> from tiatoolbox.tools.stain_norm import MacenkoNormaliser
...
class VahadaneNormaliser(StainNormaliser):
    ...
    Examples:
        >>> from tiatoolbox.tools.stain_norm import VahadaneNormaliser
...
class ReinhardNormaliser:
    ...
    Examples:
        >>> from tiatoolbox.tools.stain_norm import ReinhardNormaliser
