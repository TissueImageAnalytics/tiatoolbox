...
from tiatoolbox.tools.registration.wsi_registration import Registration, RegistrationParameters
...
def main():
	...
	pre_alignment, dfbr_refinement = Registration.run_registration(target_wsi_path, source_wsi_path, params)
	print(pre_alignment)
