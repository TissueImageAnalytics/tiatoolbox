...
//#endregion
//#region src/main_legacy.js
var gd = document.getElementById("map");
if (gd === null) throw Error("The OpenLayers map element could not be found.");
var _d = JSON.parse(gd.dataset.layers ?? "[]");
if (_d.length === 0) throw Error("No layers were supplied to the OpenLayers viewer.");
var vd = _d.map((e) => {
	let t = new ru({
		url: e.url,
		size: e.size,
...
}), yd = vd[0].getSource(), bd = yd.getTileGrid(), xd = bd.getResolutions(), Sd = bd.getExtent(), Cd = new He({
	code: "ZoomifyProjection",
	units: "pixels",
	extent: Sd,
	metersPerUnit: _d[0].mpp * 1e-6,
...
var Md = 64, Nd = 64, Pd = new ws({
...
}), Id = Md, Ld = Nd, Rd = new su({
	projection: Cd.getCode(),
	spacing: Id,
	margin: Ld,
	style: Pd,
	formatCoord(e, t) {
		let n = Td.getView().calculateExtent(Td.getSize()), r = Td.getView().getResolution(), i = n[0] + r * Ld, a = n[3] - r * Ld, o;
		if (o = t === "left" || t === "right" ? -(e - a) : e - i, o = Math.floor(o / r / Id), t === "left" || t === "right") {
			let e = "";
			do
	...
	onToggle(e) {
		e ? (Bd.setActive(!1), Rd.setMap(null), Fd.setMap(Td)) : Fd.setMap(null);
	}
}), Bd;
Td.addControl(zd), Bd = new hd({
	html: "<i class=\"fas fa-border-all\"></i>",
	className: "ol-screen-space-graticule",
	title: "Toggle Screen Space Graticule",
	onToggle(e) {
		e ? (zd.setActive(!1), Fd.setMap(null), Rd.setMap(Td)) : Rd.setMap(null);
	}
}), Td.addControl(Bd), Td.getView().fit(Sd), Object.assign(window, {
	extent: Sd,
	fullscreen: Ad,
	graticule: Fd,
	graticuleToggle: zd,
	...
	layersData: _d,
	map: Td,
	mousePositionControl: Od,
	overviewMapControl: Dd,
	projection: Cd,
	resolutions: xd,
	rotate: kd,
	scaleLineControl: Ed,
	screenSpaceGraticule: Rd,
	screenSpaceGraticuleToggle: Bd,
	view: wd
});
//#endregion
