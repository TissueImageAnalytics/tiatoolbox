...
function Kg(e) {
	...
	Ng.disabled = !0, Pg.disabled = !0, Lg.disabled = !0, Rg.disabled = !0;
}
...
}), Pg.addEventListener("change", async (e) => {
	let t = e.detail ?? Pg.value;
	if (t !== "") {
		Kg(!0);
		try {
			await pv(t), Pg.value = "";
