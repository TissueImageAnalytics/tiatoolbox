...
var ui = Kr(), di = [NaN, NaN], fi = class extends we {
	constructor() {
	...
	containsXY(e, t) {
		return this.closestPointXY(e, t, di, Number.MIN_VALUE) === 0;
	}
	getClosestPoint(e, t) {
	...
	transform(e, t) {
		let n = nr(e), r = n.getUnits() == "tile-pixels" ? function(e, r, i) {
			...
			$r(ui, o[0], o[3], s, -s, 0, 0, 0);
			let c = oi(e, 0, e.length, i, ui, r), l = dr(n, t);
			return l ? l(c, c, i) : c;
		} : dr(n, t);
	...
	setFlatCoordinates(e, t) {
		this.stride = hi(e), this.layout = e, this.flatCoordinates = t;
	}
	setCoordinates(e, t) {
		P();
	}
	...
	rotate(e, t) {
		...
		if (n) {
			...
			si(n, 0, n.length, r, e, t, n), this.changed();
		}
	}
	scale(e, t, n) {
		...
		if (r) {
			...
			ci(r, 0, r.length, i, e, t, n, r), this.changed();
		}
	}
	translate(e, t) {
		let n = this.getFlatCoordinates();
...
function Si(e, t, n, r, i, a, o, s, c, l, u) {
	...
	u ||= [NaN, NaN];
	let p = t + r;
	for (; p < n;) if (yi(e, p - r, p, r, o, s, u), f = wt(o, s, u[0], u[1]), f < l) {
		for (l = f, d = 0; d < r; ++d) c[d] = u[d];
		c.length = r, p += r;
	} else p += r * Math.max((Math.sqrt(f) - Math.sqrt(l)) / i | 0, 1);
	if (a && (yi(e, n - r, t, r, o, s, u), f = wt(o, s, u[0], u[1]), f < l)) {
		for (l = f, d = 0; d < r; ++d) c[d] = u[d];
		c.length = r;
	}
	return l;
...
function Ci(e, t, n, r, i, a, o, s, c, l, u) {
	...
	for (let d = 0, f = n.length; d < f; ++d) {
		let f = n[d];
		l = Si(e, t, f, r, i, a, o, s, c, l, u), t = f;
	}
	return l;
}
//#endregion
...
function ki(e, t, n, r, i) {
	...
	for (let o = 0, s = n.length; o < s; ++o) {
		let s = n[o];
		i[a++] = s.length === 1 && s[0] === t ? [] : Oi(e, t, s, r, i[a]), t = s[s.length - 1];
	}
	return i.length = a, i;
}
//#endregion
...
function Mi(e, t, n, r, i, a) {
	if (n.length === 0 || !ji(e, t, n[0], r, i, a)) return !1;
	for (let t = 1, o = n.length; t < o; ++t) if (ji(e, n[t - 1], n[t], r, i, a)) return !1;
	return !0;
}
//#endregion
...
function Pi(e, t, n, r, i, a) {
	return a ??= Qe(We(), e, t, n, r), pt(i, a) ? a[0] >= i[0] && a[2] <= i[2] || a[1] >= i[1] && a[3] <= i[3] || Ni(e, t, n, r, function(e, t) {
		return _t(i, e, t);
	}) : !1;
}
function Fi(e, t, n, r, i) {
	return !!(Pi(e, t, n, r, i) || ji(e, t, n, r, i[0], i[1]) || ji(e, t, n, r, i[0], i[3]) || ji(e, t, n, r, i[2], i[1]) || ji(e, t, n, r, i[2], i[3]));
}
function Ii(e, t, n, r, i) {
	if (!Fi(e, t, n[0], r, i)) return !1;
	if (n.length === 1) return !0;
	for (let t = 1, a = n.length; t < a; ++t) if (Ai(e, n[t - 1], n[t], r, i) && !Pi(e, n[t - 1], n[t], r, i)) return !1;
	return !0;
}
//#endregion
...
function Ri(e, t, n, r, i, a, o, s) {
	for (let c = 0, l = n.length; c < l; ++c) {
		let l = n[c];
		o = Li(e, t, l, r, i, a, o), s.push(o), t = l;
	}
	return o;
}
function zi(e, t) {
...
function Bi(e, t, n, r, i, a, o) {
	if (t == n) return o;
	let s = zi(e[t], i), c = zi(e[t + 1], i);
	t += r, a[o++] = s, a[o++] = c;
	let l, u;
	do
		if (l = zi(e[t], i), u = zi(e[t + 1], i), t += r, t == n) return a[o++] = l, a[o++] = u, o;
	while (l == s && u == c);
	for (; t < n;) {
		let n = zi(e[t], i), d = zi(e[t + 1], i);
...
function Vi(e, t, n, r, i, a, o, s) {
	for (let c = 0, l = n.length; c < l; ++c) {
		let l = n[c];
		o = Bi(e, t, l, r, i, a, o), s.push(o), t = l;
	}
	return o;
}
//#endregion
//#region node_modules/ol/geom/LinearRing.js
var Hi = class e extends pi {
	constructor(e, t) {
	...
	closestPointXY(e, t, n, r) {
		return r < ze(this.getExtent(), e, t) ? r : (this.maxDeltaRevision_ != this.getRevision() && (this.maxDelta_ = Math.sqrt(bi(this.flatCoordinates, 0, this.flatCoordinates.length, this.stride, 0)), this.maxDeltaRevision_ = this.getRevision()), Si(this.flatCoordinates, 0, this.flatCoordinates.length, this.stride, this.maxDelta_, !0, e, t, n, r));
	}
	getArea() {
	...
	getSimplifiedGeometryInternal(t) {
		let n = [];
		return n.length = Li(this.flatCoordinates, 0, this.flatCoordinates.length, this.stride, t, n, 0), new e(n, "XY");
	}
	getType() {
		return "LinearRing";
	}
	intersectsExtent(e) {
		return Pi(this.flatCoordinates, 0, this.flatCoordinates.length, this.stride, e);
	}
	setCoordinates(e, t) {
		this.setLayout(t, e, 1), this.flatCoordinates ||= [], this.flatCoordinates.length = Ti(this.flatCoordinates, 0, e, this.stride), this.changed();
	}
}, Ui = class e extends pi {
	constructor(e, t) {
	...
	setCoordinates(e, t) {
		this.setLayout(t, e, 0), this.flatCoordinates ||= [], this.flatCoordinates.length = wi(this.flatCoordinates, 0, e, this.stride), this.changed();
	}
};
//#endregion
...
function Wi(e, t, n, r, i, a, o) {
	...
	for (h.sort(oe), u = h[0], s = 1, c = h.length; s < c; ++s) {
		d = h[s];
		let i = Math.abs(d - u);
		i > _ && (l = (u + d) / 2, Mi(e, t, n, r, l, m) && (g = l, _ = i)), u = d;
	}
...
function Gi(e, t, n, r, i) {
	...
	for (let o = 0, s = n.length; o < s; ++o) {
		let s = n[o];
		a = Wi(e, t, s, r, i, 2 * o, a), t = s[s.length - 1];
	}
	return a;
}
//#endregion
...
function Yi(e, t, n, r, i) {
	...
	for (let a = 0, o = n.length; a < o; ++a) {
		let o = n[a], s = qi(e, t, o, r);
		(a === 0 ? i && s || !i && !s : i && !s || !i && s) && Ki(e, t, o, r), t = o;
	}
	return t;
}
function Xi(e, t) {
...
var Zi = class e extends pi {
	...
	closestPointXY(e, t, n, r) {
		return r < ze(this.getExtent(), e, t) ? r : (this.maxDeltaRevision_ != this.getRevision() && (this.maxDelta_ = Math.sqrt(xi(this.flatCoordinates, 0, this.ends_, this.stride, 0)), this.maxDeltaRevision_ = this.getRevision()), Ci(this.flatCoordinates, 0, this.ends_, this.stride, this.maxDelta_, !0, e, t, n, r));
	}
	containsXY(e, t) {
		return Mi(this.getOrientedFlatCoordinates(), 0, this.ends_, this.stride, e, t);
	}
	getArea() {
		return vi(this.getOrientedFlatCoordinates(), 0, this.ends_, this.stride);
	}
	getCoordinates(e) {
		let t;
		return e === void 0 ? t = this.flatCoordinates : (t = this.getOrientedFlatCoordinates().slice(), Yi(t, 0, this.ends_, this.stride, e)), Oi(t, 0, this.ends_, this.stride);
	}
	getEnds() {
		return this.ends_;
	}
	getFlatInteriorPoint() {
		if (this.flatInteriorPointRevision_ != this.getRevision()) {
			...
			this.flatInteriorPoint_ = Wi(this.getOrientedFlatCoordinates(), 0, this.ends_, this.stride, e, 0), this.flatInteriorPointRevision_ = this.getRevision();
		}
		return this.flatInteriorPoint_;
	}
	getInteriorPoint() {
		return new Ui(this.getFlatInteriorPoint(), "XYM");
	}
	getLinearRingCount() {
		return this.ends_.length;
	}
	getLinearRing(e) {
		return e < 0 || this.ends_.length <= e ? null : new Hi(this.flatCoordinates.slice(e === 0 ? 0 : this.ends_[e - 1], this.ends_[e]), this.layout);
	}
	getLinearRings() {
		let e = this.layout, t = this.flatCoordinates, n = this.ends_, r = [], i = 0;
		for (let a = 0, o = n.length; a < o; ++a) {
			let o = n[a], s = new Hi(t.slice(i, o), e);
			r.push(s), i = o;
		}
		return r;
	}
	getOrientedFlatCoordinates() {
		if (this.orientedRevision_ != this.getRevision()) {
			...
			Ji(e, 0, this.ends_, this.stride) ? this.orientedFlatCoordinates_ = e : (this.orientedFlatCoordinates_ = e.slice(), this.orientedFlatCoordinates_.length = Yi(this.orientedFlatCoordinates_, 0, this.ends_, this.stride)), this.orientedRevision_ = this.getRevision();
		}
		return this.orientedFlatCoordinates_;
	}
	getSimplifiedGeometryInternal(t) {
		let n = [], r = [];
		return n.length = Vi(this.flatCoordinates, 0, this.ends_, this.stride, Math.sqrt(t), n, 0, r), new e(n, "XY", r);
	}
	getType() {
		return "Polygon";
	}
	intersectsExtent(e) {
		return Ii(this.getOrientedFlatCoordinates(), 0, this.ends_, this.stride, e);
	}
	setCoordinates(e, t) {
		this.setLayout(t, e, 2), this.flatCoordinates ||= [];
		let n = Ei(this.flatCoordinates, 0, e, this.stride, this.ends_);
...
function ta(e, t, n, r) {
	return t = t === void 0 || t, (function(i, a, o, s) {
		if (i !== void 0) {
			let c = e[0], l = e[e.length - 1], u = n ? $i(c, n, o, r) : c;
			if (s) return t ? ea(i, u, l) : St(i, l, u);
...
function na(e, t, n, r, i, a) {
	return r = r === void 0 || r, n = n === void 0 ? 0 : n, (function(o, s, c, l) {
		if (o !== void 0) {
			let u = i ? $i(t, i, c, a) : t;
			if (l) return r ? ea(o, u, n) : St(o, n, u);
...
var ca = 0, la = class extends we {
	...
	applyOptions_(e) {
		...
		let r = da(e), i = n.constraint, a = pa(e);
		this.constraints_ = {
			center: r,
			resolution: i,
			rotation: a
	...
	animateInternal(e) {
		...
		for (; r < t; ++r) {
			...
			ma(t) ? t.complete = !0 : i += t.duration, c.push(t);
		}
		this.animations_.push(c), this.setHint(z.ANIMATING, 1), this.updateAnimations_();
	}
	getAnimating() {
		return this.hints_[z.ANIMATING] > 0;
	}
	getInteracting() {
		return this.hints_[z.INTERACTING] > 0;
	}
	cancelAnimations() {
		this.setHint(z.ANIMATING, -this.hints_[z.ANIMATING]);
		let e;
		for (let t = 0, n = this.animations_.length; t < n; ++t) {
			let n = this.animations_[t];
			if (n[0].callback && ua(n[0].callback, !1), !e) for (let t = 0, r = n.length; t < r; ++t) {
				let r = n[t];
				if (!r.complete) {
					e = r.anchor;
					break;
	...
	updateAnimations_() {
		...
		for (let n = this.animations_.length - 1; n >= 0; --n) {
			...
			if (i) {
				this.animations_[n] = null, this.setHint(z.ANIMATING, -1), this.nextCenter_ = null, this.nextResolution_ = NaN, this.nextRotation_ = NaN;
				let e = r[0].callback;
				e && ua(e, !0);
			}
		}
	...
	getState() {
		...
		if (i) {
			...
			r = ha(r, this.getViewportSize_(), [e[0] / 2 + i[3], e[1] / 2 + i[0]], t, n);
		}
		return {
			center: r.slice(0),
	...
	fit(e, t) {
		let n;
		if (R(Array.isArray(e) || typeof e.getSimplifiedGeometry == "function", "Invalid extent or geometry provided as `geometry`"), Array.isArray(e)) R(!mt(e), "Cannot fit empty extent provided as `geometry`"), n = Qi(yr(e, this.getProjection()));
		else if (e.getType() === "Circle") {
			let t = yr(e.getExtent(), this.getProjection());
			n = Qi(t), n.rotate(this.getRotation(), it(t));
		} else {
			let t = hr();
	...
	fitInternal(e, t) {
		...
		t.duration === void 0 ? (this.targetResolution_ = s, this.targetCenter_ = m, this.applyTargetState_(!1, !0), ua(h, !0)) : this.animateInternal({
			resolution: s,
			center: m,
			duration: t.duration,
			easing: t.easing
	...
	centerOnInternal(e, t, n) {
		this.setCenterInternal(ha(e, t, n, this.getResolution(), this.getRotation()));
	}
	calculateCenterShift(e, t, n, r) {
		let i, a = this.padding_;
		if (a && e) {
			let o = this.getViewportSizeMinusPadding_(-n), s = ha(e, r, [o[0] / 2 + a[3], o[1] / 2 + a[0]], t, n);
			i = [e[0] - s[0], e[1] - s[1]];
		}
		return i;
	}
	...
	applyTargetState_(e, t) {
		...
		this.get(Lr.ROTATION) !== r && this.set(Lr.ROTATION, r), this.get(Lr.RESOLUTION) !== a && (this.set(Lr.RESOLUTION, a), this.set("zoom", this.getZoom(), !0)), (!o || !this.get(Lr.CENTER) || !It(this.get(Lr.CENTER), o)) && this.set(Lr.CENTER, o), this.getAnimating() && !e && this.cancelAnimations(), this.cancelAnchor_ = void 0;
	}
	...
	beginInteraction() {
		this.resolveConstraints(0), this.setHint(z.INTERACTING, 1);
	}
	endInteraction(e, t, n) {
		n &&= _r(n, this.getProjection()), this.endInteractionInternal(e, t, n);
	}
	endInteractionInternal(e, t, n) {
		this.getInteracting() && (this.setHint(z.INTERACTING, -1), this.resolveConstraints(e, t, n));
	}
...
function da(e) {
	if (e.extent !== void 0) {
		...
		return Rr(e.extent, e.constrainOnlyCenter, t);
	}
	let t = or(e.projection, "EPSG:3857");
	if (e.multiWorld !== !0 && t.isGlobal()) {
		let e = t.getExtent().slice();
		return e[0] = -Infinity, e[2] = Infinity, Rr(e, !1, !1);
	}
	return zr;
}
function fa(e) {
	let t, n, r, i = e.minZoom === void 0 ? ca : e.minZoom, a = e.maxZoom === void 0 ? 28 : e.maxZoom, o = e.zoomFactor === void 0 ? 2 : e.zoomFactor, s = e.multiWorld !== void 0 && e.multiWorld, c = e.smoothResolutionConstraint === void 0 || e.smoothResolutionConstraint, l = e.showFullExtent !== void 0 && e.showFullExtent, u = or(e.projection, "EPSG:3857"), d = u.getExtent(), f = e.constrainOnlyCenter, p = e.extent;
	if (!s && !p && u.isGlobal() && (f = !1, p = d), e.resolutions !== void 0) {
		let o = e.resolutions;
		n = o[i], r = o[a] === void 0 ? o[o.length - 1] : o[a], t = e.constrainResolution ? ta(o, c, !f && p, l) : ra(n, r, c, !f && p, l);
	} else {
		let s = (d ? Math.max(I(d), ct(d)) : 360 * Kt.degrees / u.getMetersPerUnit()) / 256 / 2 ** ca, m = s / 2 ** 28;
		n = e.maxResolution, n === void 0 ? n = s / o ** +i : i = 0, r = e.minResolution, r === void 0 && (r = e.maxZoom === void 0 ? m : e.maxResolution === void 0 ? s / o ** +a : n / o ** +a), a = i + Math.floor(Math.log(n / r) / Math.log(o)), r = n / o ** +(a - i), t = e.constrainResolution ? na(o, n, r, c, !f && p, l) : ra(n, r, c, !f && p, l);
	}
	return {
		constraint: t,
		maxResolution: n,
...
function pa(e) {
	if (e.enableRotation === void 0 || e.enableRotation) {
		...
		return t === void 0 || t === !0 ? sa() : t === !1 ? aa : typeof t == "number" ? oa(t) : aa;
	}
	return ia;
}
function ma(e) {
...
function ya(e) {
	e ||= {};
	let t = new Or();
	return (e.zoom === void 0 || e.zoom) && t.push(new va(e.zoomOptions)), (e.rotate === void 0 || e.rotate) && t.push(new _a(e.rotateOptions)), (e.attribution === void 0 || e.attribution) && t.push(new ga(e.attributionOptions)), t;
}
//#endregion
...
var Ta = class extends Sa {
	...
	handleEvent(e) {
		...
		if (e.type == jr.DBLCLICK) {
			...
			wa(r.getView(), a, i, this.duration_), n.preventDefault(), t = !0;
		}
		return !t;
	}
};
...
var Da = function(e) {
	...
	return !(n instanceof ShadowRoot ? n.host : t).hasAttribute("tabindex") || Oa(e);
}, Aa = pe, ja = function(e) {
	let t = e.originalEvent;
...
var Ba = class extends Ra {
	constructor(e) {
		super({ stopDown: me }), e ||= {}, this.kinetic_ = e.kinetic, this.lastCentroid = null, this.lastPointersCount_, this.panning_ = !1;
		let t = e.condition ? e.condition : Ea(Ma, La);
		this.condition_ = e.onFocusOnly ? Ea(ka, t) : t, this.noKinetic_ = !1;
	}
	handleDragEvent(e) {
		let t = e.map;
		this.panning_ || (this.panning_ = !0, t.getView().beginInteraction());
		let n = this.targetPointers, r = t.getEventPixel(za(n));
	...
	constructor(e) {
		e ||= {}, super({ stopDown: me }), this.condition_ = e.condition ? e.condition : Da, this.lastAngle_ = void 0, this.duration_ = e.duration === void 0 ? 250 : e.duration;
	}
	handleDragEvent(e) {
		if (!Ia(e)) return;
		let t = e.map, n = t.getView();
		if (n.getConstraints().rotation === ia) return;
	...
	handleUpEvent(e) {
		return !Ia(e) || (e.map.getView().endInteraction(this.duration_), !1);
	}
	handleDownEvent(e) {
		return Ia(e) && ja(e) && this.condition_(e) ? (e.map.getView().beginInteraction(), this.lastAngle_ = void 0, !0) : !1;
	}
}, Ha = class extends ie {
	constructor(e) {
	...
	createOrUpdateGeometry() {
		...
		n[4] = n[0].slice(), this.geometry_ ? this.geometry_.setCoordinates([n]) : this.geometry_ = new Zi([n]);
	}
	getGeometry() {
	...
	constructor(e) {
		super(), this.on, this.once, this.un, e ??= {}, this.box_ = new Ha(e.className || "ol-dragbox"), this.minArea_ = e.minArea ?? 64, e.onBoxEnd && (this.onBoxEnd = e.onBoxEnd), this.startPixel_ = null, this.condition_ = e.condition ?? ja, this.boxEndCondition_ = e.boxEndCondition ?? this.defaultBoxEndCondition;
	}
	...
	handleDragEvent(e) {
		this.startPixel_ && (this.box_.setPixels(this.startPixel_, e.pixel), this.dispatchEvent(new Wa(Ua.BOXDRAG, e.coordinate, e)));
	}
	handleUpEvent(e) {
		if (!this.startPixel_) return !1;
		let t = this.boxEndCondition_(e, this.startPixel_, e.pixel);
		return t && this.onBoxEnd(e), this.dispatchEvent(new Wa(t ? Ua.BOXEND : Ua.BOXCANCEL, e.coordinate, e)), this.box_.setMap(null), this.startPixel_ = null, !1;
	}
	handleDownEvent(e) {
		return this.condition_(e) ? (this.startPixel_ = e.pixel, this.box_.setMap(e.map), this.box_.setPixels(this.startPixel_, this.startPixel_), this.dispatchEvent(new Wa(Ua.BOXSTART, e.coordinate, e)), !0) : !1;
	}
	onBoxEnd(e) {}
	setActive(e) {
		e || (this.box_.setMap(null), this.startPixel_ &&= (this.dispatchEvent(new Wa(Ua.BOXCANCEL, this.startPixel_, null)), null)), super.setActive(e);
	}
	setMap(e) {
		this.getMap() && (this.box_.setMap(null), this.startPixel_ &&= (this.dispatchEvent(new Wa(Ua.BOXCANCEL, this.startPixel_, null)), null)), super.setMap(e);
	}
}, Ka = class extends Ga {
	constructor(e) {
		e ||= {};
		let t = e.condition ? e.condition : Pa;
		super({
			condition: t,
	...
	handleEvent(e) {
		...
		if (e.type == M.KEYDOWN) {
			...
			if (this.condition_(e) && (r == qa.DOWN || r == qa.LEFT || r == qa.RIGHT || r == qa.UP)) {
				let i = e.map.getView(), a = i.getResolution() * this.pixelDelta_, o = 0, s = 0;
				r == qa.DOWN ? s = -a : r == qa.LEFT ? o = -a : r == qa.RIGHT ? o = a : s = a;
				let c = [o, s];
				Lt(c, i.getRotation()), Ca(i, c, this.duration_), n.preventDefault(), t = !0;
			}
		}
		return !t;
	}
	...
	handleEvent(e) {
		...
		if (e.type == M.KEYDOWN || e.type == M.KEYPRESS) {
			...
			if (this.condition_(e) && (r === "+" || r === "-")) {
				...
				wa(i.getView(), a, void 0, this.duration_), n.preventDefault(), t = !0;
			}
		}
		return !t;
	}
}, Xa = 40, Za = 300, Qa = 3, $a = class extends Sa {
	constructor(e) {
		...
		let t = e.condition ? e.condition : Aa;
		this.condition_ = e.onFocusOnly ? Ea(ka, t) : t, this.lastAnchor_ = null, this.startTime_ = void 0, this.timeoutId_, this.mode_ = void 0, this.trackpadEventGap_ = 400, this.trackpadTimeoutId_, this.deltaPerZoom_ = 300, this.ctrlKeyPressed_ = !1, this.ctrlKeyListenerKeys_ = [];
	}
	setMap(e) {
	...
	handleEvent(e) {
		...
		switch (n.deltaMode) {
			case WheelEvent.DOM_DELTA_LINE:
				i *= Xa;
				break;
			case WheelEvent.DOM_DELTA_PAGE: i *= Za;
		}
		if (i === 0) return !1;
		this.lastDelta_ = i;
		let a = Date.now();
		...
		let o = t.getView();
		if (this.mode_ === "trackpad") return this.trackpadTimeoutId_ ? clearTimeout(this.trackpadTimeoutId_) : (o.getAnimating() && o.cancelAnimations(), o.beginInteraction()), this.trackpadTimeoutId_ = setTimeout(this.endInteraction_.bind(this), this.timeout_), r && (i *= Qa), o.adjustZoom(-i / this.deltaPerZoom_, this.lastAnchor_ ? t.getCoordinateFromPixel(this.lastAnchor_) : null), this.startTime_ = a, !1;
		this.totalDelta_ += i;
	...
	handleWheelZoom_(e) {
		...
		(t.getConstrainResolution() || this.constrainResolution_) && (n = n ? n > 0 ? 1 : -1 : 0), wa(t, n, this.lastAnchor_ ? e.getCoordinateFromPixel(this.lastAnchor_) : null, this.duration_), this.mode_ = void 0, this.totalDelta_ = 0, this.lastAnchor_ = null, this.startTime_ = void 0, this.timeoutId_ = void 0;
	}
	setMouseAnchor(e) {
	...
	handleDragEvent(e) {
		...
		o.getConstraints().rotation !== ia && (this.anchor_ = a.getCoordinateFromPixelInternal(a.getEventPixel(za(this.targetPointers))), this.rotating_ && (a.render(), o.adjustRotationInternal(t, this.anchor_)));
	}
	handleUpEvent(e) {
	...
	handleDragEvent(e) {
		...
		t != 1 && (this.lastScaleDelta_ = t), this.anchor_ = s.getCoordinateFromPixelInternal(s.getEventPixel(za(this.targetPointers))), s.render(), c.adjustResolutionInternal(t, this.anchor_);
	}
	handleUpEvent(e) {
		if (this.targetPointers.length < 2) {
...
function no(e) {
	e ||= {};
	let t = new Or(), n = new ba(-.005, .05, 100);
	return (e.altShiftDragRotate === void 0 || e.altShiftDragRotate) && t.push(new Va()), (e.doubleClickZoom === void 0 || e.doubleClickZoom) && t.push(new Ta({
		delta: e.zoomDelta,
		duration: e.zoomDuration
	})), (e.dragPan === void 0 || e.dragPan) && t.push(new Ba({
		onFocusOnly: e.onFocusOnly,
		kinetic: n
	})), (e.pinchRotate === void 0 || e.pinchRotate) && t.push(new eo()), (e.pinchZoom === void 0 || e.pinchZoom) && t.push(new to({ duration: e.zoomDuration })), (e.keyboard === void 0 || e.keyboard) && (t.push(new Ja()), t.push(new Ya({
		delta: e.zoomDelta,
		duration: e.zoomDuration
	}))), (e.mouseWheelZoom === void 0 || e.mouseWheelZoom) && t.push(new $a({
		onFocusOnly: e.onFocusOnly,
		duration: e.zoomDuration
	})), (e.shiftDragZoom === void 0 || e.shiftDragZoom) && t.push(new Ka({ duration: e.zoomDuration })), t;
}
//#endregion
...
var V = {
...
}, oo = { LAYERS: "layers" }, so = class e extends ro {
	constructor(e) {
		e ||= {};
		let t = Object.assign({}, e);
		delete t.layers;
		let n = e.layers;
		super(t), this.on, this.once, this.un, this.layersListenerKeys_ = [], this.listenerKeys_ = {}, this.addChangeListener(oo.LAYERS, this.handleLayersChanged_), n ? Array.isArray(n) ? n = new Or(n.slice(), { unique: !0 }) : R(typeof n.getArray == "function", "Expected `layers` to be an array or a `Collection`") : n = new Or(void 0, { unique: !0 }), this.setLayers(n);
	}
	handleLayerChange_() {
		this.changed();
	}
	handleLayersChanged_() {
		...
		for (let e = 0, n = t.length; e < n; e++) {
			let n = t[e];
			this.registerLayerListeners_(n), this.dispatchEvent(new ao(io.ADDLAYER, n));
		}
		this.changed();
	}
	registerLayerListeners_(t) {
		let n = [A(t, re.PROPERTYCHANGE, this.handleLayerChange_, this), A(t, M.CHANGE, this.handleLayerChange_, this)];
		t instanceof e && n.push(A(t, io.ADDLAYER, this.handleLayerGroupAdd_, this), A(t, io.REMOVELAYER, this.handleLayerGroupRemove_, this)), this.listenerKeys_[F(t)] = n;
	}
	handleLayerGroupAdd_(e) {
		this.dispatchEvent(new ao(io.ADDLAYER, e.layer));
	}
	handleLayerGroupRemove_(e) {
		this.dispatchEvent(new ao(io.REMOVELAYER, e.layer));
	}
	handleLayersAdd_(e) {
		let t = e.element;
		this.registerLayerListeners_(t), this.dispatchEvent(new ao(io.ADDLAYER, t)), this.changed();
	}
	handleLayersRemove_(e) {
		let t = e.element, n = F(t);
		this.listenerKeys_[n].forEach(j), delete this.listenerKeys_[n], this.dispatchEvent(new ao(io.REMOVELAYER, t)), this.changed();
	}
	getLayers() {
		return this.get(oo.LAYERS);
	}
	setLayers(e) {
		let t = this.getLayers();
		if (t) {
			let e = t.getArray();
			for (let t = 0, n = e.length; t < n; ++t) this.dispatchEvent(new ao(io.REMOVELAYER, e[t]));
		}
		this.set(oo.LAYERS, e);
	}
	getLayersArray(e) {
	...
	isVisible(e) {
		...
		!e && n && (e = n.getView()), t = e instanceof la ? {
		...
		return uo(r, t.viewState) && (!i || pt(i, t.extent));
	}
	getAttributions(e) {
		if (!this.isVisible(e)) return [];
		let t = this.getSource()?.getAttributions();
		if (!t) return [];
		let n = t(e instanceof la ? e.getViewStateAndExtent() : e);
	...
	setMap(e) {
		this.mapPrecomposeKey_ &&= (j(this.mapPrecomposeKey_), null), e || this.changed(), this.mapRenderKey_ &&= (j(this.mapRenderKey_), null), e && (this.mapPrecomposeKey_ = A(e, co.PRECOMPOSE, this.handlePrecompose_, this), this.mapRenderKey_ = A(this, M.CHANGE, e.render, e), this.changed());
	}
	handlePrecompose_(e) {
...
function fo(e, t, n = 0, r = e.length - 1, i = mo) {
	for (; r > n;) {
		if (r - n > 600) {
			let a = r - n + 1, o = t - n + 1, s = Math.log(a), c = .5 * Math.exp(2 * s / 3), l = .5 * Math.sqrt(s * c * (a - c) / a) * (o - a / 2 < 0 ? -1 : 1);
			fo(e, t, Math.max(n, Math.floor(t - o * c / a + l)), Math.min(r, Math.floor(t + (a - o) * c / a + l)), i);
		}
		let a = e[t], o = n, s = r;
		for (po(e, n, t), i(e[r], a) > 0 && po(e, n, r); o < s;) {
			for (po(e, o, s), o++, s--; i(e[o], a) < 0;) o++;
			for (; i(e[s], a) > 0;) s--;
		}
		i(e[n], a) === 0 ? po(e, n, s) : (s++, po(e, s, r)), s <= t && (n = s + 1), t <= s && (r = s - 1);
	}
}
function po(e, t, n) {
	let r = e[t];
...
var ho = class {
	...
	search(e) {
		...
		for (; t;) {
			for (let a = 0; a < t.children.length; a++) {
				...
				Do(e, s) && (t.leaf ? n.push(o) : Eo(e, s) ? this._all(o, n) : i.push(o));
			}
			t = i.pop();
		}
		return n;
	...
	remove(e, t) {
		...
		for (; n || i.length;) {
			if (n || (n = i.pop(), s = i[i.length - 1], o = a.pop(), c = !0), n.leaf) {
				let r = go(e, n.children, t);
				if (r !== -1) return n.children.splice(r, 1), i.push(n), this._condense(i), this;
			}
			!c && !n.leaf && Eo(n, r) ? (i.push(n), a.push(o), o = 0, s = n, n = n.children[0]) : s ? (o++, n = s.children[o], c = !1) : n = null;
		}
		return this;
	}
	toBBox(e) {
	...
	_build(e, t, n, r) {
		...
		if (i <= a) return o = Oo(e.slice(t, n + 1)), _o(o, this.toBBox), o;
		r || (r = Math.ceil(Math.log(i) / Math.log(a)), a = Math.ceil(i / a ** (r - 1))), o = Oo([]), o.leaf = !1, o.height = r;
		let s = Math.ceil(i / a), c = s * Math.ceil(Math.sqrt(a));
		ko(e, t, n, c, this.compareMinX);
		for (let i = t; i <= n; i += c) {
			let t = Math.min(i + c - 1, n);
			ko(e, i, t, s, this.compareMinY);
			for (let n = i; n <= t; n += s) {
				let i = Math.min(n + s - 1, t);
				o.children.push(this._build(e, n, i, r - 1));
			}
		}
		return _o(o, this.toBBox), o;
	}
	_chooseSubtree(e, t, n, r) {
		for (; r.push(t), !(t.leaf || r.length - 1 === n);) {
			let n = Infinity, r = Infinity, i;
			for (let a = 0; a < t.children.length; a++) {
				let o = t.children[a], s = So(o), c = wo(e, o) - s;
	...
	_insert(e, t, n) {
		...
		for (a.children.push(e), yo(a, r); t >= 0 && i[t].children.length > this._maxEntries;) this._split(i, t), t--;
		this._adjustParentBBoxes(r, i, t);
	}
	_split(e, t) {
		let n = e[t], r = n.children.length, i = this._minEntries;
		this._chooseSplitAxis(n, i, r);
		let a = this._chooseSplitIndex(n, i, r), o = Oo(n.children.splice(a, n.children.length - a));
		o.height = n.height, o.leaf = n.leaf, _o(n, this.toBBox), _o(o, this.toBBox), t ? e[t - 1].children.push(o) : this._splitRoot(n, o);
	}
	_splitRoot(e, t) {
		this.data = Oo([e, t]), this.data.height = e.height + 1, this.data.leaf = !1, _o(this.data, this.toBBox);
	}
	_chooseSplitIndex(e, t, n) {
		let r, i = Infinity, a = Infinity;
		for (let o = t; o <= n - t; o++) {
			let t = vo(e, 0, o, this.toBBox), s = vo(e, o, n, this.toBBox), c = To(t, s), l = So(t) + So(s);
			c < i ? (i = c, r = o, a = l < a ? l : a) : c === i && l < a && (a = l, r = o);
		}
		return r || n - t;
	}
	_chooseSplitAxis(e, t, n) {
		let r = e.leaf ? this.compareMinX : bo, i = e.leaf ? this.compareMinY : xo;
		this._allDistMargin(e, t, n, r) < this._allDistMargin(e, t, n, i) && e.children.sort(r);
	}
	_allDistMargin(e, t, n, r) {
		e.children.sort(r);
		let i = this.toBBox, a = vo(e, 0, t, i), o = vo(e, n - t, n, i), s = Co(a) + Co(o);
		for (let r = t; r < n - t; r++) {
			let t = e.children[r];
			yo(a, e.leaf ? i(t) : t), s += Co(a);
		}
		for (let r = n - t - 1; r >= t; r--) {
			let t = e.children[r];
			yo(o, e.leaf ? i(t) : t), s += Co(o);
		}
		return s;
	}
	_adjustParentBBoxes(e, t, n) {
		for (let r = n; r >= 0; r--) yo(t[r], e);
	}
	_condense(e) {
		for (let t = e.length - 1, n; t >= 0; t--) e[t].children.length === 0 ? t > 0 ? (n = e[t - 1].children, n.splice(n.indexOf(e[t]), 1)) : this.clear() : _o(e[t], this.toBBox);
	}
};
function go(e, t, n) {
...
function _o(e, t) {
	vo(e, 0, e.children.length, t, e);
}
function vo(e, t, n, r, i) {
	i ||= Oo(null), i.minX = Infinity, i.minY = Infinity, i.maxX = -Infinity, i.maxY = -Infinity;
	for (let a = t; a < n; a++) {
		let t = e.children[a];
		yo(i, e.leaf ? r(t) : t);
	}
...
function Mo() {
	return jo ||= y(1, 1, void 0, {
		willReadFrequently: !0,
		desynchronized: !0
	}), jo;
}
var No = /^rgba?\(\s*(\d+%?)\s+(\d+%?)\s+(\d+%?)(?:\s*\/\s*(\d+%|\d*\.\d+|[01]))?\s*\)$/i, Po = /^rgba?\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)(?:\s*,\s*(\d+%|\d*\.\d+|[01]))?\s*\)$/i, Fo = /^rgba?\(\s*(\d+%)\s*,\s*(\d+%)\s*,\s*(\d+%)(?:\s*,\s*(\d+%|\d*\.\d+|[01]))?\s*\)$/i, Io = /^#([\da-f]{3,4}|[\da-f]{6}|[\da-f]{8})$/i;
function Lo(e, t) {
...
function zo(e) {
	if (e.toLowerCase().startsWith("rgb")) {
		let t = e.match(Po) || e.match(No) || e.match(Fo);
		if (t) {
			let e = t[4], n = 100 / 255;
			return [
				St(Lo(t[1], n) + .5 | 0, 0, 255),
				St(Lo(t[2], n) + .5 | 0, 0, 255),
				St(Lo(t[3], n) + .5 | 0, 0, 255),
				e === void 0 ? 1 : St(Lo(e, 100), 0, 1)
			];
		}
		Ro(e);
	}
	...
	t.fillStyle = "#abcdef";
	let n = t.fillStyle;
	t.fillStyle = e, t.fillStyle === n && (t.fillStyle = "#fedcba", n = t.fillStyle, t.fillStyle = e, t.fillStyle === n && Ro(e));
	let r = t.fillStyle;
	if (r.startsWith("#") || r.startsWith("rgba")) return zo(r);
...
function Yo(e) {
	let t = qo(e[0]), n = qo(e[1]), r = qo(e[2]), i = Jo(t * .222488403 + n * .716873169 + r * .06060791), a = 500 * (Jo(t * .452247074 + n * .399439023 + r * .148375274) - i), o = 200 * (i - Jo(t * .016863605 + n * .117638439 + r * .865350722)), s = 180 / Math.PI * Math.atan2(o, a);
	return [
		116 * i - 16,
		Math.sqrt(a * a + o * o),
		s < 0 ? s + 360 : s,
...
function Xo(e) {
	let t = (e[0] + 16) / 116, n = e[1], r = e[2] * Math.PI / 180, i = Ko(t), a = Ko(t + n / 500 * Math.cos(r)), o = Ko(t - n / 200 * Math.sin(r)), s = Go(a * 3.021973625 - i * 1.617392459 - o * .404875592), c = Go(a * -.943766287 + i * 1.916279586 + o * .027607165), l = Go(a * .069407491 - i * .22898585 + o * 1.159737864);
	return [
		St(s + .5 | 0, 0, 255),
		St(c + .5 | 0, 0, 255),
		St(l + .5 | 0, 0, 255),
...
function Zo(e) {
	if (e === "none") return Ao;
	if (Ho.hasOwnProperty(e)) return Ho[e];
	if (Uo >= Vo) {
		let e = 0;
		for (let t in Ho) e++ & 3 || (delete Ho[t], --Uo);
	}
	let t = zo(e);
	t.length !== 4 && Ro(e);
	for (let n of t) isNaN(n) && Ro(e);
	return Ho[e] = t, ++Uo, t;
}
function Qo(e) {
	return Array.isArray(e) ? e : Zo(e);
}
function $o(e) {
	let t = e[0];
	t != (t | 0) && (t = t + .5 | 0);
...
var rs = 0, is = 1 << rs++, H = 1 << rs++, U = 1 << rs++, W = 1 << rs++, as = 1 << rs++, os = 1 << rs++, ss = 2 ** rs - 1, cs = {
	[is]: "boolean",
	[H]: "number",
	[U]: "string",
	[W]: "color",
	[as]: "number[]",
	[os]: "size"
}, ls = Object.keys(cs).map(Number).sort(oe);
function us(e) {
	return e in cs;
}
function ds(e) {
	let t = [];
	for (let n of ls) fs(e, n) && t.push(cs[n]);
...
var hs = class {
	constructor(e, t) {
		if (!us(e)) throw Error(`literal expressions must have a specific type, got ${ds(e)}`);
...
function vs(e, t, n) {
	switch (typeof e) {
		case "boolean":
			if (ms(t, U)) return new hs(U, e ? "true" : "false");
			if (!fs(t, is)) throw Error(`got a boolean, but expected ${ds(t)}`);
			return new hs(is, e);
		case "number":
			if (ms(t, os)) return new hs(os, ns(e));
			if (ms(t, is)) return new hs(is, !!e);
			if (ms(t, U)) return new hs(U, e.toString());
			if (!fs(t, H)) throw Error(`got a number, but expected ${ds(t)}`);
			return new hs(H, e);
		case "string":
			if (ms(t, W)) return new hs(W, Zo(e));
			if (ms(t, is)) return new hs(is, !!e);
			if (!fs(t, U)) throw Error(`got a string, but expected ${ds(t)}`);
			return new hs(U, e);
	}
	...
	if (typeof e[0] == "string") return Is(e, t, n);
	...
	if (ms(t, W)) {
		if (e.length === 3) return new hs(W, [...e, 1]);
		if (e.length === 4) return new hs(W, e);
		throw Error(`expected an array of 3 or 4 values for a color, got ${e.length}`);
	}
	if (!fs(t, as)) throw Error(`got an array of numbers, but expected ${ds(t)}`);
	return new hs(as, e);
}
var G = {
	Get: "get",
	...
	[G.Get]: J(K(1, Infinity), bs),
	[G.Var]: xs(),
	[G.Has]: J(K(1, Infinity), bs),
	[G.Id]: J(Ss, Es),
	[G.Concat]: J(K(2, Infinity), q(U)),
	[G.GeometryType]: J(Cs, Es),
	[G.LineMetric]: J(ws, Es),
	[G.Resolution]: J(Ts, Es),
	[G.Zoom]: J(Ts, Es),
	[G.Time]: J(Ts, Es),
	[G.Any]: J(K(2, Infinity), q(is)),
	[G.All]: J(K(2, Infinity), q(is)),
	[G.Not]: J(K(1, 1), q(is)),
	[G.Equal]: J(K(2, 2), Os()),
	[G.NotEqual]: J(K(2, 2), Os()),
	[G.GreaterThan]: J(K(2, 2), q(H)),
	[G.GreaterThanOrEqualTo]: J(K(2, 2), q(H)),
	[G.LessThan]: J(K(2, 2), q(H)),
	[G.LessThanOrEqualTo]: J(K(2, 2), q(H)),
	[G.Multiply]: J(K(2, Infinity), Ds),
	[G.Coalesce]: J(K(2, Infinity), Ds),
	...
	[G.Atan]: J(K(1, 2), q(H)),
	[G.Sqrt]: J(K(1, 1), q(H)),
	[G.Match]: J(K(4, Infinity), As, js),
	[G.Between]: J(K(3, 3), q(H)),
	[G.Interpolate]: J(K(6, Infinity), As, Ms),
	[G.Case]: J(K(3, Infinity), ks, Ns),
	[G.In]: J(K(2, 2), Ps),
	[G.Number]: J(K(1, Infinity), q(ss)),
	[G.String]: J(K(1, Infinity), q(ss)),
	[G.Array]: J(K(1, Infinity), q(H)),
	[G.Color]: J(K(1, 4), q(H)),
	[G.Band]: J(K(1, 3), q(H)),
	[G.Palette]: J(K(2, 2), Fs),
	[G.ToString]: J(K(1, 1), q(is | H | U | W))
};
function bs(e, t, n) {
...
function xs() {
	return function(e, t, n) {
		...
		if (a !== void 0) {
			let e = vs(a, ss, n);
			if (!(e instanceof hs)) throw Error(`style variables should only be literal values (no expressions!), variable name: ${r}`);
			let o = e.type;
			if (typeof a == "string" && ps(i, W) && !ps(i, U) ? o = W : Array.isArray(a) && a.length === 2 && ps(i, os) && !ps(i, as) && (o = os), i &= o, i === 0) throw Error(`the type expected from the var operator (${ds(t)}) did not have any overlap with the type of the corresponding style variables (${ds(o)}), variable name: ${r}`);
		}
		if (n.variables.has(r)) {
			let e = n.variables.get(r);
			if (i &= e, i === 0) throw Error(`a new type expected from the var operator (${ds(t)}) did not have any overlap with the previous type expected for it (${ds(e)}), variable name: ${r}`);
		}
		return n.variables.set(r, i), new gs(i, "var", new hs(U, r));
	};
}
function Ss(e, t, n) {
	n.featureId = !0;
...
function Os() {
	return function(e, t, n) {
		let r = e[0], i = e.length - 1, a = Array(i), o = ss;
		for (let t = 0; t < i; ++t) {
			let r = vs(e[t + 1], o, n);
			o &= r.type;
		}
...
function js(e, t, n) {
	let r = e.length - 1, i = vs(e[e.length - 1], t, n), a = U | H | is, o = Array(r - 2);
...
function Ns(e, t, n) {
	let r = vs(e[e.length - 1], t, n), i = Array(e.length - 1);
...
function Fs(e, t, n) {
	...
	for (let e = 0; e < a.length; e++) {
		...
		if (!(t instanceof hs)) throw Error(`the palette color at index ${e} must be a literal value`);
		a[e] = t;
	}
	return [r, ...a];
}
...
function Ls(e) {
	...
	switch (t) {
		...
		case "GeometryCollection": return Ls(e.getGeometries()[0]);
		default: return "";
	}
}
//#endregion
...
function Bs(e, t) {
	...
	switch (n) {
		case G.Number:
		case G.String:
		case G.Coalesce: return Vs(e, t);
		case G.Get:
		case G.Var:
		case G.Has: return Hs(e, t);
		case G.Id: return (e) => e.featureId;
		case G.GeometryType: return (e) => e.geometryType;
		case G.Concat: {
			let n = e.args.map((e) => Bs(e, t));
		...
		case G.Between:
		case G.In:
		case G.Not: return Ws(e, t);
		case G.Equal:
		case G.NotEqual:
		case G.LessThan:
		case G.LessThanOrEqualTo:
		case G.GreaterThan:
		case G.GreaterThanOrEqualTo: return Us(e, t);
		case G.Multiply:
		case G.Divide:
		case G.Add:
		case G.Subtract:
		...
		case G.Cos:
		case G.Atan:
		case G.Sqrt: return Gs(e, t);
		case G.Case: return Ks(e, t);
		case G.Match: return qs(e, t);
		case G.Interpolate: return Js(e, t);
		case G.ToString: return Ys(e, t);
		default: throw Error(`Unsupported operator ${n}`);
	}
}
function Vs(e, t) {
	let n = e.operator, r = e.args.length, i = Array(r);
	for (let n = 0; n < r; ++n) i[n] = Bs(e.args[n], t);
	switch (n) {
...
function Us(e, t) {
	let n = e.operator, r = Bs(e.args[0], t), i = Bs(e.args[1], t);
	switch (n) {
...
function Ks(e, t) {
	...
	for (let i = 0; i < n; ++i) r[i] = Bs(e.args[i], t);
	return (e) => {
...
function Js(e, t) {
	...
	return (e) => {
		...
		for (let s = 2; s < n; s += 2) {
			...
			if (l && (c = Wo(c)), n >= i) return s === 2 ? c : l ? Zs(t, i, a, o, n, c) : Xs(t, i, a, o, n, c);
			a = n, o = c;
		}
		return o;
	};
...
function Ys(e, t) {
	...
	switch (n) {
		case G.ToString: return (t) => {
			let n = i[0](t);
			return e.args[0].type === W ? $o(n) : n.toString();
		};
...
function Zs(e, t, n, r, i, a) {
	if (i - n === 0) return r;
	let o = Yo(r), s = Yo(a), c = s[2] - o[2];
	return c > 180 ? c -= 360 : c < -180 && (c += 360), Xo([
		Xs(e, t, n, o[0], i, s[0]),
		Xs(e, t, n, o[1], i, s[1]),
		o[2] + Xs(e, t, n, 0, i, c),
		Xs(e, t, n, r[3], i, a[3])
...
function ec(e, t) {
	return t && (e.src = t), e.src && _ ? new Promise((t, n) => e.decode().then(() => t(e)).catch((r) => e.complete && e.width ? t(e) : n(r))) : $s(e);
}
//#endregion
...
var tc = class {
	...
	set(e, t, n, r) {
		let i = nc(e, t), a = i in this.cache_;
		this.cache_[i] = n, r && (n.getImageState() === Y.IDLE && n.load(), n.getImageState() === Y.LOADING ? n.ready().then(() => {
...
var rc = new tc(), ic = null, ac = class extends ye {
	constructor(e, t, n, r, i) {
		super(), this.hitDetectionImage_ = null, this.image_ = e, this.crossOrigin_ = n?.crossOrigin, this.referrerPolicy_ = n?.referrerPolicy, this.canvas_ = {}, this.color_ = i, this.imageState_ = r === void 0 ? Y.IDLE : r, this.size_ = e && e.width && e.height ? [e.width, e.height] : null, this.src_ = t, this.tainted_, this.ready_ = null;
	}
	initializeImage_() {
	...
	isTainted_() {
		if (this.tainted_ === void 0 && this.imageState_ === Y.LOADED) {
			ic ||= y(1, 1, void 0, { willReadFrequently: !0 }), ic.drawImage(this.image_, 0, 0);
			try {
				ic.getImageData(0, 0, 1, 1), this.tainted_ = !1;
			} catch {
				ic = null, this.tainted_ = !0;
			}
		}
	...
	load() {
		if (this.imageState_ === Y.IDLE) {
			...
			this.image_ instanceof HTMLImageElement && ec(this.image_, this.src_).then((e) => {
				this.image_ = e, this.handleImageLoad_();
			}).catch(this.handleImageError_.bind(this));
		}
	}
	replaceColor_(e) {
		if (!this.color_ || this.canvas_[e] || this.imageState_ !== Y.LOADED) return;
		let t = this.image_, n = y(Math.ceil(t.width * e), Math.ceil(t.height * e)), r = n.canvas;
		n.scale(e, e), n.drawImage(t, 0, 0), n.globalCompositeOperation = "multiply", n.fillStyle = Bo(this.color_), n.fillRect(0, 0, r.width / e, r.height / e), n.globalCompositeOperation = "destination-in", n.drawImage(t, 0, 0), this.canvas_[e] = r;
	}
	ready() {
		return this.ready_ ||= new Promise((e) => {
			if (this.imageState_ === Y.LOADED || this.imageState_ === Y.ERROR) e();
			else {
				let t = () => {
					(this.imageState_ === Y.LOADED || this.imageState_ === Y.ERROR) && (this.removeEventListener(M.CHANGE, t), e());
				};
...
function oc(e, t, n, r, i, a) {
	let o = t === void 0 ? void 0 : rc.get(t, i);
	return o || (o = new ac(e, e && "src" in e ? e.src || void 0 : t, n, r, i), rc.set(t, i, o, a)), a && o && !rc.getPattern(t, i) && rc.set(t, i, o, a), o;
}
//#endregion
//#region node_modules/ol/colorlike.js
function sc(e) {
	return e ? Array.isArray(e) ? $o(e) : typeof e == "object" && "src" in e ? cc(e) : e : null;
}
function cc(e) {
	if (!e.offset || !e.size) return rc.getPattern(e.src, e.color);
	let t = e.src + ":" + e.offset, n = rc.getPattern(t, e.color);
	if (n) return n;
	let r = rc.get(e.src, null);
	if (r.getImageState() !== Y.LOADED) return null;
	let i = y(e.size[0], e.size[1]);
	return i.drawImage(r.getImage(1), e.offset[0], e.offset[1], e.size[0], e.size[1], 0, 0, e.size[0], e.size[1]), oc(i.canvas, t, void 0, Y.LOADED, e.color, !0), rc.getPattern(t, e.color);
}
//#endregion
//#region node_modules/ol/render/canvas.js
var lc = "10px sans-serif", uc = "#000", dc = "round", fc = [], pc = "round", mc = "#000", hc = "center", gc = "middle", _c = [
	0,
	0,
	0,
	0
], vc = new we(), yc = null, bc, xc = {}, Sc = /* @__PURE__ */ new Set([
	"serif",
	"sans-serif",
	"monospace",
	"cursive",
...
var wc = (function() {
	...
	async function r() {
		await t.ready;
		let i = !0, a = vc.getProperties(), o = Object.keys(a).filter((e) => a[e] < 100);
		for (let e = o.length - 1; e >= 0; --e) {
			let t = o[e], r = a[t];
			r < 100 && (await n(t) ? (k(xc), vc.set(t, 100)) : (r += 10, vc.set(t, r, !0), r < 100 && (i = !1)));
		}
	...
	return async function(n) {
		...
		for (let e of a) {
			if (Sc.has(e)) continue;
			let t = Cc(i.style, i.weight, e);
			vc.get(t) === void 0 && (vc.set(t, 0, !0), o = !0);
		}
...
function Ec(e, t) {
	return yc ||= y(1, 1), e != bc && (yc.font = e, bc = yc.font), yc.measureText(t);
}
function Dc(e, t) {
	return Ec(e, t).width;
}
function Oc(e, t, n) {
	...
	let r = t.split("\n").reduce((t, n) => Math.max(t, Dc(e, n)), 0);
	return n[t] = r, r;
}
function kc(e, t) {
...
function Ac(e, t, n, r, i, a, o, s, c, l, u) {
	e.save(), n !== 1 && (e.globalAlpha === void 0 ? e.globalAlpha = (e) => e.globalAlpha *= n : e.globalAlpha *= n), t && e.transform.apply(e, t), r.contextInstructions ? (e.translate(c, l), e.scale(u[0], u[1]), jc(r, e)) : u[0] < 0 || u[1] < 0 ? (e.translate(c, l), e.scale(u[0], u[1]), e.drawImage(r, i, a, o, s, 0, 0, o, s)) : e.drawImage(r, i, a, o, s, c, l, o * u[0], s * u[1]), e.restore();
}
function jc(e, t) {
...
var Mc = class e {
	constructor(e) {
		this.opacity_ = e.opacity, this.rotateWithView_ = e.rotateWithView, this.rotation_ = e.rotation, this.scale_ = e.scale, this.scaleArray_ = ns(e.scale), this.displacement_ = e.displacement, this.declutterMode_ = e.declutterMode;
	}
	clone() {
		let t = this.getScale();
		return new e({
	...
	setScale(e) {
		this.scale_ = e, this.scaleArray_ = ns(e);
	}
	listenImageChange(e) {
		P();
	}
	...
	constructor(e) {
		...
		}), this.hitDetectionCanvas_ = null, this.fill_ = e.fill === void 0 ? null : e.fill, this.origin_ = [0, 0], this.points_ = e.points, this.radius = e.radius, this.radius2_ = e.radius2, this.angle_ = e.angle === void 0 ? 0 : e.angle, this.stroke_ = e.stroke === void 0 ? null : e.stroke, this.size_, this.renderOptions_, this.imageState_ = this.fill_ && this.fill_.loading() ? Y.LOADING : Y.LOADED, this.imageState_ === Y.LOADING && this.ready().then(() => this.imageState_ = Y.LOADED), this.render();
	}
	clone() {
	...
	getImage(e) {
		let t = this.fill_?.getKey(), n = `${e},${this.angle_},${this.radius},${this.radius2_},${this.points_},${t}` + Object.values(this.renderOptions_).join(","), r = rc.get(n, null)?.getImage(1);
		if (!r) {
			let t = this.renderOptions_, i = Math.ceil(t.size * e), a = y(i, i);
			this.draw_(t, a, e), r = a.canvas;
			let o = new ac(r, void 0, null, Y.LOADED, null);
			rc.set(n, null, o), createImageBitmap(r).then((e) => {
				o.setImage(e);
			});
		}
		return r;
	...
	createRenderOptions() {
		let e = dc, t = pc, n = 0, r = null, i = 0, a, o = 0;
		this.stroke_ && (a = sc(this.stroke_.getColor() ?? "#000"), o = this.stroke_.getWidth() ?? 1, r = this.stroke_.getLineDash(), i = this.stroke_.getLineDashOffset() ?? 0, t = this.stroke_.getLineJoin() ?? "round", e = this.stroke_.getLineCap() ?? "round", n = this.stroke_.getMiterLimit() ?? 10);
	...
	draw_(e, t, n) {
		if (t.scale(n, n), t.translate(e.size / 2, e.size / 2), this.createPath_(t), this.fill_) {
			...
			e === null && (e = uc), t.fillStyle = sc(e), t.fill();
		}
	...
	createHitDetectionCanvas_(e) {
		...
		if (this.fill_) {
			...
			typeof n == "string" && (n = Qo(n)), n === null ? r = 1 : Array.isArray(n) && (r = n.length === 4 ? n[3] : 1), r === 0 && (t = y(e.size, e.size), this.drawHitDetectionCanvas_(e, t));
		}
	...
	setColor(e) {
		if (typeof e == "object" && e && "src" in e) {
			let t = oc(null, e.src, { crossOrigin: "anonymous" }, void 0, e.offset ? null : e.color ? e.color : null, !(e.offset && e.size));
			t.ready().then(() => {
				this.patternImage_ = null;
			}), t.getImageState() === Y.IDLE && t.load(), t.getImageState() === Y.LOADING && (this.patternImage_ = t);
		}
		this.color_ = e;
	}
	getKey() {
		let e = this.getColor();
		return e ? e instanceof CanvasPattern || e instanceof CanvasGradient ? F(e) : typeof e == "object" && "src" in e ? e.src + ":" + e.offset : Qo(e).toString() : "";
	}
	loading() {
...
var Lc = class e extends Mc {
	constructor(e) {
		...
		let s;
		if (e.src === void 0 ? a !== void 0 && (s = "complete" in a ? a.complete ? a.src ? Y.LOADED : Y.IDLE : Y.LOADING : Y.LOADED) : s = Y.IDLE, this.color_ = e.color === void 0 ? null : Qo(e.color), this.iconImage_ = oc(a, o, {
			...
			if (e.size) [t, n] = e.size;
				...
				if (r.width && r.height) t = r.width, n = r.height;
					...
					let t = () => {
						...
						this.setScale(Ic(n[0], n[1], e.width, e.height));
					};
					this.listenImageChange(t);
					return;
				}
			}
			t !== void 0 && this.setScale(Ic(t, n, e.width, e.height));
		}
	}
	clone() {
		let t, n, r;
	...
	setColor(e) {
		...
		this.color_ = t;
		let n = this.getSrc(), r = n === void 0 ? this.getHitDetectionImage() : null, i = n === void 0 ? this.iconImage_.getImageState() : Y.IDLE;
		this.iconImage_ = oc(r, n, {
			crossOrigin: this.crossOrigin_,
			referrerPolicy: this.referrerPolicy_
		}, i, this.color_);
	}
	...
	getWidth() {
		...
		if (this.iconImage_.getImageState() == Y.LOADED) return this.iconImage_.getSize()[0] * e[0];
	}
	getHeight() {
		let e = this.getScaleArray();
		if (this.size_) return this.size_[1] * e[1];
		if (this.iconImage_.getImageState() == Y.LOADED) return this.iconImage_.getSize()[1] * e[1];
	}
	setScale(e) {
	...
	setGeometry(e) {
		typeof e == "function" ? this.geometryFunction_ = e : typeof e == "string" ? this.geometryFunction_ = function(t) {
			...
			return e;
		}) : this.geometryFunction_ = Uc, this.geometry_ = e;
	}
	setZIndex(e) {
		this.zIndex_ = e;
	}
...
function Hc(e, t) {
	if (!Vc) {
		let e = new Fc({ color: "rgba(255,255,255,0.4)" }), t = new Rc({
			color: "#3399CC",
			width: 1.25
		});
		Vc = [new zc({
...
var Wc = "#333", Gc = class e {
	constructor(e) {
		e ||= {}, this.font_ = e.font, this.rotation_ = e.rotation, this.rotateWithView_ = e.rotateWithView, this.keepUpright_ = e.keepUpright, this.scale_ = e.scale, this.scaleArray_ = ns(e.scale === void 0 ? 1 : e.scale), this.text_ = e.text, this.textAlign_ = e.textAlign, this.justify_ = e.justify, this.repeat_ = e.repeat, this.textBaseline_ = e.textBaseline, this.fill_ = e.fill === void 0 ? new Fc({ color: Wc }) : e.fill, this.maxAngle_ = e.maxAngle === void 0 ? Math.PI / 4 : e.maxAngle, this.placement_ = e.placement === void 0 ? "point" : e.placement, this.overflow_ = !!e.overflow, this.stroke_ = e.stroke === void 0 ? null : e.stroke, this.offsetX_ = e.offsetX === void 0 ? 0 : e.offsetX, this.offsetY_ = e.offsetY === void 0 ? 0 : e.offsetY, this.backgroundFill_ = e.backgroundFill ? e.backgroundFill : null, this.backgroundStroke_ = e.backgroundStroke ? e.backgroundStroke : null, this.padding_ = e.padding === void 0 ? null : e.padding, this.declutterMode_ = e.declutterMode;
	}
	clone() {
		let t = this.getScale();
		return new e({
			...
			fill: this.getFill() instanceof Fc ? this.getFill().clone() : this.getFill(),
			stroke: this.getStroke() ? this.getStroke().clone() : void 0,
	...
	setScale(e) {
		this.scale_ = e, this.scaleArray_ = ns(e === void 0 ? 1 : e);
	}
	setStroke(e) {
		this.stroke_ = e;
	}
...
function qc(e, t) {
	...
	return function(e, i) {
		...
		return t.geometryType && (r.geometryType = Ls(e.getGeometry())), n(r);
	};
}
function Jc(e, t) {
	t ??= _s();
	let n = e.length, r = Array(n);
	for (let i = 0; i < n; ++i) r[i] = Zc(e[i], t);
	let i = Rs(), a = Array(n);
	return function(e, o) {
		...
		t.geometryType && (i.geometryType = Ls(e.getGeometry()));
		let s = 0;
		for (let e = 0; e < n; ++e) {
			let t = r[e](i);
			t && (a[s] = t, s += 1);
...
function Yc(e, t) {
	if (t ??= _s(), !Array.isArray(e)) return Jc([e], t);
	let n = e.length;
	if ("style" in e[0]) {
		let r = Array(n);
		for (let t = 0; t < n; ++t) {
...
function Xc(e, t) {
	let n = e.length, r = Array(n);
	for (let i = 0; i < n; ++i) {
		let n = e[i], a = "filter" in n ? zs(n.filter, is, t) : Kc, o;
		if (Array.isArray(n.style)) {
			let e = n.style.length;
			o = Array(e);
			for (let r = 0; r < e; ++r) o[r] = Zc(n.style[r], t);
		} else o = [Zc(n.style, t)];
		r[i] = {
			filter: a,
			styles: o
...
function Zc(e, t) {
	let n = Qc(e, "", t), r = $c(e, "", t), i = el(e, t), a = tl(e, t), o = ol(e, "z-index", t);
...
function Qc(e, t, n) {
	let r;
	if (t + "fill-pattern-src" in e) r = cl(e, t + "fill-", n);
	else {
	...
	return function(e) {
		let t = r(e);
		return t === Ao ? null : (i.setColor(t), i);
	};
}
function $c(e, t, n) {
	let r = ol(e, t + "stroke-width", n), i = ul(e, t + "stroke-color", n);
	if (!r && !i) return null;
	let a = sl(e, t + "stroke-line-cap", n), o = sl(e, t + "stroke-line-join", n), s = dl(e, t + "stroke-line-dash", n), c = ol(e, t + "stroke-line-dash-offset", n), l = ol(e, t + "stroke-miter-limit", n), u = ol(e, t + "stroke-offset", n), d = new Rc();
	return function(e) {
		if (i) {
			let t = i(e);
			if (t === Ao) return null;
...
function el(e, t) {
	let n = "text-", r = sl(e, "text-value", t);
	if (!r) return null;
	let i = Qc(e, n, t), a = Qc(e, "text-background-", t), o = $c(e, n, t), s = $c(e, "text-background-", t), c = sl(e, "text-font", t), l = ol(e, "text-max-angle", t), u = ol(e, "text-offset-x", t), d = ol(e, "text-offset-y", t), f = ll(e, "text-overflow", t), p = sl(e, "text-placement", t), m = ol(e, "text-repeat", t), h = ml(e, "text-scale", t), g = ll(e, "text-rotate-with-view", t), _ = ol(e, "text-rotation", t), v = sl(e, "text-align", t), y = sl(e, "text-justify", t), b = sl(e, "text-baseline", t), x = ll(e, "text-keep-upright", t), S = dl(e, "text-padding", t), C = new Gc({ declutterMode: xl(e, "text-declutter-mode") });
	return function(e) {
...
function tl(e, t) {
	return "icon-src" in e ? nl(e, t) : "shape-points" in e ? rl(e, t) : "circle-radius" in e ? il(e, t) : null;
}
function nl(e, t) {
	let n = "icon-src", r = Cl(e[n], n), i = fl(e, "icon-anchor", t), a = ml(e, "icon-scale", t), o = ol(e, "icon-opacity", t), s = fl(e, "icon-displacement", t), c = ol(e, "icon-rotation", t), l = ll(e, "icon-rotate-with-view", t), u = vl(e, "icon-anchor-origin"), d = yl(e, "icon-anchor-x-units"), f = yl(e, "icon-anchor-y-units"), p = al(e, "icon-color"), m, h = null;
	p !== void 0 && (Array.isArray(p) && p.length > 0 && typeof p[0] == "string" ? h = ul(e, "icon-color", t) : m = Tl(p, "icon-color"));
	let g = _l(e, "icon-cross-origin"), _ = bl(e, "icon-offset"), v = vl(e, "icon-offset-origin"), y = hl(e, "icon-width"), b = {
		src: r,
		anchorOrigin: u,
		anchorXUnits: d,
		anchorYUnits: f,
		...
		offset: _,
		offsetOrigin: v,
		height: hl(e, "icon-height"),
		width: y,
		size: gl(e, "icon-size"),
		declutterMode: xl(e, "icon-declutter-mode")
	}, x = null;
	return function(e) {
		if (x) h && x.setColor(h(e));
		else {
			let t = h ? h(e) : m;
			x = new Lc(t === void 0 ? Object.assign({}, b) : Object.assign({}, b, { color: t }));
		}
...
function rl(e, t) {
	let n = "shape-", r = "shape-points", i = "shape-radius", a = wl(e[r], r);
	if (!(i in e)) throw Error(`Expected a number for ${i}`);
	let o = ol(e, i, t), s = typeof e[i] == "number" ? e[i] : 5, c = "shape-radius2", l = ol(e, c, t), u = typeof e[c] == "number" ? e[c] : void 0, d = Qc(e, n, t), f = $c(e, n, t), p = ml(e, "shape-scale", t), m = fl(e, "shape-displacement", t), h = ol(e, "shape-rotation", t), g = ll(e, "shape-rotate-with-view", t), _ = new Nc({
		points: a,
		radius: s,
		radius2: u,
		angle: hl(e, "shape-angle"),
		declutterMode: xl(e, "shape-declutter-mode")
	});
	return function(e) {
...
function il(e, t) {
	let n = "circle-", r = Qc(e, n, t), i = $c(e, n, t), a = ol(e, "circle-radius", t), o = ml(e, "circle-scale", t), s = fl(e, "circle-displacement", t), c = ol(e, "circle-rotation", t), l = ll(e, "circle-rotate-with-view", t), u = new Pc({
		radius: 5,
		declutterMode: xl(e, "circle-declutter-mode")
	});
	return function(e) {
...
function cl(e, t, n) {
	let r = sl(e, t + "pattern-src", n), i = pl(e, t + "pattern-offset", n), a = pl(e, t + "pattern-size", n), o = ul(e, t + "color", n);
	return function(e) {
		return {
			src: r(e),
			offset: i && i(e),
...
function gl(e, t) {
	let n = e[t];
	if (n !== void 0) {
		if (typeof n == "number") return ns(n);
...
function Dl(e, t) {
	return typeof e == "number" ? e : El(e, t);
}
//#endregion
//#region node_modules/ol/layer/BaseVector.js
var Ol = { RENDER_ORDER: "renderOrder" }, kl = class extends lo {
	constructor(e) {
		e ||= {};
		let t = Object.assign({}, e);
	...
	getRenderOrder() {
		return this.get(Ol.RENDER_ORDER);
	}
	getStyle() {
		return this.style_;
	}
	...
	renderDeclutter(e, t) {
		...
		n in e.declutter || (e.declutter[n] = new ho(9)), this.getRenderer().renderDeclutter(e, t);
	}
	setRenderOrder(e) {
		this.set(Ol.RENDER_ORDER, e);
	}
	setStyle(e) {
		this.style_ = e === void 0 ? Hc : e;
		let t = Al(e);
		this.styleFunction_ = e === null ? void 0 : Bc(t), this.changed();
	}
	setDeclutter(e) {
...
function Al(e) {
	if (e === void 0) return Hc;
	if (!e) return null;
	if (typeof e == "function" || e instanceof zc) return e;
	if (Array.isArray(e) && e.length === 0) return [];
	if (Array.isArray(e) && e[0] instanceof zc) {
		let t = e.length, n = Array(t);
		for (let r = 0; r < t; ++r) {
			let t = e[r];
			if (!(t instanceof zc)) throw Error("Expected a list of style instances");
			n[r] = t;
		}
		return n;
	}
...
var jl = class extends ve {
	...
	forEachFeatureAtCoordinate(e, t, n, r, i, a, o, s) {
		...
		for (let r = 0; r < p.length; r++) for (let i = h - 1; i >= 0; --i) {
			let a = m[i], d = a.layer;
			if (d.hasRenderer() && uo(a, l) && o.call(s, d)) {
	...
	scheduleExpireIconCache(e) {
		rc.canExpireCache() && e.postRenderFunctions.push(Nl);
	}
};
function Nl(e, t) {
	rc.expire();
...
var Pl = class extends Ml {
	constructor(e) {
		super(e), this.fontChangeListenerKey_ = A(vc, re.PROPERTYCHANGE, e.redrawText, e), this.element_ = g ? D() : document.createElement("div");
	...
	renderFrame(e) {
		...
		this.calculateMatrices2D(e), this.dispatchRenderEvent(co.PRECOMPOSE, e);
		let t = e.layerStatesArray.sort((e, t) => e.zIndex - t.zIndex);
		t.some((e) => e.layer instanceof kl && e.layer.getDeclutter()) && (e.declutter = {});
		let n = e.viewState;
		...
		this.dispatchRenderEvent(co.POSTCOMPOSE, e), this.renderedVisible_ ||= (this.element_.style.display = "", !0), this.scheduleExpireIconCache(e);
	}
	declutter(e, t) {
		if (e.declutter) {
...
function Fl(e) {
	...
	e instanceof so && e.getLayers().forEach(Fl);
}
function Il(e, t) {
	if (e instanceof lo) {
		e.setMapInternal(t);
	...
	if (e instanceof so) {
		...
		for (let e = 0, r = n.length; e < r; ++e) Il(n[e], t);
	}
}
var Ll = class extends we {
	...
	getAllLayers() {
		...
		function t(n) {
			n.forEach(function(n) {
				n instanceof so ? t(n.getLayers()) : e.push(n);
			});
		}
	...
	handlePostRender() {
		...
		if (!t.isEmpty()) {
			let n = this.maxTilesLoading_, r = n, i = e ? e.viewHints : void 0, a = i ? i[z.ANIMATING] || i[z.INTERACTING] : !1;
			if (a) {
		...
		e && this.renderer_ && !e.animate && (this.renderComplete_ ? (this.hasListener(co.RENDERCOMPLETE) && this.renderer_.dispatchRenderEvent(co.RENDERCOMPLETE, e), this.loaded_ === !1 && (this.loaded_ = !0, this.dispatchEvent(new kr(N.LOADEND, this, e)))) : this.loaded_ === !0 && (this.loaded_ = !1, this.dispatchEvent(new kr(N.LOADSTART, this, e))));
	...
	handleTargetChanged_() {
		...
		if (this.targetElement_ = t, !t) this.renderer_ &&= (clearTimeout(this.postRenderTimeoutHandle_), this.postRenderTimeoutHandle_ = void 0, this.postRenderFunctions_.length = 0, this.renderer_.dispose(), null), this.animationDelayKey_ &&= (cancelAnimationFrame(this.animationDelayKey_), void 0);
			...
			if (O(t) || t.appendChild(this.viewport_), this.renderer_ ||= new Pl(this), !O(t)) {
	...
	updateSize() {
		...
		if (e) {
			...
			!isNaN(n) && !isNaN(r) && (t = [Math.max(0, n), Math.max(0, r)], !es(t) && (e.offsetWidth || e.offsetHeight || e.getClientRects().length) && Gt("No map visible because the map container's width or height are 0."));
		}
		let n = this.getSize();
...
function Rl(t) {
	...
	let r = {}, i = t.layers && typeof t.layers.getLayers == "function" ? t.layers : new so({ layers: t.layers });
	r[e.LAYERGROUP] = i, r[e.TARGET] = t.target, r[e.VIEW] = t.view instanceof la ? t.view : new la();
	let a;
...
var zl = {
	...
	constructor(e) {
		super(), this.on, this.once, this.un, this.options = e, this.id = e.id, this.insertFirst = e.insertFirst === void 0 || e.insertFirst, this.stopEvent = e.stopEvent === void 0 || e.stopEvent, this.element = document.createElement("div"), this.element.className = e.className === void 0 ? "ol-overlay-container " + n : e.className, this.element.style.position = "absolute", this.element.style.pointerEvents = "auto", this.autoPan = e.autoPan === !0 ? {} : e.autoPan || void 0, this.rendered = {
			transform_: "",
			visible: !0
		}, this.mapPostrenderListenerKey = null, this.addChangeListener(zl.ELEMENT, this.handleElementChanged), this.addChangeListener(zl.MAP, this.handleMapChanged), this.addChangeListener(zl.OFFSET, this.handleOffsetChanged), this.addChangeListener(zl.POSITION, this.handlePositionChanged), this.addChangeListener(zl.POSITIONING, this.handlePositioningChanged), e.element !== void 0 && this.setElement(e.element), this.setOffset(e.offset === void 0 ? [0, 0] : e.offset), this.setPositioning(e.positioning || "top-left"), e.position !== void 0 && this.setPosition(e.position);
	}
	getElement() {
		return this.get(zl.ELEMENT);
	}
	getId() {
		return this.id;
	}
	getMap() {
		return this.get(zl.MAP) || null;
	}
	getOffset() {
		return this.get(zl.OFFSET);
	}
	getPosition() {
		return this.get(zl.POSITION);
	}
	getPositioning() {
		return this.get(zl.POSITIONING);
	}
	...
	setElement(e) {
		this.set(zl.ELEMENT, e);
	}
	setMap(e) {
		this.set(zl.MAP, e);
	}
	setOffset(e) {
		this.set(zl.OFFSET, e);
	}
	setPosition(e) {
		this.set(zl.POSITION, e);
	}
	performAutoPan() {
	...
	panIntoView(e) {
		let t = this.getMap();
		if (!t || !t.getTargetElement() || !this.get(zl.POSITION)) return;
...
}, Vl = .75, Hl = .1, Ul = class extends Te {
	constructor(e) {
		e ||= {}, super({
			element: document.createElement("div"),
			render: e.render,
		...
		d.className = "ol-overviewmap-box", d.style.boxSizing = "border-box", this.boxOverlay_ = new Bl({
			position: [0, 0],
	...
	bindView_(e) {
		if (!this.view_) {
			let t = new la({ projection: e.getProjection() });
			this.ovmap_.setView(t);
		}
		e.addChangeListener(Lr.ROTATION, this.boundHandleRotationChanged_), this.handleRotationChanged_(), e.isDef() && (this.ovmap_.updateSize(), this.resetExtent_());
	}
	unbindView_(e) {
		e.removeChangeListener(Lr.ROTATION, this.boundHandleRotationChanged_);
	}
	...
	validateExtent_() {
		...
		c < u * Hl || l < d * Hl || c > u * Vl || l > d * Vl ? this.resetExtent_() : Ve(a, r) || this.recenter_();
	}
	resetExtent_() {
		let e = this.getMap(), t = this.ovmap_, n = e.getSize(), r = e.getView().calculateExtentInternal(n), i = t.getView();
		gt(r, 1 / (2 ** (Math.log(Vl / Hl) / Math.LN2 / 2) * Hl)), i.fitInternal(Qi(r));
	}
	recenter_() {
	...
	2,
	5
], Kl = 25.4 / .28, ql = class extends Te {
	constructor(e) {
		e ||= {};
		let t = document.createElement("div");
		...
		this.innerElement_ = document.createElement("div"), this.innerElement_.className = n + "-inner", this.element.className = n + " " + r, this.element.appendChild(this.innerElement_), this.viewState_ = null, this.minWidth_ = e.minWidth === void 0 ? 64 : e.minWidth, this.maxWidth_ = e.maxWidth, this.renderedVisible_ = !1, this.renderedWidth_ = void 0, this.renderedHTML_ = "", this.addChangeListener(Wl, this.handleUnitsChanged_), this.setUnits(e.units || "metric"), this.scaleBar_ = e.bar || !1, this.scaleBarSteps_ = e.steps || 4, this.scaleBarText_ = e.text || !1, this.dpi_ = e.dpi || void 0;
	}
	getUnits() {
		return this.get(Wl);
	}
	...
	updateElement_() {
		...
		let t = e.center, n = e.projection, r = this.getUnits(), i = r == "degrees" ? "degrees" : "m", a = rr(n, e.resolution, t, i), o = this.minWidth_ * (this.dpi_ || Kl) / Kl, s = this.maxWidth_ === void 0 ? void 0 : this.maxWidth_ * (this.dpi_ || Kl) / Kl, c = o * a, l = "";
		if (r == "degrees") {
			let e = Kt.degrees;
		...
		for (;;) {
			p = Math.floor(u / 3);
			let e = 10 ** p;
			if (d = Gl[(u % 3 + 3) % 3] * e, f = Math.round(d / a), isNaN(f)) {
	...
	getScaleForResolution() {
		let e = rr(this.viewState_.projection, this.viewState_.resolution, this.viewState_.center, "m"), t = this.dpi_ || Kl;
		return 1e3 / 25.4 * e * t;
	}
	render(e) {
		let t = e.frameState;
	...
	getAlpha(e, t) {
		...
		let r = t - n + 1e3 / 60;
		return r >= this.transition_ ? 1 : Br(r / this.transition_);
	}
	inTransition(e) {
...
var Xl = /* @__PURE__ */ Error("disposed"), Zl = [256, 256], Ql = class extends Jl {
	constructor(e) {
		let t = L.IDLE;
		super(e.tileCoord, t, {
	...
	disposeInternal() {
		this.controller_ &&= (this.controller_.abort(Xl), null), super.disposeInternal();
	}
}, $l = class extends Jl {
	constructor(e, t, n, r, i, a) {
	...
	handleImageError_() {
		this.state = L.ERROR, this.unlistenImage_(), this.image_ = eu(), this.changed();
	}
	handleImageLoad_() {
	...
	load() {
		this.state == L.ERROR && (this.state = L.IDLE, this.image_ = new Image(), this.crossOrigin_ !== null && (this.image_.crossOrigin = this.crossOrigin_), this.referrerPolicy_ !== void 0 && (this.image_.referrerPolicy = this.referrerPolicy_)), this.state == L.IDLE && (this.state = L.LOADING, this.changed(), this.tileLoadFunction_(this, this.src_), this.unlisten_ = Qs(this.image_, this.handleImageLoad_.bind(this), this.handleImageError_.bind(this)));
	}
	unlistenImage_() {
...
function nu(e, t, n, r, i) {
	return i === void 0 ? new tu(e, t, n, r) : (i.minX = e, i.maxX = t, i.minY = n, i.maxY = r, i);
}
//#endregion
...
function su() {
	if (ru === void 0) {
		let e = y(6, 6, iu);
		e.globalCompositeOperation = "lighter", e.fillStyle = "rgba(210, 0, 0, 0.75)", au(e, 4, 5, 4, 0), au(e, 4, 5, 0, 5);
		let t = e.getImageData(0, 0, 3, 3).data;
		ru = ou(t, 0) || ou(t, 4) || ou(t, 8), S(e), iu.push(e.canvas);
	}
	return ru;
}
function cu(e, t, n, r) {
...
function lu(e, t, n, r) {
	...
	return (!isFinite(i) || i <= 0) && et(n, function(n) {
		return i = cu(e, t, n, r), isFinite(i) && i > 0;
	}), i;
}
function uu(e, t, n, r, i, a, o, s, c, l, u, d, f, p) {
	let m = y(Math.round(n * e), Math.round(n * t), iu);
	...
	if (!f || c.length !== 1 || l !== 0) {
		if (_ = y(Math.round(I(g) * v), Math.round(ct(g) * v), iu), d || (_.imageSmoothingEnabled = !1), i && p) {
	...
	}), _ && (S(_), iu.push(_.canvas)), u && (m.save(), m.globalCompositeOperation = "source-over", m.strokeStyle = "black", m.lineWidth = 1, s.getTriangles().forEach(function(e, t, n) {
...
var du = 10, fu = .25, pu = class {
	constructor(e, t, n, r, i, a, o) {
		this.sourceProj_ = e, this.targetProj_ = t;
		let s = {}, c = o ? sr((e) => B(o, fr(e, this.targetProj_, this.sourceProj_))) : dr(this.targetProj_, this.sourceProj_);
		...
		let l = dt(n), u = ft(n), d = rt(n), f = nt(n), p = this.transformInv_(l), m = this.transformInv_(u), h = this.transformInv_(d), g = this.transformInv_(f), _ = du + (a ? Math.max(0, Math.ceil(Math.log2(tt(n) / (a * a * 256 * 256)))) : 0);
	...
	addQuad_(e, t, n, r, i, a, o, s, c) {
		...
		if (c > 0 && (this.targetProj_.isGlobal() && this.targetWorldWidth_ && (p = I(Fe([
			...
			n,
			r
		])) / this.targetWorldWidth_ > fu || p), !f && this.sourceProj_.isGlobal() && u && (p = u > fu || p)), !p && this.maxSourceExtent_ && isFinite(l[0]) && isFinite(l[1]) && isFinite(l[2]) && isFinite(l[3]) && !pt(l, this.maxSourceExtent_)) return;
		let m = 0;
	...
	constructor(e, t, n, r, i, a, o, s, c, l, u, d) {
		...
		let g = e.getExtent();
		g && (m = m ? lt(m, g) : g);
		let _ = r.getResolution(this.wrappedTileCoord_[0]), v = lu(e, n, h, _);
		if (!isFinite(v) || v <= 0) {
			this.state = L.EMPTY;
			return;
		}
		let y = l === void 0 ? mu : l;
		if (this.triangulation_ = new pu(e, n, h, m, v * y, _), this.triangulation_.getTriangles().length === 0) {
			this.state = L.EMPTY;
			return;
		}
	...
	reproject_() {
		...
		if (this.sourceTiles_.forEach((t) => {
			...
			this.canvas_ = uu(r, i, this.pixelRatio_, o, this.sourceTileGrid_.getExtent(), a, s, this.triangulation_, e, this.gutter_, this.renderEdges_, this.interpolate), this.state = L.LOADED;
		}
		this.changed();
	}
	load() {
	...
	release() {
		this.canvas_ &&= (S(this.canvas_.getContext("2d")), iu.push(this.canvas_), null), this.sourceTiles_.length = 0, super.release();
	}
}, gu = class {
	constructor(e) {
...
function yu(e, t, n, r, i) {
	return `${F(e)},${t},${vu(n, r, i)}`;
}
function bu(e) {
	return xu(e[0], e[1], e[2]);
}
function xu(e, t, n) {
	return (t << e) + n;
}
...
var Cu = class {
...
}, wu = 5, Tu = class extends be {
	constructor(e) {
		super(), this.ready = !0, this.boundHandleImageChange_ = this.handleImageChange_.bind(this), this.layer_ = e, this.staleKeys_ = [], this.maxStaleKeys = wu, this.renderedSourceKey_;
	}
	getStaleKeys() {
	...
	handleImageChange_(e) {
		let t = e.target;
		(t.getState() === Y.LOADED || t.getState() === Y.ERROR) && this.renderIfReadyAndVisible();
	}
	loadImage(e) {
		let t = e.getState();
		return t != Y.LOADED && t != Y.ERROR && e.addEventListener(M.CHANGE, this.boundHandleImageChange_), t == Y.IDLE && (e.load(), t = e.getState()), t == Y.LOADED;
	}
...
function Ou() {
	Du = y(1, 1, void 0, { willReadFrequently: !0 });
}
var ku = class extends Tu {
	constructor(e) {
	...
	getImageData(e, t, n) {
		Du || Ou(), Du.clearRect(0, 0, 1, 1);
		let r;
		try {
			Du.drawImage(e, t, n, 1, 1, 0, 0, 1, 1), r = Du.getImageData(0, 0, 1, 1).data;
		} catch {
			return Du = null, null;
		}
		return r;
	...
	useContainer(e, t, n, r, i) {
		...
		if (e && e.className === a && (!n || e && e.style.backgroundColor && de(Qo(e.style.backgroundColor), Qo(n)))) {
	...
	dispatchRenderEvent_(e, t, n) {
		let r = this.getLayer();
		if (r.hasListener(e)) {
			let i = new jl(e, this.inversePixelTransform, n, t);
			r.dispatchEvent(i);
		}
	}
	preRender(e, t) {
		this.frameState = t, !t.declutter && this.dispatchRenderEvent_(co.PRERENDER, e, t);
	}
	postRender(e, t) {
		t.declutter || this.dispatchRenderEvent_(co.POSTRENDER, e, t);
	}
	...
	renderDeferred(e) {
		e.declutter && (this.dispatchRenderEvent_(co.PRERENDER, this.context, e), e.declutter && this.deferredContext_ && (this.deferredContext_.draw(this.context), this.deferredContext_.clear()), this.renderDeferredInternal(e), this.dispatchRenderEvent_(co.POSTRENDER, this.context, e));
	}
...
var Nu = class extends ku {
	constructor(e, t) {
		super(e), t ||= {}, this.extentChanged = !0, this.renderComplete = !1, this.renderedExtent_ = null, this.renderedPixelRatio, this.renderedProjection = null, this.renderedTiles = [], this.renderedSourceRevision_, this.tempExtent = We(), this.tempTileRange_ = new tu(0, 0, 0, 0), this.tempTileCoord_ = _u(0, 0, 0);
		let n = t.cacheSize === void 0 ? 512 : t.cacheSize;
		this.tileCache_ = new gu(n), this.sourceTileCache_ = null, this.layerExtent = null, this.maxStaleKeys = n * .5;
	}
	getTileCache() {
		return this.tileCache_;
	}
	getSourceTileCache() {
		return this.sourceTileCache_ ||= new gu(512), this.sourceTileCache_;
	}
	getOrCreateTile(e, t, n, r) {
		let i = this.tileCache_, a = this.getLayer().getSource(), o = yu(a, a.getKey(), e, t, n), s;
	...
	getData(e) {
		...
		for (let e = s.getZForResolution(a.resolution); e >= s.getMinZoom(); --e) {
			...
			let l = s.getOrigin(e), u = ns(s.getTileSize(e)), d = s.getResolution(e), f;
			if (i instanceof $l || i instanceof hu) f = i.getImage();
			else if (i instanceof Ql) {
				if (f = Yl(i.getData()), !f) continue;
			} else continue;
	...
	enqueueTiles(e, t, n, r, i) {
		...
		for (let i = n; i >= f; --i) {
			...
			for (let t = n.minX; t <= n.maxX; ++t) for (let o = n.minY; o <= n.maxY; ++o) {
				...
				if (!n || !Au(r, n, i)) continue;
				let s = n.getKey();
				if (u[s] = !0, n.getState() === L.IDLE && !e.tileQueue.isKeyQueued(s)) {
					let r = _u(i, t, o, this.tempTileCoord_);
					e.tileQueue.enqueue([
						n,
						l,
	...
	findStaleTile_(e, t) {
		...
		for (let e = 0; e < o.length; ++e) {
			let s = yu(this.getLayer().getSource(), o[e], r, i, a);
			if (n.containsKey(s)) {
				let e = n.peek(s);
				if (e.getState() === L.LOADED) return e.endTransition(F(this)), Au(t, e, r), !0;
			}
		}
		return !1;
	}
	findAltTiles_(e, t, n, r) {
		...
		for (let e = i.minX; e <= i.maxX; ++e) for (let t = i.minY; t <= i.maxY; ++t) {
			let i = yu(s, c, n, e, t), l = !1;
			if (o.containsKey(i)) {
				let e = o.peek(i);
				e.getState() === L.LOADED && (Au(r, e, n), l = !0);
			}
			l || (a = !1);
		}
		return a;
	...
	renderFrame(e, t) {
		...
		if (e.nextExtent && this.enqueueTilesForNextExtent()) {
			let t = u.getZForResolution(r.nextResolution, l.zDirection), n = Mu(e, e.nextExtent);
		...
		$r(this.tempTransform, h / 2, g / 2, T, T, 0, -h / 2, -g / 2), this.layerExtent && this.clipUnrotated(E, e, this.layerExtent), l.getInterpolate() || (E.imageSmoothingEnabled = !1), this.preRender(E, e);
		let ee = Object.keys(b).map(Number);
		ee.sort(oe);
		let D = [], O = [], k = [];
		for (let t = ee.length - 1; t >= 0; --t) {
			let n = ee[t], r = l.getTilePixelSize(n, s, i), a = u.getResolution(n) / f, o = r[0] * a * T, c = r[1] * a * T, p = u.getTileCoordForCoordAndZ(dt(y), n), h = u.getTileCoordExtent(p), g = B(this.tempTransform, [m * (h[0] - y[0]) / f, m * (y[3] - h[3]) / f]), _ = m * l.getGutterForProjection(i);
			for (let t of b[n]) {
	...
	drawTile(e, t, n, r, i, a, o, s, c) {
		let l;
		if (e instanceof Ql) {
			if (l = Yl(e.getData()), !l) throw Error("Rendering array data is not yet supported");
	...
	getPreload() {
		return this.get(Pu.PRELOAD);
	}
	setPreload(e) {
		this.set(Pu.PRELOAD, e);
	}
	getUseInterimTilesOnError() {
		return this.get(Pu.USE_INTERIM_TILES_ON_ERROR);
	}
	setUseInterimTilesOnError(e) {
		this.set(Pu.USE_INTERIM_TILES_ON_ERROR, e);
	}
	getData(e) {
	...
	createRenderer() {
		return new Nu(this, { cacheSize: this.getCacheSize() });
	}
}, Lu = [
	0,
	0,
	...
	constructor(e) {
		...
		i !== void 0 && !this.origin_ && !this.origins_ && (this.origin_ = dt(i)), R(!this.origin_ && this.origins_ || this.origin_ && !this.origins_, "Either `origin` or `origins` must be configured, never both"), this.tileSizes_ = null, e.tileSizes !== void 0 && (this.tileSizes_ = e.tileSizes, R(this.tileSizes_.length == this.resolutions_.length, "Number of `tileSizes` and `resolutions` must be equal")), this.tileSize_ = e.tileSize === void 0 ? this.tileSizes_ ? null : 256 : e.tileSize, R(!this.tileSize_ && this.tileSizes_ || this.tileSize_ && !this.tileSizes_, "Either `tileSize` or `tileSizes` must be configured, never both"), this.extent_ = i === void 0 ? null : i, this.fullTileRanges_ = null, this.tmpSize_ = [0, 0], this.tmpExtent_ = [
			...
			let n = new tu(Math.min(0, e[0]), Math.max(e[0] - 1, -1), Math.min(0, e[1]), Math.max(e[1] - 1, -1));
			if (i) {
	...
	forEachTileCoordParentTileRange(e, t, n, r) {
		...
		for (this.zoomFactor_ === 2 ? (a = e[1], o = e[2]) : s = this.getTileCoordExtent(e, r); c >= this.minZoom;) {
			if (a !== void 0 && o !== void 0 ? (a = Math.floor(a / 2), o = Math.floor(o / 2), i = nu(a, a, o, o, n)) : i = this.getTileRangeForExtentAndZ(s, c, n), t(c, i)) return !0;
			--c;
		}
		return !1;
	}
	...
	getTileRangeForTileCoordAndZ(e, t, n) {
		...
		if (t === r) return nu(i, a, i, a, n);
		if (this.zoomFactor_) {
			let e = this.zoomFactor_ ** +(t - r), o = Math.floor(i * e), s = Math.floor(a * e);
			return t < r ? nu(o, o, s, s, n) : nu(o, Math.floor(e * (i + 1)) - 1, s, Math.floor(e * (a + 1)) - 1, n);
		}
	...
	getTileRangeForExtentAndZ(e, t, n) {
		this.getTileCoordForXYAndZ_(e[0], e[3], t, !1, Lu);
		let r = Lu[1], i = Lu[2];
		this.getTileCoordForXYAndZ_(e[2], e[1], t, !0, Lu);
		let a = Lu[1], o = Lu[2];
		return nu(r, a, i, o, n);
	}
	getTileCoordCenter(e) {
		let t = this.getOrigin(e[0]), n = this.getResolution(e[0]), r = ns(this.getTileSize(e[0]), this.tmpSize_);
		return [t[0] + (e[1] + .5) * r[0] * n, t[1] - (e[2] + .5) * r[1] * n];
	}
	getTileCoordExtent(e, t) {
		let n = this.getOrigin(e[0]), r = this.getResolution(e[0]), i = ns(this.getTileSize(e[0]), this.tmpSize_), a = n[0] + e[1] * i[0] * r, o = n[1] - (e[2] + 1) * i[1] * r;
	...
	getTileCoordForXYAndResolution_(e, t, n, r, i) {
		let a = this.getZForResolution(n), o = n / this.getResolution(a), s = this.getOrigin(a), c = ns(this.getTileSize(a), this.tmpSize_), l = o * (e - s[0]) / n / c[0], u = o * (s[1] - t) / n / c[1];
		return r ? (l = Mt(l, Ru) - 1, u = Mt(u, Ru) - 1) : (l = jt(l, Ru), u = jt(u, Ru)), _u(a, l, u, i);
	}
	getTileCoordForXYAndZ_(e, t, n, r, i) {
		let a = this.getOrigin(n), o = this.getResolution(n), s = ns(this.getTileSize(n), this.tmpSize_), c = (e - a[0]) / o / s[0], l = (a[1] - t) / o / s[1];
		return r ? (c = Mt(c, Ru) - 1, l = Mt(l, Ru) - 1) : (c = jt(c, Ru), l = jt(l, Ru)), _u(n, c, l, i);
	}
	...
	tileCoordIntersectsViewport(e, t) {
		return Fi(t, 0, t.length, 2, this.getTileCoordExtent(e));
	}
...
}, Bu = /\{z\}/g, Vu = /\{x\}/g, Hu = /\{y\}/g, Uu = /\{-y\}/g;
function Wu(e, t, n, r, i) {
	return e.replace(Bu, t.toString()).replace(Vu, n.toString()).replace(Hu, r.toString()).replace(Uu, function() {
...
function qu(e, t) {
	let n = e.length, r = Array(n);
	for (let i = 0; i < n; ++i) r[i] = Ku(e[i], t);
	return Ju(r);
}
function Ju(e) {
	return e.length === 1 ? e[0] : (function(t, n, r) {
		return t ? e[Ot(bu(t), e.length)](t, n, r) : void 0;
	});
}
//#endregion
...
function Yu(e) {
	...
	return t || (t = $u(e), e.setDefaultTileGrid(t)), t;
}
function Xu(e, t, n) {
	let r = t[0], i = e.getTileCoordCenter(t), a = ed(n);
	if (!Be(a, i)) {
...
function Qu(e, t, n, r) {
	t = t === void 0 ? 42 : t, n = ns(n === void 0 ? 256 : n);
	let i = ct(e), a = I(e);
...
var td = class extends we {
	constructor(e) {
		super(), this.projection = nr(e.projection), this.attributions_ = nd(e.attributions), this.attributionsCollapsible_ = e.attributionsCollapsible ?? !0, this.loading = !1, this.state_ = e.state === void 0 ? "ready" : e.state, this.wrapX_ = e.wrapX !== void 0 && e.wrapX, this.interpolate_ = !!e.interpolate, this.viewResolver = null, this.viewRejector = null;
		let t = this;
	...
	setAttributions(e) {
		this.attributions_ = nd(e), this.changed();
	}
	setState(e) {
...
var rd = class extends td {
	constructor(e) {
		super({
			...
			wrapX: e.wrapX,
			interpolate: e.interpolate
		}), this.on, this.once, this.un, this.tilePixelRatio_ = e.tilePixelRatio === void 0 ? 1 : e.tilePixelRatio, this.tileGrid = e.tileGrid === void 0 ? null : e.tileGrid, this.tileGrid && ns(this.tileGrid.getTileSize(this.tileGrid.getMinZoom()), [256, 256]), this.tmpSize = [0, 0], this.key_ = e.key || F(this), this.tileOptions = {
			transition: e.transition,
			interpolate: e.interpolate
	...
	getTileGridForProjection(e) {
		return this.tileGrid ? this.tileGrid : Yu(e);
	}
	getTilePixelRatio(e) {
		return this.tilePixelRatio_;
	}
	getTilePixelSize(e, t, n) {
		let r = this.getTileGridForProjection(n), i = this.getTilePixelRatio(t), a = ns(r.getTileSize(e), this.tmpSize);
		return i == 1 ? a : ts(a, i, this.tmpSize);
	}
	getTileCoordForTileUrlFunction(e, t) {
		...
		return this.getWrapX() && n.isGlobal() && (e = Xu(r, e, n)), Su(e, r) ? e : null;
	}
	clear() {}
	refresh() {
	...
	handleTileChange(e) {
		...
		r == L.LOADING ? (this.tileLoadingKeys_[n] = !0, i = ad.TILELOADSTART) : n in this.tileLoadingKeys_ && (delete this.tileLoadingKeys_[n], i = r == L.ERROR ? ad.TILELOADERROR : r == L.LOADED ? ad.TILELOADEND : void 0), i != null && this.dispatchEvent(new id(i, t));
	}
	...
	setUrls(e) {
		this.urls = e;
		let t = e.join("\n");
		this.generateTileUrlFunction_ ? this.setTileUrlFunction(qu(e, this.tileGrid), t) : this.setKey(t);
	}
	...
	constructor(e) {
		super({
			...
			state: e.state,
			tileGrid: e.tileGrid,
			tileLoadFunction: e.tileLoadFunction ? e.tileLoadFunction : cd,
		...
		}), this.crossOrigin = e.crossOrigin === void 0 ? null : e.crossOrigin, this.referrerPolicy = e.referrerPolicy, this.tileClass = e.tileClass === void 0 ? $l : e.tileClass, this.tileGridForProjection = {}, this.reprojectionErrorThreshold_ = e.reprojectionErrorThreshold, this.renderReprojectionEdges_ = !1;
	}
	getGutterForProjection(e) {
	...
	getTileGridForProjection(e) {
		...
		let n = F(e);
		return n in this.tileGridForProjection || (this.tileGridForProjection[n] = Yu(e)), this.tileGridForProjection[n];
	}
	...
	getTile(e, t, n, r, i, a) {
		...
		let s = [
			...
			t,
			n
		], c = this.getKey(), l = new hu(o, this.getTileGridForProjection(o), i, this.getTileGridForProjection(i), s, this.getTileCoordForTileUrlFunction(s, i), this.getTilePixelRatio(r), this.getGutter(), (e, t, n, r) => this.getTileInternal(e, t, n, r, o, a), this.reprojectionErrorThreshold_, this.renderReprojectionEdges_, this.tileOptions);
		return l.key = c, l;
	}
	getTileInternal(e, t, n, r, i, a) {
		let o = this.getKey(), s = yu(this, o, e, t, n);
...
var ld = class extends $l {
	...
	constructor(e) {
		...
		let g = Ju(p.map(h)), _ = ld.bind(null, ns(s * r));
		super({
			attributions: e.attributions,
			cacheSize: e.cacheSize,
	...
	setStyle(e) {
		this._style = e || new zc({});
	}
	getStyle() {
		return this._style;
	}
	getStroke() {
		return this._style.getStroke() || this._style.setStroke(new Rc({
			color: "#000",
			width: 1.25
		})), this._style.getStroke();
	}
	getFill() {
		return this._style.getFill() || this._style.setFill(new Fc({ color: "#fff" })), this._style.getFill();
	}
	getTextStroke() {
		var e = this._style.getText();
		return e ||= new Gc({}), e.getStroke() || e.setStroke(new Rc({
			color: "#fff",
			width: 3
		})), e.getStroke();
	}
	getTextFill() {
		var e = this._style.getText();
		return e ||= new Gc({}), e.getFill() || e.setFill(new Fc({ color: "#fff" })), e.getFill();
	}
	getTextFont() {
		var e = this._style.getText();
		return e ||= new Gc({}), e.getFont() || e.setFont("12px sans-serif"), e.getFont();
	}
	_draw() {
	...
	constructor(e) {
		...
		this.fac = 1e4 / this.fac, this.set("maxResolution", e.maxResolution || Infinity), this.set("step", e.step || .1), this.set("stepCoord", e.stepCoord || 1), this.set("spacing", e.spacing || 40), this.set("intervals", e.intervals), this.set("precision", e.precision), this.set("margin", e.margin || 0), this.set("borderWidth", e.borderWidth || 5), this.set("stroke", e.stroke !== !1), this.formatCoord = e.formatCoord || function(e) {
			return e;
		}, e.style instanceof zc ? this.setStyle(e.style) : this.setStyle(new zc({
			stroke: new Rc({
				color: "#000",
				width: 1
			}),
			fill: new Fc({ color: "#fff" }),
			text: new Gc({
				stroke: new Rc({
					color: "#fff",
					width: 2
				}),
				fill: new Fc({ color: "#000" })
			})
		}));
	}
	setStyle(e) {
	...
	SET_STROKE_STYLE: 11,
	STROKE: 12
}, hd = [X.FILL], gd = [X.STROKE], _d = [X.BEGIN_PATH], vd = [X.CLOSE_PATH], yd = class extends md {
	constructor(e, t, n, r) {
	...
	reverseHitDetectionInstructions() {
		...
		for (t = 0; t < n; ++t) r = e[t], i = r[0], i == X.END_GEOMETRY ? a = t : i == X.BEGIN_GEOMETRY && (r[2] = t, le(this.hitDetectionInstructions, a, t), a = -1);
	}
	fillStyleToState(e, t = {}) {
		if (e) {
			let n = e.getColor();
			t.fillPatternScale = n && typeof n == "object" && "src" in n ? this.pixelRatio : 1, t.fillStyle = sc(n || "#000") ?? void 0;
		} else t.fillStyle = void 0;
		return t;
	}
	strokeStyleToState(e, t = {}) {
		if (e) {
			t.strokeStyle = sc(e.getColor() || mc);
			let n = e.getLineCap();
			t.lineCap = n === void 0 ? dc : n;
			let r = e.getLineDash();
			t.lineDash = r ? r.slice() : fc, t.lineDashOffset = e.getLineDashOffset() || 0;
			let i = e.getLineJoin();
			t.lineJoin = i === void 0 ? pc : i;
			let a = e.getWidth();
	...
	drawLineString(e, t, n) {
		...
		this.drawFlatCoordinates_(s, 0, s.length, c, o), this.hitDetectionInstructions.push(gd), this.endGeometry(t);
	}
	drawMultiLineString(e, t, n) {
		let r = this.state, i = r.strokeStyle, a = r.lineWidth, o = r.strokeOffset;
		if (i === void 0 || a === void 0) return;
		...
		this.hitDetectionInstructions.push(gd), this.endGeometry(t);
	}
	finish() {
		let e = this.state;
		return e.lastStroke != null && e.lastStroke != this.coordinates.length && this.instructions.push(gd), this.reverseHitDetectionInstructions(), this.state = null, super.finish();
	}
	applyStroke(e) {
		e.lastStroke != null && e.lastStroke != this.coordinates.length && (this.instructions.push(gd), e.lastStroke = this.coordinates.length), e.lastStroke = 0, super.applyStroke(e), this.instructions.push(_d);
	}
}, Sd = class extends yd {
	constructor(e, t, n, r) {
		super(e, t, n, r);
	...
	drawFlatCoordinatess_(e, t, n, r, i) {
		...
		this.instructions.push(_d), this.hitDetectionInstructions.push(_d);
		for (let a = 0; a < c; ++a) {
			...
			this.instructions.push([
				...
				i,
				!0
			]), s && (this.instructions.push(vd), this.hitDetectionInstructions.push(vd)), t = o;
		}
		return o && (this.instructions.push(hd), this.hitDetectionInstructions.push(hd)), s && (this.instructions.push(gd), this.hitDetectionInstructions.push(gd)), t;
	}
	drawCircle(e, t, n) {
		...
		this.instructions.push(_d, u), this.hitDetectionInstructions.push(_d, u), r.fillStyle !== void 0 && (this.instructions.push(hd), this.hitDetectionInstructions.push(hd)), r.strokeStyle !== void 0 && (this.instructions.push(gd), this.hitDetectionInstructions.push(gd)), this.endGeometry(t);
	}
	drawPolygon(e, t, n) {
		let r = this.state, i = r.fillStyle, a = r.strokeStyle, o = r.strokeOffset;
	...
	finish() {
		...
		if (e !== 0) {
			...
			for (let n = 0, r = t.length; n < r; ++n) t[n] = zi(t[n], e);
		}
		return super.finish();
	}
...
function Ed(e, t, n, r) {
	...
	for (let r = 0, m = t.length; r < m; ++r) {
		...
		for (let t = p + n; t < m; t += n) {
			let n = e[t], r = e[t + 1];
			if (Td(i, a, o, s, h, g, n, r)) {
				let e = n - h, t = r - g, i = h + Cd * e, a = g + Cd * t, o = h + wd * e, s = g + wd * t;
...
var kd = {
	...
	Text: class extends yd {
		...
		drawText(e, t, n) {
			...
			if (a.placement === "line" && (c == "LineString" || c == "MultiLineString" || c == "Polygon" || c == "MultiPolygon")) {
				...
				if ((c == "LineString" || c == "MultiLineString") && !Ve(this.getBufferedMaxExtent(), r)) {
					let e = Ed(l, i, u, this.getBufferedMaxExtent());
				...
				for (let e = 0, t = i.length; e < t; ++e) {
					let t;
					t = d ? Dd(d * this.resolution, l, p, i[e], u) : [l.slice(p, i[e])];
					for (let n = 0, r = t.length; n < r; ++n) {
						let r = t[n], c = 0, l = r.length;
						if (f == null) {
							let e = Od(a.maxAngle, r, 0, r.length, 2);
							c = e[0], l = e[1];
						}
				...
				this.beginGeometry(e, t, n);
				let p = a.padding;
				if (p != _c && (a.scale[0] < 0 || a.scale[1] < 0)) {
		...
		drawChars_(e, t) {
			...
			this.saveTextStates_();
			let s = this.pixelRatio, c = kd[r.textBaseline], l = this.textOffsetX_ * s, u = this.textOffsetY_ * s, d = this.text_, f = n ? n.lineWidth * Math.abs(r.scale[0]) / 2 : 0;
			this.instructions.push([
				X.DRAW_CHARS,
				e,
				t,
		...
		setTextStyle(e, t) {
			...
			if (!e) this.text_ = "";
				...
				let t = e.getFill();
				t ? (r = this.textFillState_, r || (r = {}, this.textFillState_ = r), r.fillStyle = sc(t.getColor() || "#000")) : (r = null, this.textFillState_ = r);
				let a = e.getStroke();
...
function Nd(e, t, n, r, i, a, o, s) {
	...
	for (let x = t; x < n; x += r) {
		m = f, h = p, g = void 0, _ = void 0, x + r < n && (g = e[x + r], _ = e[x + r + 1]), a && x === t && (m = u, h = d), a && x === n - r && (g = c, _ = l), f = e[x], p = e[x + 1], [v, y] = Pd(f, p, m, h, g, _, i), o[b++] = v, o[b++] = y;
...
var Id;
function Ld() {
	return Id ||= new Intl.Segmenter(void 0, { granularity: "grapheme" }), Id;
}
function Rd(e, t, n, r, i, a, o, s, c, l, u, d, f = !0) {
	...
	i = i.replace(/\n/g, " ");
	let ne = Array.from(Ld().segment(i), (e) => e.segment);
...
var zd = We(), Bd = [], Vd = [], Hd = [], Ud = [];
function Wd(e) {
	return e[3].declutterBox;
}
var Gd = /* @__PURE__ */ RegExp("[֑-ࣿיִ-﷿ﹰ-ﻼࠀ-࿿-]");
function Kd(e, t) {
	return t === "start" ? t = Gd.test(e) ? "right" : "left" : t === "end" && (t = Gd.test(e) ? "left" : "right"), kd[t];
}
function qd(e, t, n) {
	return n > 0 && e.push("\n", ""), e.push(t, ""), e;
}
...
var Yd = class {
	...
	createLabel(e, t, n, r) {
		...
		let a = r ? this.strokeStates[r] : null, o = n ? this.fillStates[n] : null, s = this.textStates[t], c = this.pixelRatio, l = [s.scale[0] * c, s.scale[1] * c], u = s.justify ? kd[s.justify] : Kd(Array.isArray(e) ? e[0] : e, s.textAlign || "center"), d = r && a.lineWidth ? a.lineWidth : 0, f = Array.isArray(e) ? e : String(e).split("\n").reduce(qd, []), { width: p, height: m, widths: h, heights: g, lineWidths: _ } = kc(s, f), v = p + d, y = [], b = (v + 2) * l[0], x = (m + d) * l[1], S = {
	...
	calculateImageOrLabelDimensions_(e, t, n, r, i, a, o, s, c, l, u, d, f, p, m, h) {
		...
		(m || u !== 0) && (Bd[0] = S, Ud[0] = S, Bd[1] = C, Vd[1] = C, Vd[0] = S + b, Hd[0] = Vd[0], Hd[1] = C + x, Ud[1] = Hd[1]);
		let w;
		return u === 0 ? Ge(Math.min(S, S + b), Math.min(C, C + x), Math.max(S, S + b), Math.max(C, C + x), zd) : (w = $r(Kr(), n, r, 1, 1, u, -n, -r), B(w, Bd), B(w, Vd), B(w, Hd), B(w, Ud), Ge(Math.min(Bd[0], Vd[0], Hd[0], Ud[0]), Math.min(Bd[1], Vd[1], Hd[1], Ud[1]), Math.max(Bd[0], Vd[0], Hd[0], Ud[0]), Math.max(Bd[1], Vd[1], Hd[1], Ud[1]), zd)), f && (g = Math.round(g), _ = Math.round(_)), {
			drawImageX: g,
			drawImageY: _,
			drawImageW: v,
			drawImageH: y,
	...
	replayImageOrLabel_(e, t, n, r, i, a, o) {
		...
		return c.minX - l <= t[0] && c.maxX + l >= 0 && c.minY - l <= t[1] && c.maxY + l >= 0 && (s && this.replayTextBackground_(e, Bd, Vd, Hd, Ud, a, o), Ac(e, r.canvasTransform, i, n, r.originX, r.originY, r.drawImageW, r.drawImageH, r.drawImageX, r.drawImageY, r.scale)), !0;
	}
	fill_(e) {
	...
	drawLabelWithPointPlacement_(e, t, n, r) {
		let i = this.textStates[t], a = this.createLabel(e, t, r, n), o = this.strokeStates[n], s = this.pixelRatio, c = Kd(Array.isArray(e) ? e[0] : e, i.textAlign || "center"), l = kd[i.textBaseline || "middle"], u = o && o.lineWidth ? o.lineWidth : 0;
		return {
			label: a,
	...
	execute_(e, t, n, r, i, a, o, s) {
		...
		this.pixelCoordinates_ && de(n, this.renderedTransform_) ? l = this.pixelCoordinates_ : (this.pixelCoordinates_ ||= [], l = oi(this.coordinates, 0, this.coordinates.length, 2, n, this.pixelCoordinates_), Xr(this.renderedTransform_, n));
		...
		for (; u < d;) {
			...
			switch (n[0]) {
				...
				case X.DRAW_IMAGE:
					...
					n.length > 25 && (Se = n[25]);
					let F, Ce, we;
					n.length > 17 ? (F = n[16], Ce = n[17], we = n[18]) : (F = _c, Ce = null, we = null), ve && A ? ye += te : !ve && !A && (ye -= te);
					let Te = 0;
					for (; f < p; f += 2) {
						...
						if (s) {
							...
							if (P) {
								...
								let a = P[n];
								e = a.args, t = a.declutterMode, delete P[n], i = Wd(e);
							}
							let a, o;
				...
				case X.DRAW_CHARS:
					...
					E = n[9];
					let Ne = n[10];
					w = n[11], Array.isArray(w) && (w = w.reduce(Jd, "")), T = n[12];
					let Pe = [n[13], n[13]];
					v = n[14] || "declutter";
					...
					let Ve = Md(l, Ee, De, 2), He = Math.abs(ze[0]) * Oc(Re, w, Be);
					if (ke || He <= Ve) {
						let n = this.textStates[T].textAlign, r = (Ve - He) * Kd(w, n), i = Rd(l, Ee, De, 2, w, r, Ae, Math.abs(ze[0]), Oc, Re, Be, A ? 0 : this.viewRotation_, Fe);
						drawChars: if (i) {
							let n = [], r, a, o, c, l;
							if (E) for (r = 0, a = i.length; r < a; ++r) {
								...
								let a = this.calculateImageOrLabelDimensions_(c.width, c.height, l[0], l[1], c.width, c.height, h, g, 0, 0, l[3], Pe, !1, _c, !1, M);
				...
				case X.MOVE_TO_LINE_TO:
					...
					if (_) {
						...
						Nd(l, f, p, 2, _, e, m), Fd(m, 2, e), Ue = m, We = 0, Ge = Ue.length;
					} else Ue = l, We = f, Ge = p;
	...
	"Text",
	"Default"
], Zd = ["Image", "Text"], Qd = Xd.filter((e) => !Zd.includes(e)), $d = !1, ef = !1;
function tf() {
	let e = 0, t = (t) => {
...
var nf = class {
	...
	createExecutors_(e, t) {
		for (let n in e) {
			...
			for (let e in i) {
				let n = i[e];
				r[e] = new Yd(this.resolution_, this.pixelRatio_, this.overlaps_, n, t);
			}
		}
	}
	hasExecutors(e) {
	...
	forEachFeatureAtCoordinate(e, t, n, r, i, a) {
		...
		for (h = m.length - 1; h >= 0; --h) {
			let e = m[h].toString();
			for (_ = this.executorsByZIndex_[e], g = Xd.length - 1; g >= 0; --g) if (f = Xd[g], v = _[f], v !== void 0 && (b = v.executeHitDetection(l, s, n, p, u), b)) return b;
		}
	}
	getClipCoords(e) {
...
var of = class extends md {
	...
	drawImages_(e, t, n, r) {
		if (!this.image_) return;
		let i = oi(e, t, n, r, this.transform_, this.pixelCoordinates_), a = this.context_, o = this.tmpLocalTransform_, s = a.globalAlpha;
	...
	drawText_(e, t, n, r) {
		...
		let i = oi(e, t, n, r, this.transform_, this.pixelCoordinates_), a = this.context_, o = this.textRotation_;
	...
	moveToLineTo_(e, t, n, r, i, a) {
		let o = this.context_, s = oi(e, t, n, r, this.transform_, this.pixelCoordinates_);
		if (Math.abs(a) > 0) {
			let e = s.length, t = i || Math.abs(s[0] - s[e - 2]) < 1e-6 && Math.abs(s[1] - s[e - 1]) < 1e-6;
			s = Nd(s, 0, e, 2, a, t, s), Fd(s, 2, t);
		}
		o.moveTo(s[0], s[1]);
		let c = s.length;
		i && (c -= 2);
	...
	drawCircle(e) {
		if (this.squaredTolerance_ && (e = e.simplifyTransformed(this.squaredTolerance_, this.userTransform_)), pt(this.extent_, e.getExtent())) {
			if (this.fillState_ || this.strokeState_) {
				...
				let t = gi(e, this.transform_, this.pixelCoordinates_), n = t[2] - t[0], r = t[3] - t[1], i = Math.sqrt(n * n + r * r), a = this.context_;
	...
	setContextTextState_(e) {
		let t = this.context_, n = this.contextTextState_, r = e.textAlign ? e.textAlign : hc;
	...
	setFillStrokeStyle(e, t) {
		if (!e) this.fillState_ = null;
			...
			let t = e.getColor();
			this.fillState_ = { fillStyle: sc(t || uc) };
		}
		if (!t) this.strokeState_ = null;
		else {
			let e = t.getColor(), n = t.getLineCap(), r = t.getLineDash(), i = t.getLineDashOffset(), a = t.getLineJoin(), o = t.getWidth(), s = t.getMiterLimit(), c = r || fc, l = t.getOffset();
			this.strokeState_ = {
				lineCap: n === void 0 ? dc : n,
				lineDash: this.pixelRatio_ === 1 ? c : c.map((e) => e * this.pixelRatio_),
				lineDashOffset: (i || 0) * this.pixelRatio_,
				lineJoin: a === void 0 ? pc : a,
	...
	setTextStyle(e) {
		if (!e) this.text_ = "";
			...
			if (!t) this.textFillState_ = null;
				...
				let e = t.getColor();
				this.textFillState_ = { fillStyle: sc(e || uc) };
			}
			let n = e.getStroke();
			...
			this.textState_ = {
				font: r === void 0 ? lc : r,
				textAlign: u === void 0 ? hc : u,
				textBaseline: d === void 0 ? gc : d
...
function cf(e, t, n, r, i, a, o, s, c) {
	let l = c ? vr(i, c) : i, u = y(e[0] * sf, e[1] * sf);
	u.imageSmoothingEnabled = !1;
	let d = u.canvas, f = new of(u, sf, i, null, o, s, c ? lr(hr(), c) : null), p = n.length, m = Math.floor(16777215 / p), h = {};
	for (let e = 1; e <= p; ++e) {
		...
		for (let e = 0, n = o.length; e < n; ++e) {
			...
			if (u) {
				...
				t.fillStyle = s, t.fillRect(0, 0, n.width, n.height), i.setImage(new Lc({
					img: n,
					anchor: u.getAnchor(),
					anchorXUnits: "pixels",
					anchorYUnits: "pixels",
...
function lf(e, t, n) {
	let r = [];
	if (n) {
		let i = Math.floor(Math.round(e[0]) * sf), a = Math.floor(Math.round(e[1]) * sf), o = (St(i, 0, n.width - 1) + St(a, 0, n.height - 1) * n.width) * 4, s = n.data[o], c = n.data[o + 1], l = n.data[o + 2] + 256 * (c + 256 * s), u = Math.floor(16777215 / t.length);
...
function gf(e, t, n, r, i, a, o, s) {
	...
	if (l) {
		...
		t == Y.LOADED || t == Y.ERROR ? e = !1 : t == Y.IDLE && l.load(), e && c.push(l.ready());
	}
	let u = n.getFill();
	u && u.loading() && c.push(u.ready());
	let d = c.length > 0;
	return d && Promise.all(c).then(() => i(null)), _f(e, t, n, r, a, o, s), d;
}
function _f(e, t, n, r, i, a, o) {
	let s = n.getGeometryFunction()(t);
	if (!s) return;
	let c = s.simplifyTransformed(r, i);
	if (n.getRenderer()) vf(e, c, n, t, o);
	else {
		let r = df[c.getType()];
		r(e, c, n, t, o, a);
	}
...
function vf(e, t, n, r, i) {
	if (t.getType() == "GeometryCollection") {
		...
		for (let t = 0, o = a.length; t < o; ++t) vf(e, a[t], n, r, i);
		return;
	}
...
function Cf(e, t, n, r, i, a) {
	...
	if (o) {
		if (o.getImageState() != Y.LOADED) return;
...
var Ef = class extends ku {
	...
	renderWorlds(e, t, n) {
		let r = t.extent, i = t.viewState, a = i.center, o = i.resolution, s = i.projection, c = i.rotation, l = s.getExtent(), u = this.getLayer().getSource(), d = this.getLayer().getDeclutter(), f = t.pixelRatio, p = t.viewHints, m = !(p[z.ANIMATING] || p[z.INTERACTING]), h = this.context, g = Math.round(I(r) / o * f), _ = Math.round(ct(r) / o * f), v = u.getWrapX() && s.canWrapX(), y = v ? I(l) : null, b = v ? Math.ceil((r[2] - l[2]) / y) + (this.extendX_ ? 2 : 1) : 1, x = v ? Math.floor((r[0] - l[0]) / y) - +!!this.extendX_ : 0;
		do {
			let r = this.getRenderTransform(a, o, 0, f, g, _, x * y);
			t.declutter && (r = r.slice(0)), e.execute(h, [h.canvas.width, h.canvas.height], r, c, m, n === void 0 ? Xd : n ? Zd : Qd, n ? d && t.declutter[d] : void 0);
		} while (++x < b);
	}
	setDrawContext_() {
		this.opacity_ !== 1 && (this.targetContext_ = this.context, this.context = y(this.context.canvas.width, this.context.canvas.height, Eu));
	}
	resetDrawContext_() {
		if (this.opacity_ !== 1 && this.targetContext_) {
			let e = this.targetContext_.globalAlpha;
			this.targetContext_.globalAlpha = this.opacity_, this.targetContext_.drawImage(this.context.canvas, 0, 0), this.targetContext_.globalAlpha = e, S(this.context), Eu.push(this.context.canvas), this.context = this.targetContext_, this.targetContext_ = null;
		}
	}
	renderDeclutter(e) {
	...
	renderFrame(e, t) {
		...
		if (!o && !(this.getLayer().hasListener(co.PRERENDER) || this.getLayer().hasListener(co.POSTRENDER))) return this.container;
	...
	getFeatures(e) {
		return new Promise((t) => {
			if (this.frameState && !this.hitDetectionImageData_ && !this.animatingOrInteracting_) {
				let e = this.frameState.size.slice(), t = this.renderedCenter_, n = this.renderedResolution_, r = this.renderedRotation_, i = this.renderedProjection_, a = this.wrappedRenderedExtent_, o = this.getLayer(), s = [], c = e[0] * sf, l = e[1] * sf;
				s.push(this.getRenderTransform(t, n, r, sf, c, l, 0).slice());
				let u = o.getSource(), d = i.getExtent();
				if (u.getWrapX() && i.canWrapX() && !Ve(d, a)) {
					let e = a[0], i = I(d), o = 0, u;
					for (; e < d[0];) --o, u = i * o, s.push(this.getRenderTransform(t, n, r, sf, c, l, u).slice()), e += i;
					for (o = 0, e = a[2]; e > d[2];) ++o, u = i * o, s.push(this.getRenderTransform(t, n, r, sf, c, l, u).slice()), e -= i;
				}
				let f = hr();
				this.hitDetectionImageData_ = cf(e, s, this.renderedFeatures_, o.getStyleFunction(), a, n, r, pf(n, this.renderedPixelRatio_), f ? i : null);
			}
			t(lf(e, this.renderedFeatures_, this.hitDetectionImageData_));
		});
	}
	forEachFeatureAtCoordinate(e, t, n, r, i) {
	...
	prepareFrame(e) {
		...
		if (!n) return !1;
		let r = e.viewHints[z.ANIMATING], i = e.viewHints[z.INTERACTING], a = t.getUpdateWhileAnimating(), o = t.getUpdateWhileInteracting();
		...
		let x = new jd(mf(u, d), g, u, d), S = hr(), C;
		if (S) {
		...
		let O = x.finish(), k = new nf(g, u, d, n.getOverlaps(), O, t.getRenderBuffer(), !!e.declutter);
	...
	renderFeature(e, t, n, r, i, a, o) {
		if (!n) return !1;
		let s = !1;
		if (Array.isArray(n)) for (let c = 0, l = n.length; c < l; ++c) s = gf(r, e, n[c], t, this.boundHandleStyleImageChange_, i, a, o) || s;
		else s = gf(r, e, n, t, this.boundHandleStyleImageChange_, i, a, o);
		return s;
	}
}, Df = class extends kl {
	constructor(e) {
	...
	getTile(e, t, n, r) {
		...
		if (!i) return null;
		let a = r.viewState, o = a.resolution, s = r.viewHints, c = this.getLayer().getSource(), l = c.getTileGridForProjection(a.projection), u = !(s[z.ANIMATING] || s[z.INTERACTING]), d = l.getZForResolution(o, c.zDirection) === e;
	...
	updateExecutorGroup_(e, t, n) {
		...
		for (let i = 0, m = f.length; i < m; ++i) {
			...
			let v = lt(d, _), y = Le(v, r.getRenderBuffer() * o, this.tempExtent), b = Ye(_, v) ? null : y, x = new jd(0, v, o, t), S = pf(o, t), C = function(e, t) {
			...
			let T = x.finish(), E = new nf(r.getRenderMode() !== "vector" && l && f.length === 1 ? null : v, o, t, c.getOverlaps(), T, r.getRenderBuffer(), !0);
	...
	getFeatures(e) {
		return this.renderedTiles.length === 0 ? Promise.resolve([]) : new Promise((t, n) => {
			...
			if (!g) {
				let e = ns(c.getTileSize(c.getZForResolution(s, i.zDirection))), t = this.renderedRotation_;
				g = cf(e, [this.getRenderTransform(c.getTileCoordCenter(d.wrappedTileCoord), s, 0, sf, e[0] * sf, e[1] * sf, 0)], h, r.getStyleFunction(), c.getTileCoordExtent(d.wrappedTileCoord), d.getReplayState(r).renderedResolution, t), d.hitDetectionImageData[f] = g;
			}
			t(lf(m, h, g));
		});
	}
	...
	renderDeclutter(e, t) {
		...
		let i = e.viewHints, a = !(i[z.ANIMATING] || i[z.INTERACTING]), o = [this.context.canvas.width, this.context.canvas.height], s = this.getLayer().getDeclutter(), c = s ? e.declutter?.[s] : void 0, l = F(this.getLayer()), u = this.renderedTiles;
		for (let t = 0, n = u.length; t < n; ++t) {
			let n = u[t], r = n.executorGroups[l];
			if (r) for (let t = r.length - 1; t >= 0; --t) r[t].execute(this.context, o, this.getTileRenderTransform(n, e), e.viewState.rotation, a, Zd, c);
		}
		n.globalAlpha = r;
	}
	renderDeferredInternal(e) {
	...
	postRender(e, t) {
		let n = t.viewHints, r = !(n[z.ANIMATING] || n[z.INTERACTING]);
		...
		let s = i.getDeclutter(), c = s ? kf[a].filter((e) => !Zd.includes(e)) : kf[a], l = t.viewState, u = l.rotation;
		...
		for (let n = p.length - 1; n >= 0; --n) {
			...
			if (b) {
				...
				S = new Cu(), x = S.getContext(), f !== d && (y = this.clipTileContext_(x, e, m, h, d, l)), m.push(e), h.push(d);
			}
	...
	renderFeature(e, t, n, r, i, a) {
		if (!n) return !1;
		let o = !1;
		if (Array.isArray(n)) for (let s = 0, c = n.length; s < c; ++s) o = gf(r, e, n[s], t, this.boundHandleStyleImageChange_, void 0, i, a) || o;
		else o = gf(r, e, n, t, this.boundHandleStyleImageChange_, void 0, i, a);
		return o;
	}
	...
	renderTileImage_(e, t) {
		...
		for (let e = 0, t = a.length; e < t; ++e) a[e].execute(h, [h.canvas.width * _, h.canvas.height * _], b, 0, !0, Of[n.getRenderMode()], null);
	...
	createRenderer() {
		return new Af(this, { cacheSize: this.cacheSize_ });
	}
	getFeatures(e) {
		return super.getFeatures(e);
	}
	...
	prepareFrame(e) {
		...
		if (t.extent !== void 0 && (s = lt(s, yr(t.extent, r.projection))), !o[z.ANIMATING] && !o[z.INTERACTING] && !mt(s)) {
			if (a) {
				...
				t && (this.loadImage(t) ? this.image = t : t.getState() === Y.EMPTY && (this.image = null));
...
var Vf = 34962, Hf = 34963, Uf = 35040, Wf = 35044, Gf = 35048, Kf = 5121, qf = 5123, Jf = 5125, Yf = 5126, Xf = [
	"experimental-webgl",
	"webgl",
	"webkit-3d",
	"moz-webgl"
...
var Qf = {
	...
	constructor(e, t) {
		this.array_ = null, this.type_ = e, R(e === 34962 || e === 34963, "A `WebGLArrayBuffer` must either be of type `ELEMENT_ARRAY_BUFFER` or `ARRAY_BUFFER`"), this.usage_ = t === void 0 ? Qf.STATIC_DRAW : t;
	}
	ofSize(e) {
		return this.array_ = new (ep(this.type_))(e), this;
	}
	fromArray(e) {
		return this.array_ = ep(this.type_).from(e), this;
	}
	fromArrayBuffer(e) {
		return this.array_ = new (ep(this.type_))(e), this;
	}
...
var tp = {
	...
	constructor(e) {
		...
		t.shaderSource(n, e.vertexShader || np), t.compileShader(n);
...
function fp(e) {
	...
	r && r.loseContext();
	let i = n.canvas;
	i.width = 1, i.height = 1, delete sp[e];
}
var pp = class extends ie {
	constructor(e) {
		super(), e ||= {}, this.boundHandleWebGLContextLost_ = this.handleWebGLContextLost.bind(this), this.boundHandleWebGLContextRestored_ = this.handleWebGLContextRestored.bind(this), this.canvasCacheKey_ = e.canvasCacheKey ? cp(e.canvasCacheKey) : up(), this.gl_ = dp(this.canvasCacheKey_), this.bufferCache_ = {}, this.extensionCache_ = {}, this.currentProgram_ = null, this.needsToBeRecreated_ = !1;
		let t = this.gl_.canvas;
		t.addEventListener(tp.LOST, this.boundHandleWebGLContextLost_), t.addEventListener(tp.RESTORED, this.boundHandleWebGLContextRestored_), this.tmpMat4_ = Ff(), this.uniformLocationsByProgram_ = {}, this.attribLocationsByProgram_ = {}, this.uniforms_ = [], e.uniforms && this.setUniforms(e.uniforms), this.postProcessPasses_ = e.postProcesses?.length ? e.postProcesses.map((e) => new ip({
			webGlContext: this.gl_,
			scaleRatio: e.scaleRatio,
			vertexShader: e.vertexShader,
			fragmentShader: e.fragmentShader,
			uniforms: e.uniforms
		})) : [new ip({ webGlContext: this.gl_ })], this.shaderCompileErrors_ = null, this.startTime_ = Date.now(), this.maxAttributeCount_ = this.gl_.getParameter(this.gl_.MAX_VERTEX_ATTRIBS);
	}
	setUniforms(e) {
	...
	canvasCacheKeyMatches(e) {
		return this.canvasCacheKey_ === cp(e);
	}
	getExtension(e) {
	...
	disposeInternal() {
		...
		e.removeEventListener(tp.LOST, this.boundHandleWebGLContextLost_), e.removeEventListener(tp.RESTORED, this.boundHandleWebGLContextRestored_), fp(this.canvasCacheKey_), delete this.gl_;
	}
	prepareDraw(e, t, n) {
	...
	applyFrameState(e) {
		...
		this.setUniformFloatValue(ap.TIME, (Date.now() - this.startTime_) * .001), this.setUniformFloatValue(ap.ZOOM, e.viewState.zoom), this.setUniformFloatValue(ap.RESOLUTION, e.viewState.resolution), this.setUniformFloatValue(ap.PIXEL_RATIO, r), this.setUniformFloatVec2(ap.VIEWPORT_SIZE_PX, [t[0], t[1]]), this.setUniformFloatValue(ap.ROTATION, n);
	}
	applyHitDetectionUniform(e) {
		let t = this.getUniformLocation(ap.HIT_DETECTION);
		this.getGL().uniform1i(t, +!!e), e && this.setUniformFloatValue(ap.PIXEL_RATIO, .5);
	}
	applyUniforms(e) {
		...
		this.uniforms_.forEach((i) => {
			...
			} else if (Array.isArray(n) && n.length === 6) this.setUniformMatrixValue(i.name, Lf(this.tmpMat4_, n));
	...
	enableAttributes_(e, t) {
		...
		for (let i = 0; i < e.length; i++) {
			let a = e[i];
			a.name && this.enableAttributeArray_(a.name, a.size, a.type || 5126, n, r, t), r += a.size * hp(a.type);
		}
	}
	enableAttributes(e) {
...
function hp(e) {
	switch (e) {
		case op.UNSIGNED_BYTE: return Uint8Array.BYTES_PER_ELEMENT;
		case op.UNSIGNED_SHORT: return Uint16Array.BYTES_PER_ELEMENT;
		case op.UNSIGNED_INT: return Uint32Array.BYTES_PER_ELEMENT;
		case op.FLOAT:
...
var gp = class e extends Tu {
	...
	dispatchPreComposeEvent(e, t) {
		let n = this.getLayer();
		if (n.hasListener(co.PRECOMPOSE)) {
			let r = new jl(co.PRECOMPOSE, void 0, t, e);
			n.dispatchEvent(r);
		}
	}
	dispatchPostComposeEvent(e, t) {
		let n = this.getLayer();
		if (n.hasListener(co.POSTCOMPOSE)) {
			let r = new jl(co.POSTCOMPOSE, void 0, t, e);
			n.dispatchEvent(r);
		}
	}
	reset(e) {
	...
	prepareFrame(t) {
		if (this.getLayer().getRenderSource()) {
			...
			(!this.helper || !this.helper.canvasCacheKeyMatches(a) || this.helper.needsToBeRecreated()) && (this.removeHelper(), this.helper = new pp({
	...
	dispatchRenderEvent_(e, t, n) {
		...
		if (r.hasListener(e)) {
			...
			let i = new jl(e, this.inversePixelTransform_, n, t);
			r.dispatchEvent(i);
		}
	}
	preRender(e, t) {
		this.dispatchRenderEvent_(co.PRERENDER, e, t);
	}
	postRender(e, t) {
		this.dispatchRenderEvent_(co.POSTRENDER, e, t);
	}
}, _p = {
	...ap,
...
({ TEXTURE_COORD: "a_textureCoord" }).TEXTURE_COORD, op.FLOAT;
//#endregion
...
function xp(e) {
	...
	return `vec${e.length}(${e.map(bp).join(", ")})`;
}
function Sp(e) {
	let t = Qo(e), n = t.length > 3 ? t[3] : 1;
	return xp([
		t[0] / 255,
		t[1] / 255,
		t[2] / 255,
...
var Ap = "getBandValue", jp = "u_paletteTextures", Mp = "featureId", Np = "geometryType", Pp = -9999999;
function Fp(e, t, n, r) {
	let i = vs(e, t, n);
	return r.properties = new Map([...r.properties, ...n.properties]), r.variables = new Map([...r.variables, ...n.variables]), Lp(i, t, r);
}
function Z(e) {
	return (t, n, r) => {
		let i = n.args.length, a = Array(i);
		for (let e = 0; e < i; ++e) a[e] = Lp(n.args[e], r, t);
		return e(a, t);
	};
}
var Ip = {
	[G.Get]: (e, t) => {
		...
		return ms(t.type, is) && (n = `(${n} > 0.0)`), n;
	},
	[G.Id]: (e) => (e.featureId = !0, "a_featureId"),
	[G.GeometryType]: (e) => (e.geometryType = !0, "a_geometryType"),
	[G.LineMetric]: () => "currentLineMetric",
	[G.Var]: (e, t) => {
		let n = t.args[0].value, r = Op(n);
		return ms(t.type, is) && (r = `(${r} > 0.0)`), r;
	},
	[G.Has]: (e, t) => `(a_prop_${t.args[0].value} != ${bp(Pp)})`,
	...
	[G.Not]: Z(([e]) => `(!${e})`),
	[G.Equal]: Z(([e, t]) => `(${e} == ${t})`),
	[G.NotEqual]: Z(([e, t]) => `(${e} != ${t})`),
	[G.GreaterThan]: Z(([e, t]) => `(${e} > ${t})`),
	[G.GreaterThanOrEqualTo]: Z(([e, t]) => `(${e} >= ${t})`),
	[G.LessThan]: Z(([e, t]) => `(${e} < ${t})`),
	[G.LessThanOrEqualTo]: Z(([e, t]) => `(${e} <= ${t})`),
	[G.Multiply]: Z((e) => `(${e.join(" * ")})`),
	[G.Divide]: Z(([e, t]) => `(${e} / ${t})`),
	[G.Add]: Z((e) => `(${e.join(" + ")})`),
	[G.Subtract]: Z(([e, t]) => `(${e} - ${t})`),
	[G.Clamp]: Z(([e, t, n]) => `clamp(${e}, ${t}, ${n})`),
	[G.Mod]: Z(([e, t]) => `mod(${e}, ${t})`),
	[G.Pow]: Z(([e, t]) => `pow(${e}, ${t})`),
	[G.Abs]: Z(([e]) => `abs(${e})`),
	[G.Floor]: Z(([e]) => `floor(${e})`),
	[G.Ceil]: Z(([e]) => `ceil(${e})`),
	[G.Round]: Z(([e]) => `floor(${e} + 0.5)`),
	[G.Sin]: Z(([e]) => `sin(${e})`),
	[G.Cos]: Z(([e]) => `cos(${e})`),
	[G.Atan]: Z(([e, t]) => t === void 0 ? `atan(${e})` : `atan(${e}, ${t})`),
	[G.Sqrt]: Z(([e]) => `sqrt(${e})`),
	[G.Match]: Z((e) => {
	...
	[G.Between]: Z(([e, t, n]) => `(${e} >= ${t} && ${e} <= ${n})`),
	[G.Interpolate]: Z(([e, t, ...n]) => {
		let r = "";
		for (let i = 0; i < n.length - 2; i += 2) {
			let a = n[i], o = r || n[i + 1], s = n[i + 2], c = n[i + 3], l;
			l = e === bp(1) ? `(${t} - ${a}) / (${s} - ${a})` : `(pow(${e}, (${t} - ${a})) - 1.0) / (pow(${e}, (${s} - ${a})) - 1.0)`, r = `mix(${o}, ${c}, clamp(${l}, 0.0, 1.0))`;
		}
		return r;
	}),
	[G.Case]: Z((e) => {
...
${i.join("\n")}
  return false;
	...
	[G.Array]: Z((e) => `vec${e.length}(${e.join(", ")})`),
	[G.Color]: Z((e) => {
	...
	[G.Band]: Z(([e, t, n], r) => {
		if (!(Ap in r.functions)) {
			let e = "", t = r.bandCount || 1;
			for (let n = 0; n < t; n++) {
				let r = Math.floor(n / 4), i = n % 4;
				n === t - 1 && i === 1 && (i = 3);
				let a = `${_p.TILE_TEXTURE_ARRAY}[${r}]`;
				e += `  if (band == ${n + 1}.0) {
...
`;
  ...
  float dx = xOffset / ${_p.TEXTURE_PIXEL_WIDTH};
  float dy = yOffset / ${_p.TEXTURE_PIXEL_HEIGHT};
${e}
}`;
		}
		return `${Ap}(${e}, ${t ?? "0.0"}, ${n ?? "0.0"})`;
	}),
	[G.Palette]: (e, t) => {
		let [n, ...r] = t.args, i = r.length, a = new Uint8Array(i * 4);
		for (let e = 0; e < r.length; e++) {
			let t = r[e].value, n = Qo(t), i = e * 4;
			a[i] = n[0], a[i + 1] = n[1], a[i + 2] = n[2], a[i + 3] = n[3] * 255;
		}
		e.paletteTextures ||= [];
		let o = `${jp}[${e.paletteTextures.length}]`, s = new vp(o, a);
		return e.paletteTextures.push(s), `texture2D(${o}, vec2((${Lp(n, H, e)} + 0.5) / ${i}.0, 0.5))`;
	}
};
function Lp(e, t, n) {
	if (e instanceof gs) {
	...
	if ((e.type & H) > 0) return bp(e.value);
	if ((e.type & is) > 0) return e.value.toString();
	if ((e.type & U) > 0) return Dp(e.value.toString());
	if ((e.type & W) > 0) return Sp(e.value);
	if ((e.type & as) > 0) return xp(e.value);
	if ((e.type & os) > 0) return Cp(e.value);
	throw Error(`Unexpected expression ${e.value} (expected type ${ds(t)})`);
}
//#endregion
...
function Q(e, t, n, r) {
	return Fp(t, n, r ?? _s(e.inputVariables), e);
}
function Bp(e) {
	let t = Qo(e), n = t[0] * 256, r = t[1], i = t[2] * 256, a = Math.round(t[3] * 255);
	return [n + r, i + a];
}
var Vp = "vec4 unpackColor(vec2 packedColor) {\n  return vec4(\n    min(floor(packedColor[0] / 256.0) / 255.0, 1.0),\n    min(mod(packedColor[0], 256.0) / 255.0, 1.0),\n    min(floor(packedColor[1] / 256.0) / 255.0, 1.0),\n    min(mod(packedColor[1], 256.0) / 255.0, 1.0)\n  );\n}";
function Hp(e) {
	return e === W || e === os ? 2 : e === as ? 4 : e === U ? 3 : 1;
}
function Up(e) {
	if (e === U) return "float";
	let t = Hp(e);
...
function Kp(e) {
	...
	for (let n of e.properties.entries()) {
		let [e, r] = n, i = (t) => {
			let n = t.get(e);
			return r === W ? Bp([...Qo(n || "#eee")]) : r === is ? +!!n : n;
		};
		t[`prop_${e}`] = {
			size: Hp(r),
			callback: i
...
var Yp = `#ifdef GL_FRAGMENT_PRECISION_HIGH
...
`, Xp = Rp(), Zp = class {
	constructor() {
		this.uniforms_ = [], this.attributes_ = [], this.hasSymbol_ = !1, this.symbolSizeExpression_ = `vec2(${bp(Xp["circle-radius"])} + ${bp(Xp["circle-stroke-width"] * .5)})`, this.symbolRotationExpression_ = "0.0", this.symbolOffsetExpression_ = "vec2(0.0)", this.symbolColorExpression_ = Sp(Xp["circle-fill-color"]), this.texCoordExpression_ = "vec4(0.0, 0.0, 1.0, 1.0)", this.fragmentDiscardExpression_ = null, this.shapeDiscardExpression_ = null, this.symbolRotateWithView_ = !1, this.hasStroke_ = !1, this.strokeWidthExpression_ = bp(Xp["stroke-width"]), this.strokeColorExpression_ = Sp(Xp["stroke-color"]), this.strokeOffsetExpression_ = "0.", this.strokeCapExpression_ = Dp("round"), this.strokeJoinExpression_ = Dp("round"), this.strokeMiterLimitExpression_ = "10.", this.strokeDistanceFieldExpression_ = "-1000.", this.strokePatternLengthExpression_ = null, this.hasFill_ = !1, this.fillColorExpression_ = Sp(Xp["fill-color"]), this.fillPatternSizeExpression_ = null, this.vertexShaderFunctions_ = [], this.fragmentShaderFunctions_ = [];
	}
	addUniform(e, t) {
...
float miterJoinDistanceField(vec2 point, vec2 start, vec2 end, float width, float joinAngle) {
  if (cos(joinAngle) > ${zp}) { // avoid risking a division by zero
...
var em = Kr(), tm = class e {
	...
	getFlatInteriorPoint() {
		if (!this.flatInteriorPoints_) {
			let e = it(this.getExtent());
			this.flatInteriorPoints_ = Wi(this.flatCoordinates_, 0, this.ends_, this.stride_, e, 0);
		}
		return this.flatInteriorPoints_;
	}
	getFlatInteriorPoints() {
		if (!this.flatInteriorPoints_) {
			let e = Xi(this.flatCoordinates_, this.ends_), t = $p(this.flatCoordinates_, 0, e, this.stride_);
			this.flatInteriorPoints_ = Gi(this.flatCoordinates_, 0, e, this.stride_, t);
		}
		return this.flatInteriorPoints_;
	}
	getFlatMidpoint() {
		return this.flatMidpoints_ ||= Qp(this.flatCoordinates_, 0, this.flatCoordinates_.length, this.stride_, .5), this.flatMidpoints_;
	}
	getFlatMidpoints() {
		if (!this.flatMidpoints_) {
			...
			for (let r = 0, i = n.length; r < i; ++r) {
				let i = n[r], a = Qp(e, t, i, this.stride_, .5);
	...
	transform(e) {
		...
		if (t && n) {
			let e = ct(n) / ct(t);
			$r(em, n[0], n[3], e, -e, 0, 0, 0), oi(this.flatCoordinates_, 0, this.flatCoordinates_.length, this.stride_, em, this.flatCoordinates_);
		}
	}
	applyTransform(e) {
	...
	enableSimplifyTransformed() {
		return this.simplifyTransformed = ge((t, n) => {
			...
			switch (this.type_) {
				case "LineString":
					r.length = Li(r, 0, this.simplifiedGeometry_.flatCoordinates_.length, this.simplifiedGeometry_.stride_, t, r, 0), i = [r.length];
					break;
				case "MultiLineString":
					i = [], r.length = Ri(r, 0, this.simplifiedGeometry_.ends_, this.simplifiedGeometry_.stride_, t, r, 0, i);
					break;
				case "Polygon": i = [], r.length = Vi(r, 0, this.simplifiedGeometry_.ends_, this.simplifiedGeometry_.stride_, Math.sqrt(t), r, 0, i);
			}
...
tm.prototype.getFlatCoordinates = tm.prototype.getOrientedFlatCoordinates;
//#endregion
	...
	addCoordinates_(e, t, n, r, i, a, o) {
		...
		switch (e) {
			...
			case "Polygon": {
				...
				this.polygonBatch.verticesCount += s, this.polygonBatch.ringsCount += c, this.polygonBatch.geometriesCount++, this.polygonBatch.entries[i].flatCoordss.push(rm(t, a)), this.polygonBatch.entries[i].ringsVerticesCounts.push(l), this.polygonBatch.entries[i].verticesCount += s, this.polygonBatch.entries[i].ringsCount += c;
				for (let n = 0, s = e.length; n < s; n++) {
					let s = n > 0 ? e[n - 1] : 0;
			...
			case "LinearRing": this.lineStringBatch.entries[i] || (this.lineStringBatch.entries[i] = this.addRefToEntry_(i, {
				...
				flatCoordss: [],
				verticesCount: 0
			})), s = t.length / a, this.lineStringBatch.verticesCount += s, this.lineStringBatch.geometriesCount++, this.lineStringBatch.entries[i].flatCoordss.push(im(t, a, o)), this.lineStringBatch.entries[i].verticesCount += s;
		}
	}
	addRefToEntry_(e, t) {
...
var am = new TextEncoder(), om = 1e5, sm = class {
	constructor() {
		this.array_ = new Uint8Array(om), this.actualSize_ = 0, this.labelPositionMap_ = /* @__PURE__ */ new Map();
	}
	push(e) {
		if (e === "") return [0, 0];
		...
		if (this.actualSize_ + t.length > this.array_.length) {
			let e = new Uint8Array(this.array_.length + om);
...
function gm(e, t, n, r, i) {
	let a = (2 + hm(r)) * e.geometriesCount;
	(!t || t.length !== a) && (t = new Float32Array(a));
	let o = [], s = 0;
	for (let a in e.entries) {
		let c = e.entries[a];
		for (let e = 0, a = c.flatCoordss.length; e < a; e++) o[0] = c.flatCoordss[e][0], o[1] = c.flatCoordss[e][1], B(i, o), t[s++] = o[0], t[s++] = o[1], s += mm(t, n, r, c, s);
	}
	return t;
}
function _m(e, t, n, r, i) {
	let a = 3 * e.verticesCount + (1 + hm(r)) * e.geometriesCount;
	(!t || t.length !== a) && (t = new Float32Array(a));
	let o = [], s = 0;
	for (let a in e.entries) {
		let c = e.entries[a];
		for (let e = 0, a = c.flatCoordss.length; e < a; e++) {
			o.length = c.flatCoordss[e].length, oi(c.flatCoordss[e], 0, o.length, 3, i, o, 3), s += mm(t, n, r, c, s), t[s++] = o.length / 3;
...
function vm(e, t, n, r, i) {
	let a = 2 * e.verticesCount + (1 + hm(r)) * e.geometriesCount + e.ringsCount;
	(!t || t.length !== a) && (t = new Float32Array(a));
	let o = [], s = 0;
	for (let a in e.entries) {
		let c = e.entries[a];
		for (let e = 0, a = c.flatCoordss.length; e < a; e++) {
			o.length = c.flatCoordss[e].length, oi(c.flatCoordss[e], 0, o.length, 2, i, o), s += mm(t, n, r, c, s), t[s++] = c.ringsVerticesCounts[e].length;
...
function xm(e, t, n, r) {
	if (`${r}radius` in e && r !== "icon-") {
		let i = Q(n, e[`${r}radius`], H);
		if (`${r}radius2` in e) {
			let t = Q(n, e[`${r}radius2`], H);
			i = `max(${i}, ${t})`;
		}
		`${r}stroke-width` in e && (i = `(${i} + ${Q(n, e[`${r}stroke-width`], H)} * 0.5)`), t.setSymbolSizeExpression(`vec2(${i} * 2. + 0.5)`);
	}
	if (`${r}scale` in e) {
		let i = Q(n, e[`${r}scale`], os);
		t.setSymbolSizeExpression(`${t.getSymbolSizeExpression()} * ${i}`);
	}
	`${r}displacement` in e && t.setSymbolOffsetExpression(Q(n, e[`${r}displacement`], as)), `${r}rotation` in e && t.setSymbolRotationExpression(Q(n, e[`${r}rotation`], H)), `${r}rotate-with-view` in e && t.setSymbolRotateWithView(!!e[`${r}rotate-with-view`]);
}
...
function Tm(e, t, n, r) {
	...
	let i = null;
	"circle-opacity" in e && (i = Q(r, e["circle-opacity"], H));
	let a = "coordsPx";
	"circle-scale" in e && (a = `coordsPx / ${Q(r, e["circle-scale"], os)}`);
	let o = null;
	"circle-fill-color" in e && (o = Q(r, e["circle-fill-color"], W));
	let s = null;
	"circle-stroke-color" in e && (s = Q(r, e["circle-stroke-color"], W));
	let c = Q(r, e["circle-radius"], H), l = null;
	"circle-stroke-width" in e && (l = Q(r, e["circle-stroke-width"], H), c = `(${c} + ${l} * 0.5)`);
	let u = Sm(`circleDistanceField(${a}, ${c})`, o, s, l, i);
...
function Em(e, t, n, r) {
	...
	let i = null;
	"shape-opacity" in e && (i = Q(r, e["shape-opacity"], H));
	let a = "coordsPx";
	"shape-scale" in e && (a = `coordsPx / ${Q(r, e["shape-scale"], os)}`);
	let o = null;
	"shape-fill-color" in e && (o = Q(r, e["shape-fill-color"], W));
	let s = null;
	"shape-stroke-color" in e && (s = Q(r, e["shape-stroke-color"], W));
	let c = null;
	"shape-stroke-width" in e && (c = Q(r, e["shape-stroke-width"], H));
	let l = Q(r, e["shape-points"], H), u = "0.";
	"shape-angle" in e && (u = Q(r, e["shape-angle"], H));
	let d, f = Q(r, e["shape-radius"], H);
	if (c !== null && (f = `${f} + ${c} * 0.5`), "shape-radius2" in e) {
		let t = Q(r, e["shape-radius2"], H);
...
function Dm(e, t, n, r) {
	let i = "vec4(1.0)";
	"icon-color" in e && (i = Q(r, e["icon-color"], W)), "icon-opacity" in e && (i = `${i} * vec4(1.0, 1.0, 1.0, ${Q(r, e["icon-opacity"], H)})`);
	let a = bm(e["icon-src"]), o = Cm(e, t, n, "icon-", a);
	if (t.setSymbolColorExpression(`${i} * texture2D(u_texture${a}, v_texCoord)`).setSymbolSizeExpression(o), "icon-width" in e && "icon-height" in e && t.setSymbolSizeExpression(`vec2(${Q(r, e["icon-width"], H)}, ${Q(r, e["icon-height"], H)})`), "icon-offset" in e && "icon-size" in e) {
		let n = Q(r, e["icon-size"], as), i = t.getSymbolSizeExpression();
		t.setSymbolSizeExpression(n);
		let a = wm(e, "icon-", r, "v_quadSizePx", n);
		t.setTextureCoordinateExpression(`(vec4((${a}).xyxy) + vec4(0., 0., ${n})) / (${i}).xyxy`);
	}
	if (xm(e, t, r, "icon-"), "icon-anchor" in e) {
		let n = Q(r, e["icon-anchor"], as), i = "1.0";
		"icon-scale" in e && (i = Q(r, e["icon-scale"], os));
		let a;
...
function Om(e, t, n, r) {
	if ("stroke-color" in e && t.setStrokeColorExpression(Q(r, e["stroke-color"], W)), "stroke-pattern-src" in e) {
		let i = bm(e["stroke-pattern-src"]), a = Cm(e, t, n, "stroke-pattern-", i), o = a, s = "vec2(0.)";
		"stroke-pattern-offset" in e && "stroke-pattern-size" in e && (o = Q(r, e["stroke-pattern-size"], as), s = wm(e, "stroke-pattern-", r, a, o));
		let c = "0.";
		"stroke-pattern-spacing" in e && (c = Q(r, e["stroke-pattern-spacing"], H));
		let l = "0.";
		"stroke-pattern-start-offset" in e && (l = Q(r, e["stroke-pattern-start-offset"], H)), r.functions.sampleStrokePattern = "vec4 sampleStrokePattern(sampler2D texture, vec2 textureSize, vec2 textureOffset, vec2 sampleSize, float spacingPx, float startOffsetPx, float currentLengthPx, float currentRadiusRatio, float lineWidth) {\n  float currentLengthScaled = (currentLengthPx - startOffsetPx) * sampleSize.y / lineWidth;\n  float spacingScaled = spacingPx * sampleSize.y / lineWidth;\n  float uCoordPx = mod(currentLengthScaled, (sampleSize.x + spacingScaled));\n  float isInsideOfPattern = step(uCoordPx, sampleSize.x);\n  float vCoordPx = (-currentRadiusRatio * 0.5 + 0.5) * sampleSize.y;\n  // make sure that we're not sampling too close to the borders to avoid interpolation with outside pixels\n  uCoordPx = clamp(uCoordPx, 0.5, sampleSize.x - 0.5);\n  vCoordPx = clamp(vCoordPx, 0.5, sampleSize.y - 0.5);\n  vec2 texCoord = (vec2(uCoordPx, vCoordPx) + textureOffset) / textureSize;\n  return texture2D(texture, texCoord) * vec4(1.0, 1.0, 1.0, isInsideOfPattern);\n}";
	...
	if ("stroke-width" in e && t.setStrokeWidthExpression(Q(r, e["stroke-width"], H)), "stroke-offset" in e && t.setStrokeOffsetExpression(Q(r, e["stroke-offset"], H)), "stroke-line-cap" in e && t.setStrokeCapExpression(Q(r, e["stroke-line-cap"], U)), "stroke-line-join" in e && t.setStrokeJoinExpression(Q(r, e["stroke-line-join"], U)), "stroke-miter-limit" in e && t.setStrokeMiterLimitExpression(Q(r, e["stroke-miter-limit"], H)), "stroke-line-dash" in e) {
  ...
  return distanceSegment;
		...
		let n = e["stroke-line-dash"].map((e) => Q(r, e, H));
		n.length % 2 == 1 && (n = [...n, ...n]);
		let i = "0.";
		"stroke-line-dash-offset" in e && (i = Q(r, e["stroke-line-dash-offset"], H));
		let a = `dashDistanceField_${bm(e["stroke-line-dash"])}`, o = n.map((e, t) => `float dashLength${t}`).join(", "), s = n.map((e, t) => `dashLength${t}`).join(" + "), c = "0.", l = `getSingleDashDistance(distance, radius, ${c}, dashLength0, totalDashLength, capType, lineWidth)`;
...
function km(e, t, n, r) {
	if ("fill-color" in e && t.setFillColorExpression(Q(r, e["fill-color"], W)), "fill-pattern-src" in e) {
		let i = bm(e["fill-pattern-src"]), a = Cm(e, t, n, "fill-pattern-", i);
		t.setFillPatternSizeExpression(a);
		let o = "vec2(0.)";
		if ("fill-pattern-offset" in e && "fill-pattern-size" in e) {
			let n = Q(r, e["fill-pattern-size"], as);
			t.setFillPatternSizeExpression(n), o = wm(e, "fill-pattern-", r, a, "v_patternSizePx");
		}
...
function Am(e, t, n, r) {
	...
	"text-value" in e && i(r, e["text-value"], U), "text-font" in e && i(r, e["text-font"], U), "text-max-angle" in e && i(r, e["text-max-angle"], H), "text-offset-x" in e && i(r, e["text-offset-x"], H), "text-offset-y" in e && i(r, e["text-offset-y"], H), "text-overflow" in e && i(r, e["text-overflow"], is), "text-placement" in e && i(r, e["text-placement"], U), "text-repeat" in e && i(r, e["text-repeat"], H), "text-scale" in e && i(r, e["text-scale"], os), "text-rotate-with-view" in e && i(r, e["text-rotate-with-view"], is), "text-rotation" in e && i(r, e["text-rotation"], H), "text-align" in e && i(r, e["text-align"], U), "text-justify" in e && i(r, e["text-justify"], U), "text-baseline" in e && i(r, e["text-baseline"], U), "text-padding" in e && i(r, e["text-padding"], as), "text-fill-color" in e && i(r, e["text-fill-color"], W), "text-stroke-color" in e && i(r, e["text-stroke-color"], W), "text-stroke-line-cap" in e && i(r, e["text-stroke-line-cap"], U), "text-stroke-line-join" in e && i(r, e["text-stroke-line-join"], U), "text-stroke-line-dash" in e && i(r, e["text-stroke-line-dash"], as), "text-stroke-line-dash-offset" in e && i(r, e["text-stroke-line-dash-offset"], H), "text-stroke-miter-limit" in e && i(r, e["text-stroke-miter-limit"], H), "text-stroke-width" in e && i(r, e["text-stroke-width"], H), "text-background-fill-color" in e && i(r, e["text-background-fill-color"], W), "text-background-stroke-color" in e && i(r, e["text-background-stroke-color"], W), "text-background-stroke-line-cap" in e && i(r, e["text-background-stroke-line-cap"], U), "text-background-stroke-line-join" in e && i(r, e["text-background-stroke-line-join"], U), "text-background-stroke-line-dash" in e && i(r, e["text-background-stroke-line-dash"], as), "text-background-stroke-line-dash-offset" in e && i(r, e["text-background-stroke-line-dash-offset"], H), "text-background-stroke-miter-limit" in e && i(r, e["text-background-stroke-miter-limit"], H), "text-background-stroke-width" in e && i(r, e["text-background-stroke-width"], H), "z-index" in e && i(r, e["z-index"], H);
}
function jm(e, t, n) {
	let r = kp(t), i = new Zp(), a = {};
	if ("icon-src" in e ? Dm(e, i, a, r) : "shape-points" in e ? Em(e, i, a, r) : "circle-radius" in e && Tm(e, i, a, r), Om(e, i, a, r), km(e, i, a, r), Am(e, i, a, r), n) {
		let e = _s(t), a = Q(r, n, is, e);
	...
	return s("geometryType", Np, U, (e) => Ep(Ls(e.getGeometry()))), s("featureId", Mp, U | H, (e) => {
		let t = e.getId() ?? null;
		return typeof t == "string" ? Ep(t) : t;
	}), Wp(i, r), {
		builder: i,
		attributes: {
			...o,
...
function Pm(e, t) {
	...
	return {
      ...
      uniform sampler2D u_image;
      uniform sampler2D ${Mm.TEXT_OVERLAY_TEXTURE};
      uniform mat4 ${Mm.TEXT_OVERLAY_MATRIX};
      ...
      void main() {
        ...
        coords = (${Mm.TEXT_OVERLAY_MATRIX} * vec4(coords.xy, 0., 1.)).xy;
        coords = coords * 0.5 + vec2(0.5);
        float outOfBounds = clamp(step(1., coords.x) + step(1., coords.y) + step(0., -coords.x) + step(0., -coords.y), 0., 1.);

        vec4 textColor = texture2D(${Mm.TEXT_OVERLAY_TEXTURE}, vec2(coords.x, 1. - coords.y));
		...
		uniforms: {
			[Mm.TEXT_OVERLAY_TEXTURE]: e,
			[Mm.TEXT_OVERLAY_MATRIX]: (r) => {
				let i = e(), a = t();
				if (!i || !a) return n;
				...
				return If(n), Rf(n, 1 / p / (h / 2), 1 / p / (g / 2), 1, n), Bf(n, m, n), zf(n, c[0] - f[0], c[1] - f[1], 0, n), Bf(n, -u, n), Rf(n, l * d[0] / 2, l * d[1] / 2, 1, n), n;
			}
		}
	};
}
new tm("Point", [0, 0], [], 2, {}, "dummy"), new TextDecoder();
//#endregion
...
var Bm = {
	...
	constructor(e, t, n, r) {
		super(), this.helper_, this.hitDetectionEnabled_ = !!r, this.flatStyle = Hm(e), this.styleShaders = Um(e, t), this.customAttributes_ = {}, this.uniforms_ = {}, this.hitDetectionEnabled_ && (this.customAttributes_.hitColor = {
			callback() {
				return fm(this.ref, Fm);
			},
			size: 2
		});
		...
		this.renderPasses_ = this.styleShaders.map((e) => {
			...
			return e.builder.getFillVertexShader() && (t.fillRenderPass = {
				...
				attributesDesc: [{
					name: Bm.LOCAL_POSITION,
					size: 2,
					type: op.FLOAT
				}],
				instancedAttributesDesc: [
					{
						name: Bm.SEGMENT_START,
						size: 2,
						type: op.FLOAT
					},
					{
						name: Bm.MEASURE_START,
						size: 1,
						type: op.FLOAT
					},
					{
					...
					{
						name: Bm.DISTANCE_LOW,
						size: 1,
						type: op.FLOAT
					},
					{
						name: Bm.DISTANCE_HIGH,
						size: 1,
						type: op.FLOAT
					},
					{
						name: Bm.ANGLE_TANGENT_SUM,
						size: 1,
						type: op.FLOAT
					},
					...n
		...
		}), this.hasFill_ = this.renderPasses_.some((e) => e.fillRenderPass), this.hasStroke_ = this.renderPasses_.some((e) => e.strokeRenderPass), this.hasSymbol_ = this.renderPasses_.some((e) => e.symbolRenderPass), this.hasText_ = this.flatStyle && Nm(this.flatStyle), this.hasText_ && (this.textOverlayCanvas_ = y().canvas, this.textOverlayContext_ = this.textOverlayCanvas_.getContext("2d"), this.textOverlayRenderFrameState_ = null, this.textOverlayWorker_ = cm(), this.textOverlayRenderList_ = /* @__PURE__ */ new Set()), this.setHelper(n);
	}
	async generateBuffers(e, t, n) {
		...
		let i = new sm(), a = this.generateRenderInstructions_(e, i, t), [o, s, c, l] = await Promise.all([
	...
	generateRenderInstructions_(e, t, n) {
		return {
			polygonInstructions: this.hasFill_ || this.hasText_ ? vm(e.polygonBatch, /* @__PURE__ */ new Float32Array(), t, this.customAttributes_, n) : null,
			lineStringInstructions: this.hasStroke_ || this.hasText_ ? _m(e.lineStringBatch, /* @__PURE__ */ new Float32Array(), t, this.customAttributes_, n) : null,
			pointInstructions: this.hasSymbol_ || this.hasText_ ? gm(e.pointBatch, /* @__PURE__ */ new Float32Array(), t, this.customAttributes_, n) : null
		};
	}
	generateBuffersForType_(e, t, n) {
		...
		switch (t) {
			case "Polygon":
				r = um.GENERATE_POLYGON_BUFFERS;
				break;
			case "LineString":
				r = um.GENERATE_LINE_STRING_BUFFERS;
				break;
			case "Point": r = um.GENERATE_POINT_BUFFERS;
		}
		let i = {
			type: r,
			renderInstructions: e.buffer,
			renderInstructionsTransform: n,
			customAttributesSize: hm(this.customAttributes_)
		};
		return zm(Lm(), i, [e.buffer]).then((e) => {
			if (!this.helper_.getGL()) return;
			let t = e, n = new $f(Hf, Gf).fromArrayBuffer(t.indicesBuffer), r = new $f(Vf, Gf).fromArrayBuffer(t.vertexAttributesBuffer), i = new $f(Vf, Gf).fromArrayBuffer(t.instanceAttributesBuffer);
	...
	generateTextInstructions_(e, t, n, r) {
		...
		return zm(this.textOverlayWorker_, l, i).then((e) => e.instructionsSetKey);
	}
	render(e, t, n) {
	...
	finalizeTextRender(e) {
		...
		return zm(this.textOverlayWorker_, t).then((e) => {
			let t = e;
			if (t.imageData) {
...
var Wm = {
...
}, Gm = /* @__PURE__ */ new Uint8Array(4), Km = class {
	constructor(e, t) {
		this.helper_ = e;
		let n = e.getGL();
	...
	readPixel(e, t) {
		if (e < 0 || t < 0 || e > this.size_[0] || t >= this.size_[1]) return Gm[0] = 0, Gm[1] = 0, Gm[2] = 0, Gm[3] = 0, Gm;
		this.readAll();
		let n = Math.floor(e) + (this.size_[1] - Math.floor(t) - 1) * this.size_[0];
		return Gm[0] = this.data_[n * 4], Gm[1] = this.data_[n * 4 + 1], Gm[2] = this.data_[n * 4 + 2], Gm[3] = this.data_[n * 4 + 3], Gm;
	}
	getTexture() {
		return this.texture_;
	}
	...
	ONE: "u_one"
}, Jm = [0, 0], Ym = [0, 0], Xm = Kr(), Zm = Ff();
function Qm(e, t, n, r) {
	Xr(Xm, t), Jr(Xm, n), e.setUniformMatrixValue(ap.PROJECTION_MATRIX, Lf(Zm, Xm)), ei(Xm, Xm), e.setUniformMatrixValue(ap.INVERT_PROJECTION_MATRIX, Lf(Zm, Xm)), Jm[0] = 0, Jm[1] = 0;
	let i = r.size, a = r.viewState.resolution, o = r.viewState.center;
	$r(Xm, i[0] / 2, i[1] / 2, 1 / a, 1 / a, 0, -o[0], -o[1]), B(Xm, Jm), Ym[0] = Jp(Jm[0]), Ym[1] = qp(Jm[0]), e.setUniformFloatVec2(qm.PATTERN_ORIGIN_X_DOUBLE, Ym), Ym[0] = Jp(Jm[1]), Ym[1] = qp(Jm[1]), e.setUniformFloatVec2(qm.PATTERN_ORIGIN_Y_DOUBLE, Ym);
	let s = 2 ** ((r.viewState.zoom + .5) % 1 - .5);
	Jm[0] = Jp(s), Jm[1] = qp(s), e.setUniformFloatVec2(qm.PATTERN_SCALE_RATIO_DOUBLE, Jm);
}
//#endregion
...
var eh = {
	...
	constructor(e, t) {
		...
		}), this.hitDetectionEnabled_ = !t.disableHitDetection, this.hitRenderTarget_, this.sourceRevision_ = -1, this.layerRevision_ = -1, this.skipNextTextRender_ = !1, this.previousExtent_ = We(), this.currentTransform_ = Kr(), this.currentFrameStateTransform_ = Kr(), this.styleVariables_ = {}, this.style_ = [], this.hasText_ = !1, this.styleRenderer_ = null, this.buffers_ = null, this.batch_ = new nm(), this.initialFeaturesAdded_ = !1, this.sourceListenKeys_ = null, this.applyOptions_(t);
	}
	addInitialFeatures_(e) {
		...
		n && (r = lr(n, e.viewState.projection)), this.batch_.addFeatures(t.getFeatures(), r), this.sourceListenKeys_ = [
			A(t, Wm.ADDFEATURE, this.handleSourceFeatureAdded_.bind(this, r)),
			A(t, Wm.CHANGEFEATURE, this.handleSourceFeatureChanged_.bind(this, r), this),
			A(t, Wm.REMOVEFEATURE, this.handleSourceFeatureDelete_, this),
			A(t, Wm.CLEAR, this.handleSourceFeatureClear_, this)
		];
	}
	applyOptions_(e) {
		this.styleVariables_ = e.variables, this.style_ = e.style;
		let t = Hm(this.style_), n = !!t && Nm(t);
		n && !this.hasText_ ? this.setPostProcesses([Pm(() => this.styleRenderer_.getTextOverlayCanvas(), () => this.styleRenderer_.getTextOverlayFrameState()), ...this.getPostProcesses()]) : !n && this.hasText_ && this.setPostProcesses(this.getPostProcesses().slice(1)), this.hasText_ = n;
	}
	createRenderers_() {
	...
	afterHelperCreated() {
		this.styleRenderer_ ? this.styleRenderer_.setHelper(this.helper, this.buffers_) : this.createRenderers_(), this.hitDetectionEnabled_ && (this.hitRenderTarget_ = new Km(this.helper));
	}
	...
	applyUniforms_(e, t) {
		Qm(this.helper, this.currentFrameStateTransform_, e, t);
	}
	renderFrame(e) {
		let t = this.helper.getGL();
		this.preRender(t, e);
		let n = this.getLayer(), [r, i, a] = $m(e, n);
	...
	prepareFrameInternal(e) {
		...
		let t = this.getLayer(), n = t.getSource(), r = e.viewState, i = !e.viewHints[z.ANIMATING] && !e.viewHints[z.INTERACTING], a = !Ye(this.previousExtent_, e.extent), o = this.sourceRevision_ < n.getRevision(), s = this.layerRevision_ < t.getRevision();
		if (this.sourceRevision_ = n.getRevision(), this.layerRevision_ = t.getRevision(), (s || a || o) && (this.skipNextTextRender_ = !1), i && (a || o)) {
			let i = r.projection, a = r.resolution, o = t instanceof kl ? t.getRenderBuffer() : 0, s = Le(e.extent, o * a), c = hr();
	...
	forEachFeatureAtCoordinate(e, t, n, r, i) {
		...
		let a = B(t.coordinateToPixelTransform, e.slice()), o = this.hitRenderTarget_.readPixel(a[0] / 2, a[1] / 2), s = pm([
			o[0] / 255,
			o[1] / 255,
			o[2] / 255,
			o[3] / 255
	...
	constructor(e) {
		e ||= {};
		let t = Object.assign({}, e);
		delete t.gradient, delete t.radius, delete t.blur, delete t.weight, super(t), this.on, this.once, this.un, this.filter_ = e.filter ?? !0, this.styleVariables_ = e.variables || {}, this.gradient_ = null, this.addChangeListener(nh.GRADIENT, this.handleGradientChanged_), this.setGradient(e.gradient ? e.gradient : rh), this.setBlur(e.blur === void 0 ? 15 : e.blur), this.setRadius(e.radius === void 0 ? 8 : e.radius);
		let n = e.weight ? e.weight : "weight";
		this.weight_ = n, this.setRenderOrder(null);
	}
	getBlur() {
		return this.get(nh.BLUR);
	}
	getGradient() {
		return this.get(nh.GRADIENT);
	}
	getRadius() {
		return this.get(nh.RADIUS);
	}
	handleGradientChanged_() {
		this.gradient_ = ah(this.getGradient());
	}
	setBlur(e) {
		let t = this.get(nh.BLUR);
		if (this.set(nh.BLUR, e), typeof e == "number" && typeof t == "number") {
			this.changed();
			return;
		}
		this.clearRenderer();
	...
	setGradient(e) {
		this.set(nh.GRADIENT, e);
	}
	setRadius(e) {
		let t = this.get(nh.RADIUS);
		if (this.set(nh.RADIUS, e), typeof e == "number" && typeof t == "number") {
			this.changed();
			return;
		}
		this.clearRenderer();
	...
	createRenderer() {
		let e = new Zp(), t = kp(this.styleVariables_), n = _s(this.styleVariables_), r = Q(t, this.filter_, is, n), i = Q(t, this.getRadius(), H), a = Q(t, this.getBlur(), H), o = {};
...
$.create = function(e, t) {
	...
	return new ch(Object.assign({ input: t }, e || {})), t;
	...
	return e.type === "radio" ? new lh(n) : new sh(n), t;
	...
	e instanceof Ll && (e = e.getTargetElement()), !("ontouchstart" in window) && e instanceof Element && (e.style.cursor = t);
};
//#endregion
...
var uh = class extends Te {
	...
	drawList(e, t) {
		...
		function c(c) {
			...
			if (this.show_progress && c instanceof Iu) {
				var _ = $.create("DIV", {
	...
	getLayerClass(e) {
		return e ? e.getLayers ? "ol-layer-group" : e instanceof Df ? "ol-layer-vector" : e instanceof jf ? "ol-layer-vectortile" : e instanceof Iu ? "ol-layer-tile" : e instanceof Pf ? "ol-layer-image" : e instanceof ih ? "ol-layer-heatmap" : e.getFeatures ? "ol-layer-vectorimage" : "unknown" : "none";
	}
	selectLayer(e, t) {
		if (!e) {
...
}, ph = document.getElementById("map");
if (ph === null) throw Error("The OpenLayers map element could not be found.");
var mh = JSON.parse(ph.dataset.layers ?? "[]");
if (mh.length === 0) throw Error("No layers were supplied to the OpenLayers viewer.");
var hh = mh.map((e) => {
	let t = new ud({
		url: e.url,
		size: e.size,
...
}), gh = hh[0].getSource(), _h = gh.getTileGrid(), vh = _h.getResolutions(), yh = _h.getExtent(), bh = new qt({
	code: "ZoomifyProjection",
	units: "pixels",
	extent: yh,
	metersPerUnit: mh[0].mpp * 1e-6,
...
var kh = 64, Ah = 64, jh = new zc({
	...
	text: new Gc({
		...
		fill: new Fc({ color: "rgba(0, 0, 0, 1)" }),
		stroke: new Rc({
...
}), Nh = kh, Ph = Ah, Fh = new pd({
	projection: bh.getCode(),
	spacing: Nh,
	margin: Ph,
	style: jh,
	formatCoord(e, t) {
		let n = Sh.getView().calculateExtent(Sh.getSize()), r = Sh.getView().getResolution(), i = n[0] + r * Ph, a = n[3] - r * Ph, o;
		if (o = t === "left" || t === "right" ? -(e - a) : e - i, o = Math.floor(o / r / Nh), t === "left" || t === "right") {
			let e = "";
			do
	...
	onToggle(e) {
		e ? (Lh.setActive(!1), Fh.setMap(null), Mh.setMap(Sh)) : Mh.setMap(null);
	}
}), Lh;
Sh.addControl(Ih), Lh = new fh({
	html: "<i class=\"fas fa-border-all\"></i>",
	className: "ol-screen-space-graticule",
	title: "Toggle Screen Space Graticule",
	onToggle(e) {
		e ? (Ih.setActive(!1), Mh.setMap(null), Fh.setMap(Sh)) : Fh.setMap(null);
	}
}), Sh.addControl(Lh), Sh.getView().fit(yh), Object.assign(window, {
	extent: yh,
	fullscreen: Dh,
	graticule: Mh,
	graticuleToggle: Ih,
	...
	layersData: mh,
	map: Sh,
	mousePositionControl: Th,
	overviewMapControl: wh,
	projection: bh,
	resolutions: vh,
	rotate: Eh,
	scaleLineControl: Ch,
	screenSpaceGraticule: Fh,
	screenSpaceGraticuleToggle: Lh,
	view: xh
});
//#endregion
