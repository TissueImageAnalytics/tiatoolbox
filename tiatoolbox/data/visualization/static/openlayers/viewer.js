...
var De = {
	...
	setMap(e) {
		...
		if (this.listenerKeys.length = 0, this.map_ = e, e) {
			...
			this.element && t.appendChild(this.element), this.render !== y && this.listenerKeys.push(i(e, De.POSTRENDER, this.render, this)), e.render();
		}
	}
	render(e) {}
	setTarget(e) {
...
var I = {
	...
	setState(e) {
		if (this.state !== I.EMPTY) {
			if (this.state !== I.ERROR && this.state > e) throw Error("Tile load sequence violation");
	...
	getAlpha(e, t) {
		...
		let r = t - n + 1e3 / 60;
		return r >= this.transition_ ? 1 : Ae(r / this.transition_);
	}
	inTransition(e) {
...
var ze = /* @__PURE__ */ Error("disposed"), Be = [256, 256], Ve = class extends Le {
	constructor(e) {
		let t = I.IDLE;
		super(e.tileCoord, t, {
	...
	load() {
		if (this.state !== I.IDLE && this.state !== I.ERROR) return;
		this.state = I.LOADING, this.changed();
		let e = this;
		this.loader_().then(function(t) {
			e.data_ = t, e.state = I.LOADED, e.changed();
		}).catch(function(t) {
			e.error_ = t, e.state = I.ERROR, e.changed();
		});
	}
	disposeInternal() {
		this.controller_ &&= (this.controller_.abort(ze), null), super.disposeInternal();
	}
}, L = {
	IDLE: 0,
	LOADING: 1,
...
var Ge = class extends Le {
	...
	setImage(e) {
		this.image_ = e, this.state = I.LOADED, this.unlistenImage_(), this.changed();
	}
	getCrossOrigin() {
	...
	load() {
		this.state == I.ERROR && (this.state = I.IDLE, this.image_ = new Image(), this.crossOrigin_ !== null && (this.image_.crossOrigin = this.crossOrigin_), this.referrerPolicy_ !== void 0 && (this.image_.referrerPolicy = this.referrerPolicy_)), this.state == I.IDLE && (this.state = I.LOADING, this.changed(), this.tileLoadFunction_(this, this.src_), this.unlisten_ = He(this.image_, this.handleImageLoad_.bind(this), this.handleImageError_.bind(this)));
	}
	unlistenImage_() {
...
function Je(e, t, n, r, i) {
	return i === void 0 ? new qe(e, t, n, r) : (i.minX = e, i.maxX = t, i.minY = n, i.maxY = r, i);
}
//#endregion
...
function Xe(e) {
	let t = at();
	for (let n = 0, r = e.length; n < r; ++n) ft(t, e[n]);
	return t;
}
function Ze(e, t, n) {
	return ot(Math.min.apply(null, e), Math.min.apply(null, t), Math.max.apply(null, e), Math.max.apply(null, t), n);
}
function Qe(e, t, n) {
...
function it(e, t) {
	let n = e[0], r = e[1], i = e[2], a = e[3], o = t[0], s = t[1], c = Ye.UNKNOWN;
	return o < n ? c |= Ye.LEFT : o > i && (c |= Ye.RIGHT), s < r ? c |= Ye.BELOW : s > a && (c |= Ye.ABOVE), c === Ye.UNKNOWN && (c = Ye.INTERSECTING), c;
}
function at() {
	return [
		Infinity,
...
function st(e) {
	return ot(Infinity, Infinity, -Infinity, -Infinity, e);
}
function ct(e, t) {
	let n = e[0], r = e[1];
	return ot(n, r, n, r, t);
...
function ht(e, t) {
	let n;
	return n = t(_t(e)), n || (n = t(vt(e)), n) || (n = t(Dt(e)), n) || (n = t(Et(e)), n) ? n : !1;
}
function gt(e) {
	let t = 0;
	return kt(e) || (t = R(e) * Ct(e)), t;
}
function _t(e) {
	return [e[0], e[1]];
}
...
function bt(e, t) {
	let n;
	if (t === "bottom-left") n = _t(e);
	else if (t === "bottom-right") n = vt(e);
	else if (t === "top-left") n = Et(e);
	else if (t === "top-right") n = Dt(e);
	else throw Error("Invalid corner");
	return n;
}
function xt(e, t, n, r, i) {
	let [a, o, s, c, l, u, d, f] = St(e, t, n, r);
	return ot(Math.min(a, s, l, d), Math.min(o, c, u, f), Math.max(a, s, l, d), Math.max(o, c, u, f), i);
}
function St(e, t, n, r) {
...
function wt(e, t, n) {
	let r = n || at();
	return Ot(e, t) ? (r[0] = e[0] > t[0] ? e[0] : t[0], r[1] = e[1] > t[1] ? e[1] : t[1], r[2] = e[2] < t[2] ? e[2] : t[2], r[3] = e[3] < t[3] ? e[3] : t[3]) : st(r), r;
}
function Tt(e, t) {
	if (!Ot(e, t)) return [e.slice()];
	if (nt(t, e)) return [];
...
function Mt(e, t, n) {
	let r = !1, i = it(e, t), a = it(e, n);
	if (i === Ye.INTERSECTING || a === Ye.INTERSECTING) r = !0;
	else {
		let o = e[0], s = e[1], c = e[2], l = e[3], u = t[0], d = t[1], f = n[0], p = n[1], m = (p - d) / (f - u), h, g;
		a & Ye.ABOVE && !(i & Ye.ABOVE) && (h = f - (p - l) / m, r = h >= o && h <= c), !r && a & Ye.RIGHT && !(i & Ye.RIGHT) && (g = p - (f - c) * m, r = g >= s && g <= l), !r && a & Ye.BELOW && !(i & Ye.BELOW) && (h = f - (p - s) / m, r = h >= o && h <= c), !r && a & Ye.LEFT && !(i & Ye.LEFT) && (g = p - (f - o) * m, r = g >= s && g <= l);
	}
	return r;
}
function Nt(e, t, n, r) {
...
function Pt(e, t) {
	let n = t.getExtent(), r = yt(e);
	if (t.canWrapX() && (r[0] < n[0] || r[0] >= n[2])) {
		let t = R(n), i = Math.floor((r[0] - n[0]) / t) * t;
		e[0] -= i, e[2] -= i;
	}
	return e;
}
...
function It(e, t) {
	...
	for (let e = 0, r = t.length; e < r && n.length > 0; ++e) {
		let r = [];
		for (let i = 0, a = n.length; i < a; ++i) r.push(...Tt(n[i], t[e]));
		n = r;
	}
	return n;
}
...
function rn(e, t) {
	if (t.canWrapX()) {
		let n = R(t.getExtent()), r = an(e, t, n);
		r && (e[0] -= r * n);
	}
	return e;
}
function an(e, t, n) {
	...
	return t.canWrapX() && (e[0] < r[0] || e[0] > r[2]) && (n ||= R(r), i = Math.floor((e[0] - r[0]) / n)), i;
}
function on(e, t, n) {
	let r = Math.sqrt((t[0] - e[0]) * (t[0] - e[0]) + (t[1] - e[1]) * (t[1] - e[1])), i = [(t[0] - e[0]) / r, (t[1] - e[1]) / r], a = [-i[1], i[0]], o = Math.sqrt((n[0] - e[0]) * (n[0] - e[0]) + (n[1] - e[1]) * (n[1] - e[1])), s = [(n[0] - e[0]) / o, (n[1] - e[1]) / o], c = r === 0 || o === 0 ? 0 : Math.acos(Bt(s[0] * i[0] + s[1] * i[1], -1, 1));
...
function jr(e, t) {
	return ur && !en(e, [0, 0]) && e[0] >= -180 && e[0] <= 180 && e[1] >= -90 && e[1] <= 90 && (ur = !1, zt("Call useGeographic() from ol/proj once to work with [longitude, latitude] coordinates.")), e;
}
function Mr(e, t) {
	return e;
}
...
function Hr(e, t, n, r) {
	let i = Vr(e, t, yt(n), r);
	return (!isFinite(i) || i <= 0) && ht(n, function(n) {
...
function Ur(e, t, n, r, i, a, o, s, c, l, u, d, f, p) {
	...
	if (!f || c.length !== 1 || l !== 0) {
		...
		c.forEach(function(e, t, n) {
			if (e.image.width > 0 && e.image.height > 0) {
				if (e.clipExtent) {
					_.save();
					let t = (e.clipExtent[0] - g[0]) * v, n = -(e.clipExtent[3] - g[3]) * v, r = R(e.clipExtent) * v, i = Ct(e.clipExtent) * v;
					_.rect(d ? t : Math.round(t), d ? n : Math.round(n), d ? r : Math.round(t + r) - Math.round(t), d ? i : Math.round(n + i) - Math.round(n)), _.clip();
				}
				let t = (e.extent[0] - g[0]) * v, n = -(e.extent[3] - g[3]) * v, r = R(e.extent) * v, i = Ct(e.extent) * v;
	...
	return s.getTriangles().forEach(function(e, t, n) {
		...
		if (_) k = _.canvas, m.scale(y, -y);
			...
			k = e.image, m.scale(R(t) / k.width, -Ct(t) / k.height);
		}
		m.drawImage(k, 0, 0), m.restore();
	}), _ && (ye(_), Lr.push(_.canvas)), u && (m.save(), m.globalCompositeOperation = "source-over", m.strokeStyle = "black", m.lineWidth = 1, s.getTriangles().forEach(function(e, t, n) {
...
var oi = 10, si = .25, ci = class {
	constructor(e, t, n, r, i, a, o) {
		...
		}, this.maxSourceExtent_ = r, this.errorThresholdSquared_ = i * i, this.triangles_ = [], this.wrapsXInSource_ = !1, this.canWrapXInSource_ = this.sourceProj_.canWrapX() && !!r && !!this.sourceProj_.getExtent() && R(r) >= R(this.sourceProj_.getExtent()), this.sourceWorldWidth_ = this.sourceProj_.getExtent() ? R(this.sourceProj_.getExtent()) : null, this.targetWorldWidth_ = this.targetProj_.getExtent() ? R(this.targetProj_.getExtent()) : null;
		let l = Et(n), u = Dt(n), d = vt(n), f = _t(n), p = this.transformInv_(l), m = this.transformInv_(u), h = this.transformInv_(d), g = this.transformInv_(f), _ = oi + (a ? Math.max(0, Math.ceil(Math.log2(gt(n) / (a * a * 256 * 256)))) : 0);
	...
	addQuad_(e, t, n, r, i, a, o, s, c) {
		let l = Xe([
			...
			o,
			s
		]), u = this.sourceWorldWidth_ ? R(l) / this.sourceWorldWidth_ : null, d = this.sourceWorldWidth_, f = this.sourceProj_.canWrapX() && u > .5 && u < 1, p = !1;
		if (c > 0 && (this.targetProj_.isGlobal() && this.targetWorldWidth_ && (p = R(Xe([
			e,
			t,
			n,
			r
		])) / this.targetWorldWidth_ > si || p), !f && this.sourceProj_.isGlobal() && u && (p = u > si || p)), !p && this.maxSourceExtent_ && isFinite(l[0]) && isFinite(l[1]) && isFinite(l[2]) && isFinite(l[3]) && !Ot(l, this.maxSourceExtent_)) return;
		let m = 0;
	...
	calculateSourceExtent() {
		...
		return this.triangles_.forEach(function(t, n, r) {
			let i = t.source;
			ft(e, i[0]), ft(e, i[1]), ft(e, i[2]);
		}), e;
	}
	getTriangles() {
		return this.triangles_;
	}
}, li = .5, ui = class extends Le {
	constructor(e, t, n, r, i, a, o, s, c, l, u, d) {
		super(i, I.IDLE, d), this.renderEdges_ = u !== void 0 && u, this.pixelRatio_ = o, this.gutter_ = s, this.canvas_ = null, this.sourceTileGrid_ = t, this.targetTileGrid_ = r, this.wrappedTileCoord_ = a || i, this.sourceTiles_ = [], this.sourcesListenerKeys_ = null, this.sourceZ_ = 0, this.clipExtent_ = e.canWrapX() ? e.getExtent() : void 0;
		let f = r.getTileCoordExtent(this.wrappedTileCoord_), p = this.targetTileGrid_.getExtent(), m = this.sourceTileGrid_.getExtent(), h = p ? wt(f, p) : f;
		if (gt(h) === 0) {
			this.state = I.EMPTY;
			return;
		}
		...
		if (m && (e.canWrapX() ? (b[1] = Bt(b[1], m[1], m[3]), b[3] = Bt(b[3], m[1], m[3])) : b = wt(b, m)), !gt(b)) this.state = I.EMPTY;
		else {
			let n = 0, r = 0;
			e.canWrapX() && (n = R(g), r = Math.floor((b[0] - g[0]) / n)), Ft(b.slice(), e, !0).forEach((e) => {
				...
				++r;
			}), this.sourceTiles_.length === 0 && (this.state = I.EMPTY);
		}
	}
	getImage() {
		return this.canvas_;
	...
	reproject_() {
		...
		if (this.sourceTiles_.forEach((t) => {
		...
		}), this.sourceTiles_.length = 0, e.length === 0) this.state = I.ERROR;
		else {
			...
			this.canvas_ = Ur(r, i, this.pixelRatio_, o, this.sourceTileGrid_.getExtent(), a, s, this.triangulation_, e, this.gutter_, this.renderEdges_, this.interpolate), this.state = I.LOADED;
		}
		this.changed();
	}
	load() {
	...
	release() {
		this.canvas_ &&= (ye(this.canvas_.getContext("2d")), Lr.push(this.canvas_), null), this.sourceTiles_.length = 0, super.release();
	}
};
//#endregion
...
function Ai(e) {
	if (e.toLowerCase().startsWith("rgb")) {
		...
		if (t) {
			let e = t[4], n = 100 / 255;
			return [
				Bt(Oi(t[1], n) + .5 | 0, 0, 255),
				Bt(Oi(t[2], n) + .5 | 0, 0, 255),
				Bt(Oi(t[3], n) + .5 | 0, 0, 255),
				e === void 0 ? 1 : Bt(Oi(e, 100), 0, 1)
			];
		}
		ki(e);
	}
...
var Gi = class extends S {
	...
	constructor() {
		this.instructions_ = [], this.zIndex = 0, this.offset_ = 0, this.pendingMethod_, this.context_ = new Proxy(ve(), {
			get: (e, t) => {
	...
	handleImageChange_(e) {
		let t = e.target;
		(t.getState() === L.LOADED || t.getState() === L.ERROR) && this.renderIfReadyAndVisible();
	}
	loadImage(e) {
		let t = e.getState();
		return t != L.LOADED && t != L.ERROR && e.addEventListener(s.CHANGE, this.boundHandleImageChange_), t == L.IDLE && (e.load(), t = e.getState()), t == L.LOADED;
	}
...
var $i = class extends Yi {
	...
	useContainer(e, t, n, r, i) {
		if (Ee(e) && this.pixelTransform[1] === 0 && this.pixelTransform[2] === 0 && this.pixelTransform[4] === 0 && this.pixelTransform[5] === 0 && e.width === r && e.height === i) {
	...
	clipUnrotated(e, t, n) {
		let r = Et(n), i = Dt(n), a = vt(n), o = _t(n);
	...
	prepareContainer(e, t) {
		let n = e.extent, r = e.viewState.resolution, i = e.viewState.rotation, a = e.pixelRatio, o = Math.round(R(n) / r * a), s = Math.round(Ct(n) / r * a);
...
function na(e, t) {
	...
	n.extent && (t = wt(t, Nr(n.extent, e.viewState.projection)));
...
var ra = class extends $i {
	constructor(e, t) {
		super(e), t ||= {}, this.extentChanged = !0, this.renderComplete = !1, this.renderedExtent_ = null, this.renderedPixelRatio, this.renderedProjection = null, this.renderedTiles = [], this.renderedSourceRevision_, this.tempExtent = at(), this.tempTileRange_ = new qe(0, 0, 0, 0), this.tempTileCoord_ = hi(0, 0, 0);
	...
	getData(e) {
		...
		for (let e = s.getZForResolution(a.resolution); e >= s.getMinZoom(); --e) {
			...
			if (!i || i.getState() !== I.LOADED) continue;
			let l = s.getOrigin(e), u = pi(s.getTileSize(e)), d = s.getResolution(e), f;
			if (i instanceof Ge || i instanceof ui) f = i.getImage();
			else if (i instanceof Ve) {
				if (f = Re(i.getData()), !f) continue;
			} else continue;
	...
	enqueueTiles(e, t, n, r, i) {
		...
		for (let i = n; i >= f; --i) {
			...
			for (let t = n.minX; t <= n.maxX; ++t) for (let o = n.minY; o <= n.maxY; ++o) {
				...
				let s = n.getKey();
				if (u[s] = !0, n.getState() === I.IDLE && !e.tileQueue.isKeyQueued(s)) {
	...
	findStaleTile_(e, t) {
		...
		for (let e = 0; e < o.length; ++e) {
			...
			if (n.containsKey(s)) {
				let e = n.peek(s);
				if (e.getState() === I.LOADED) return e.endTransition(O(this)), ea(t, e, r), !0;
			}
		}
		return !1;
	}
	findAltTiles_(e, t, n, r) {
		...
		for (let e = i.minX; e <= i.maxX; ++e) for (let t = i.minY; t <= i.maxY; ++t) {
			...
			if (o.containsKey(i)) {
				let e = o.peek(i);
				e.getState() === I.LOADED && (ea(r, e, n), l = !0);
			}
			l || (a = !1);
		}
		return a;
	...
	renderFrame(e, t) {
		...
		this.layerExtent = n.extent ? Nr(n.extent, i) : null, this.layerExtent && (m = wt(m, this.layerExtent));
		...
		for (let t of x[f]) {
			...
			let r = t.tileCoord;
			if (n === I.LOADED && t.getAlpha(w, T) === 1) {
				t.endTransition(w);
				continue;
			}
			if (n !== I.ERROR && (this.renderComplete = !1), this.findStaleTile_(r, x)) {
	...
	drawTile(e, t, n, r, i, a, o, s, c) {
		let l;
		if (e instanceof Ve) {
			if (l = Re(e.getData()), !l) throw Error("Rendering array data is not yet supported");
...
var da = Kr(), fa = [NaN, NaN], pa = class extends A {
	constructor() {
		super(), this.extent_ = at(), this.extentRevision_ = -1, this.simplifiedGeometryMaxMinSquaredTolerance = 0, this.simplifiedGeometryRevision = 0, this.simplifyTransformedInternal = b((e, t, n) => {
	...
	getExtent(e) {
		if (this.extentRevision_ != this.getRevision()) {
			...
			(isNaN(e[0]) || isNaN(e[1])) && st(e), this.extentRevision_ = this.getRevision();
		}
		return At(this.extent_, e);
	}
	rotate(e, t) {
		E();
	}
	...
	computeExtent(e) {
		return lt(this.flatCoordinates, 0, this.flatCoordinates.length, this.stride, e);
	}
	getCoordinates() {
		return E();
	}
	...
	scale(e, t, n) {
		t === void 0 && (t = e), n ||= yt(this.getExtent());
...
function Fa(e, t, n, r, i, a) {
	return a ??= pt(at(), e, t, n, r), Ot(i, a) ? a[0] >= i[0] && a[2] <= i[2] || a[1] >= i[1] && a[3] <= i[3] || Pa(e, t, n, r, function(e, t) {
		return Mt(i, e, t);
	}) : !1;
}
...
var Ua = class e extends ma {
	...
	closestPointXY(e, t, n, r) {
		return r < et(this.getExtent(), e, t) ? r : (this.maxDeltaRevision_ != this.getRevision() && (this.maxDelta_ = Math.sqrt(xa(this.flatCoordinates, 0, this.flatCoordinates.length, this.stride, 0)), this.maxDeltaRevision_ = this.getRevision()), Ca(this.flatCoordinates, 0, this.flatCoordinates.length, this.stride, this.maxDelta_, !0, e, t, n, r));
	}
	getArea() {
	...
	computeExtent(e) {
		return ct(this.flatCoordinates, e);
	}
	getType() {
		return "Point";
	}
	intersectsExtent(e) {
		return rt(e, this.flatCoordinates[0], this.flatCoordinates[1]);
	}
	setCoordinates(e, t) {
...
var Qa = class e extends ma {
	...
	closestPointXY(e, t, n, r) {
		return r < et(this.getExtent(), e, t) ? r : (this.maxDeltaRevision_ != this.getRevision() && (this.maxDelta_ = Math.sqrt(Sa(this.flatCoordinates, 0, this.ends_, this.stride, 0)), this.maxDeltaRevision_ = this.getRevision()), wa(this.flatCoordinates, 0, this.ends_, this.stride, this.maxDelta_, !0, e, t, n, r));
	}
	containsXY(e, t) {
...
function $a(e) {
	if (kt(e)) throw Error("Cannot create polygon from empty extent");
...
function eo(e, t, n, r) {
	let i = R(t) / n[0], a = Ct(t) / n[1];
	return r ? Math.min(e, Math.max(i, a)) : Math.min(e, Math.min(i, a));
}
function to(e, t, n) {
	let r = Math.min(e, t);
	return r *= Math.log(1 + 50 * Math.max(0, e / t - 1)) / 50 + 1, n && (r = Math.max(r, n), r /= Math.log(1 + 50 * Math.max(0, n / e - 1)) / 50 + 1), Bt(r, n / 2, t * 2);
}
function no(e, t, n, r) {
	return t = t === void 0 || t, (function(i, a, o, s) {
		if (i !== void 0) {
			let c = e[0], l = e[e.length - 1], u = n ? eo(c, n, o, r) : c;
			if (s) return t ? to(i, u, l) : Bt(i, l, u);
...
var lo = 0, uo = class extends A {
	...
	calculateExtentInternal(e) {
		...
		return z(r !== void 0, "The view rotation is not defined"), xt(t, n, r, e);
	}
	getMaxResolution() {
	...
	getResolutionForZoom(e) {
		if (this.resolutions_?.length) {
			...
			let t = Bt(Math.floor(e), 0, this.resolutions_.length - 2), n = this.resolutions_[t] / this.resolutions_[t + 1];
			return this.resolutions_[t] / n ** +Bt(e - t, 0, 1);
		}
		return this.maxResolution_ / this.zoomFactor_ ** +(e - this.minZoom_);
	}
	fit(e, t) {
		let n;
		if (z(Array.isArray(e) || typeof e.getSimplifiedGeometry == "function", "Invalid extent or geometry provided as `geometry`"), Array.isArray(e)) z(!kt(e), "Cannot fit empty extent provided as `geometry`"), n = $a(Nr(e, this.getProjection()));
		else if (e.getType() === "Circle") {
			let t = Nr(e.getExtent(), this.getProjection());
			n = $a(t), n.rotate(this.getRotation(), yt(t));
		} else {
			let t = kr();
	...
	fitInternal(e, t) {
		...
		let c = this.getRotation(), l = Math.sin(c), u = Math.cos(c), d = yt(o);
...
function mo(e) {
	...
	if (!s && !p && u.isGlobal() && (f = !1, p = d), e.resolutions !== void 0) {
		...
		let s = (d ? Math.max(R(d), Ct(d)) : 360 * sn.degrees / u.getMetersPerUnit()) / 256 / 2 ** lo, m = s / 2 ** 28;
...
var H = {
	...
	isVisible(e) {
		...
		return bo(r, t.viewState) && (!i || Ot(i, t.extent));
	}
	getAttributions(e) {
...
var xo = {
	...
	handleTileChange(e) {
		...
		if (n === I.LOADED || n === I.ERROR || n === I.EMPTY) {
			n !== I.ERROR && t.removeEventListener(s.CHANGE, this.boundHandleTileChange_);
			let e = t.getKey();
	...
	loadMoreTiles(e, t) {
		...
		for (; this.tilesLoading_ < e && n < t && this.getCount() > 0;) {
			...
			e.getState() === I.IDLE && !(t in this.tilesLoadingKeys_) && (this.tilesLoadingKeys_[t] = !0, ++this.tilesLoading_, ++n, e.load());
		}
	}
};
...
var es = class extends Qo {
	...
	handleWheelZoom_(e) {
		...
		let n = -Bt(this.totalDelta_, -this.maxDelta_ * this.deltaPerZoom_, this.maxDelta_ * this.deltaPerZoom_) / this.deltaPerZoom_;
...
var _s = {
	...
	getLayerStatesArray(e) {
		...
		for (let e = n, a = t.length; e < a; e++) {
			let n = t[e];
			n.opacity *= r.opacity, n.visible = n.visible && r.visible, n.maxResolution = Math.min(n.maxResolution, r.maxResolution), n.minResolution = Math.max(n.minResolution, r.minResolution), n.minZoom = Math.max(n.minZoom, r.minZoom), n.maxZoom = Math.min(n.maxZoom, r.maxZoom), r.extent !== void 0 && (n.extent = n.extent === void 0 ? r.extent : wt(n.extent, r.extent)), n.zIndex === void 0 && (n.zIndex = i);
		}
		return t;
	}
	getSourceState() {
...
var Pc = class {
	...
	set(e, t, n, r) {
		...
		this.cache_[i] = n, r && (n.getImageState() === L.IDLE && n.load(), n.getImageState() === L.LOADING ? n.ready().then(() => {
			this.patternCache_[i] = ve().createPattern(n.getImage(1), "repeat");
		}) : this.patternCache_[i] = ve().createPattern(n.getImage(1), "repeat")), a || ++this.cacheSize_;
	}
	setSize(e) {
...
var Ic = new Pc(), Lc = null, Rc = class extends C {
	constructor(e, t, n, r, i) {
		super(), this.hitDetectionImage_ = null, this.image_ = e, this.crossOrigin_ = n?.crossOrigin, this.referrerPolicy_ = n?.referrerPolicy, this.canvas_ = {}, this.color_ = i, this.imageState_ = r === void 0 ? L.IDLE : r, this.size_ = e && e.width && e.height ? [e.width, e.height] : null, this.src_ = t, this.tainted_, this.ready_ = null;
	}
	initializeImage_() {
	...
	handleImageError_() {
		this.imageState_ = L.ERROR, this.dispatchChangeEvent_();
	}
	handleImageLoad_() {
		this.imageState_ = L.LOADED, this.size_ = [this.image_.width, this.image_.height], this.dispatchChangeEvent_();
	}
	getImage(e) {
	...
	load() {
		if (this.imageState_ === L.IDLE) {
			this.image_ || this.initializeImage_(), this.imageState_ = L.LOADING;
			try {
				this.src_ !== void 0 && (this.image_.src = this.src_);
			} catch {
				this.handleImageError_();
			}
			this.image_ instanceof HTMLImageElement && We(this.image_, this.src_).then((e) => {
	...
	ready() {
		return this.ready_ ||= new Promise((e) => {
			if (this.imageState_ === L.LOADED || this.imageState_ === L.ERROR) e();
			else {
				let t = () => {
					(this.imageState_ === L.LOADED || this.imageState_ === L.ERROR) && (this.removeEventListener(s.CHANGE, t), e());
				};
...
var dl = class e {
	...
	constructor(e) {
		...
		}), this.hitDetectionCanvas_ = null, this.fill_ = e.fill === void 0 ? null : e.fill, this.origin_ = [0, 0], this.points_ = e.points, this.radius = e.radius, this.radius2_ = e.radius2, this.angle_ = e.angle === void 0 ? 0 : e.angle, this.stroke_ = e.stroke === void 0 ? null : e.stroke, this.size_, this.renderOptions_, this.imageState_ = this.fill_ && this.fill_.loading() ? L.LOADING : L.LOADED, this.imageState_ === L.LOADING && this.ready().then(() => this.imageState_ = L.LOADED), this.render();
	}
	clone() {
	...
	setColor(e) {
		if (typeof e == "object" && e && "src" in e) {
			...
			}), t.getImageState() === L.IDLE && t.load(), t.getImageState() === L.LOADING && (this.patternImage_ = t);
		}
		this.color_ = e;
	}
	getKey() {
...
var gl = class e extends dl {
	constructor(e) {
		...
		let s;
		if (e.src === void 0 ? a !== void 0 && (s = "complete" in a ? a.complete ? a.src ? L.LOADED : L.IDLE : L.LOADING : L.LOADED) : s = L.IDLE, this.color_ = e.color === void 0 ? null : Ui(e.color), this.iconImage_ = zc(a, o, {
	...
	setColor(e) {
		...
		this.color_ = t;
		let n = this.getSrc(), r = n === void 0 ? this.getHitDetectionImage() : null, i = n === void 0 ? this.iconImage_.getImageState() : L.IDLE;
	...
	getWidth() {
		...
		if (this.iconImage_.getImageState() == L.LOADED) return this.iconImage_.getSize()[0] * e[0];
	}
	getHeight() {
		let e = this.getScaleArray();
		if (this.size_) return this.size_[1] * e[1];
		if (this.iconImage_.getImageState() == L.LOADED) return this.iconImage_.getSize()[1] * e[1];
	}
	setScale(e) {
...
var fu = class extends uu {
	...
	renderFrame(e) {
		...
		Ee(r) && (i = r.getContext("2d"), i.setTransform(1, 0, 0, 1, 0, 0), i.clearRect(0, 0, r.width, r.height));
		let a = [], o = i ? r : null;
		...
		this.declutter(e, a), we(this.element_, this.children_);
		for (let e of i ? this.children_ : []) {
			let t = e.firstElementChild || e, n = e.style.backgroundColor;
			if (n && (!Ee(t) || t.width > 0) && (i.fillStyle = n, i.fillRect(0, 0, i.canvas.width, i.canvas.height)), !Ee(t) || t.width === 0) continue;
			i.save();
...
var hu = class extends A {
	...
	handlePostRender() {
		...
		e && this.renderer_ && !e.animate && (this.renderComplete_ ? (this.hasListener(Ki.RENDERCOMPLETE) && this.renderer_.dispatchRenderEvent(Ki.RENDERCOMPLETE, e), this.loaded_ === !1 && (this.loaded_ = !0, this.dispatchEvent(new wo(De.LOADEND, this, e)))) : this.loaded_ === !0 && (this.loaded_ = !1, this.dispatchEvent(new wo(De.LOADSTART, this, e))));
	...
	handleTargetChanged_() {
		...
		if (this.targetElement_ && !Ee(this.targetElement_)) {
		...
		if (this.targetElement_ = t, !t) this.renderer_ &&= (clearTimeout(this.postRenderTimeoutHandle_), this.postRenderTimeoutHandle_ = void 0, this.postRenderFunctions_.length = 0, this.renderer_.dispose(), null), this.animationDelayKey_ &&= (cancelAnimationFrame(this.animationDelayKey_), void 0);
			...
			if (Ee(t) || t.appendChild(this.viewport_), this.renderer_ ||= new fu(this), !Ee(t)) {
				...
				if (this.targetChangeHandlerKeys_ = [i(e, s.KEYDOWN, this.handleBrowserEvent, this), i(e, s.KEYPRESS, this.handleBrowserEvent, this)], !Ee(t)) {
					let e = t.getRootNode();
	...
	renderFrame_(e) {
		...
		if (t !== void 0 && di(t) && n && n.isDef()) {
			...
			if (i = {
				...
				declutter: null,
				extent: xt(a.center, a.resolution, a.rotation, t),
				...
				i.nextExtent = xt(a.nextCenter, a.nextResolution, e, t);
			}
		}
		this.frameState_ = i, this.renderer_.renderFrame(i), i && (i.animate && this.render(), Array.prototype.push.apply(this.postRenderFunctions_, i.postRenderFunctions), r && (!this.previousExtent_ || !kt(this.previousExtent_) && !ut(i.extent, this.previousExtent_)) && (this.dispatchEvent(new wo(De.MOVESTART, this, r)), this.previousExtent_ = st(this.previousExtent_)), this.previousExtent_ && !i.viewHints[V.ANIMATING] && !i.viewHints[V.INTERACTING] && !ut(i.extent, this.previousExtent_) && (this.dispatchEvent(new wo(De.MOVEEND, this, i)), $e(i.extent, this.previousExtent_))), this.dispatchEvent(new wo(De.POSTRENDER, this, i)), this.renderComplete_ = (this.hasListener(De.LOADSTART) || this.hasListener(De.LOADEND) || this.hasListener(Ki.RENDERCOMPLETE)) && !this.tileQueue_.getTilesLoading() && !this.tileQueue_.getCount() && !this.getLoadingOrNotReady(), this.postRenderTimeoutHandle_ ||= setTimeout(() => {
	...
	updateSize() {
		...
		if (e) {
			...
			!isNaN(n) && !isNaN(r) && (t = [Math.max(0, n), Math.max(0, r)], !di(t) && (e.offsetWidth || e.offsetHeight || e.getClientRects().length) && zt("No map visible because the map container's width or height are 0."));
		}
		let n = this.getSize();
...
var _u = [
	...
	constructor(e) {
		...
		let i = e.extent;
		i !== void 0 && !this.origin_ && !this.origins_ && (this.origin_ = Et(i)), z(!this.origin_ && this.origins_ || this.origin_ && !this.origins_, "Either `origin` or `origins` must be configured, never both"), this.tileSizes_ = null, e.tileSizes !== void 0 && (this.tileSizes_ = e.tileSizes, z(this.tileSizes_.length == this.resolutions_.length, "Number of `tileSizes` and `resolutions` must be equal")), this.tileSize_ = e.tileSize === void 0 ? this.tileSizes_ ? null : 256 : e.tileSize, z(!this.tileSize_ && this.tileSizes_ || this.tileSize_ && !this.tileSizes_, "Either `tileSize` or `tileSizes` must be configured, never both"), this.extent_ = i === void 0 ? null : i, this.fullTileRanges_ = null, this.tmpSize_ = [0, 0], this.tmpExtent_ = [
			0,
			0,
			0,
			0
		], e.tileRanges === void 0 ? e.sizes === void 0 ? i && this.calculateTileRanges_(i) : this.fullTileRanges_ = e.sizes.map((e, t) => {
			let n = new qe(Math.min(0, e[0]), Math.max(e[0] - 1, -1), Math.min(0, e[1]), Math.max(e[1] - 1, -1));
			if (i) {
	...
	forEachTileCoordParentTileRange(e, t, n, r) {
		...
		for (this.zoomFactor_ === 2 ? (a = e[1], o = e[2]) : s = this.getTileCoordExtent(e, r); c >= this.minZoom;) {
			if (a !== void 0 && o !== void 0 ? (a = Math.floor(a / 2), o = Math.floor(o / 2), i = Je(a, a, o, o, n)) : i = this.getTileRangeForExtentAndZ(s, c, n), t(c, i)) return !0;
			--c;
		}
		return !1;
	}
	...
	getTileRangeForTileCoordAndZ(e, t, n) {
		...
		if (t === r) return Je(i, a, i, a, n);
		if (this.zoomFactor_) {
			let e = this.zoomFactor_ ** +(t - r), o = Math.floor(i * e), s = Math.floor(a * e);
			return t < r ? Je(o, o, s, s, n) : Je(o, Math.floor(e * (i + 1)) - 1, s, Math.floor(e * (a + 1)) - 1, n);
		}
	...
	getTileCoordExtent(e, t) {
		...
		return ot(a, o, a + i[0] * r, o + i[1] * r, t);
	}
	...
	getZForResolution(e, t) {
		return Bt(f(this.resolutions_, e, t || 0), this.minZoom, this.maxZoom);
	}
...
function Au(e, t, n) {
	...
	if (!tt(a, i)) {
		let t = R(a), n = Math.ceil((a[0] - i[0]) / t);
...
var Lu = class extends Fu {
	...
	handleTileChange(e) {
		...
		r == I.LOADING ? (this.tileLoadingKeys_[n] = !0, i = zu.TILELOADSTART) : n in this.tileLoadingKeys_ && (delete this.tileLoadingKeys_[n], i = r == I.ERROR ? zu.TILELOADERROR : r == I.LOADED ? zu.TILELOADEND : void 0), i != null && this.dispatchEvent(new Ru(i, t));
	}
	...
	constructor(e) {
		...
		}), this.crossOrigin = e.crossOrigin === void 0 ? null : e.crossOrigin, this.referrerPolicy = e.referrerPolicy, this.tileClass = e.tileClass === void 0 ? Ge : e.tileClass, this.tileGridForProjection = {}, this.reprojectionErrorThreshold_ = e.reprojectionErrorThreshold, this.renderReprojectionEdges_ = !1;
	}
	getGutterForProjection(e) {
	...
	createTile_(e, t, n, r, i, a) {
		let o = [
			...
			t,
			n
		], c = this.getTileCoordForTileUrlFunction(o, i), l = c ? this.tileUrlFunction(c, r, i) : void 0, u = new this.tileClass(o, l === void 0 ? I.EMPTY : I.IDLE, l === void 0 ? "" : l, {
...
var Uu = class extends Ge {
	...
	constructor(e) {
		...
		let v = g(d.getTileCoordForCoordAndResolution(yt(d.getExtent()), l[l.length - 1]), 1, null), y = new Image();
	...
	appendFlatPointCoordinates(e, t) {
		...
		for (let o = 0, s = e.length; o < s; o += t) r[0] = e[o], r[1] = e[o + 1], tt(n, r) && (i[a++] = r[0], i[a++] = r[1]);
		return a;
	}
	appendFlatLineCoordinates(e, t, n, r, i, a) {
		...
		for (p = t + r; p < n; p += r) d[0] = e[p], d[1] = e[p + 1], h = it(c, d), h === m ? h === Ye.INTERSECTING ? (o[s++] = d[0], o[s++] = d[1], f = !1) : f = !0 : (f &&= (o[s++] = l, o[s++] = u, !1), o[s++] = d[0], o[s++] = d[1]), l = d[0], u = d[1], m = h;
	...
	getBufferedMaxExtent() {
		if (!this.bufferedMaxExtent_ && (this.bufferedMaxExtent_ = $e(this.maxExtent), this.maxLineWidth > 0)) {
			let e = this.resolution * (this.maxLineWidth + 1) / 2;
			Qe(this.bufferedMaxExtent_, e, this.bufferedMaxExtent_);
		}
	...
	drawPoint(e, t, n) {
		if (!this.image_ || this.maxExtent && !tt(this.maxExtent, e.getFlatCoordinates())) return;
	...
	drawMultiPoint(e, t, n) {
		...
		for (let t = 0, n = r.length; t < n; t += e.getStride()) (!this.maxExtent || tt(this.maxExtent, r.slice(t, t + 2))) && i.push(r[t], r[t + 1]);
	...
	Text: class extends Xu {
		...
		drawText(e, t, n) {
			...
			if (a.placement === "line" && (c == "LineString" || c == "MultiLineString" || c == "Polygon" || c == "MultiPolygon")) {
				...
				if ((c == "LineString" || c == "MultiLineString") && !nt(this.getBufferedMaxExtent(), r)) {
...
var Ed = class {
	...
	calculateImageOrLabelDimensions_(e, t, n, r, i, a, o, s, c, l, u, d, f, p, m, h) {
		...
		let w;
		return u === 0 ? ot(Math.min(S, S + b), Math.min(C, C + x), Math.max(S, S + b), Math.max(C, C + x), gd) : (w = $r(Kr(), n, r, 1, 1, u, -n, -r), B(w, _d), B(w, vd), B(w, yd), B(w, bd), ot(Math.min(_d[0], vd[0], yd[0], bd[0]), Math.min(_d[1], vd[1], yd[1], bd[1]), Math.max(_d[0], vd[0], yd[0], bd[0]), Math.max(_d[1], vd[1], yd[1], bd[1]), gd)), f && (g = Math.round(g), _ = Math.round(_)), {
			drawImageX: g,
			drawImageY: _,
			drawImageW: v,
			drawImageH: y,
		...
		for (; u < d;) {
			...
			switch (n[0]) {
					...
					for (; f < p; f += 2) {
						...
						if (s) {
							...
							if (be) {
								...
								let a = be[n];
								e = a.args, t = a.declutterMode, delete be[n], i = xd(e);
							}
							let a, o;
				...
				case X.DRAW_CHARS:
					...
					let Pe = [n[13], n[13]];
					y = n[14] || "declutter";
					let Fe = n[15], Ie = n[16], I = this.textStates[E], Le = I.font, Re = [I.scale[0] * je, I.scale[1] * je], ze;
...
var Nd = class {
	...
	forEachFeatureAtCoordinate(e, t, n, r, i, a) {
		...
		let d;
		this.renderBuffer_ !== void 0 && (d = at(), ft(d, e), Qe(d, t * (this.renderBuffer_ + r), d));
		let f = Fd(r), p;
		function m(e, t, n) {
...
var Id = class extends Gu {
	...
	drawCircle(e) {
		if (this.squaredTolerance_ && (e = e.simplifyTransformed(this.squaredTolerance_, this.userTransform_)), Ot(this.extent_, e.getExtent())) {
...
function Rd(e, t, n, r, i, a, o, s, c) {
	...
	for (let e = 1; e <= m; ++e) {
		...
		for (let e = 0, n = o.length; e < n; ++e) {
			...
			if (!r || !Ot(l, r.getExtent())) continue;
...
function zd(e, t, n) {
	let r = [];
	if (n) {
		let i = Math.floor(Math.round(e[0]) * Ld), a = Math.floor(Math.round(e[1]) * Ld), o = (Bt(i, 0, n.width - 1) + Bt(a, 0, n.height - 1) * n.width) * 4, s = n.data[o], c = n.data[o + 1], l = n.data[o + 2] + 256 * (c + 256 * s), u = Math.floor(16777215 / t.length);
...
function Kd(e, t, n, r, i, a, o, s) {
	...
	if (l) {
		...
		t == L.LOADED || t == L.ERROR ? e = !1 : t == L.IDLE && l.load(), e && c.push(l.ready());
	}
	let u = n.getFill();
...
function $d(e, t, n, r, i, a) {
	...
	if (o) {
		if (o.getImageState() != L.LOADED) return;
...
var nf = class extends $i {
	constructor(e) {
		super(e), this.boundHandleStyleImageChange_ = this.handleStyleImageChange_.bind(this), this.animatingOrInteracting_, this.hitDetectionImageData_ = null, this.clipExtent_ = null, this.extendX_ = !1, this.renderedFeatures_ = null, this.renderedRevision_ = -1, this.renderedResolution_ = NaN, this.renderedExtent_ = at(), this.wrappedRenderedExtent_ = at(), this.renderedRotation_, this.renderedCenter_ = null, this.renderedProjection_ = null, this.renderedPixelRatio_ = 1, this.renderedRenderOrder_ = null, this.renderedFrameDeclutter_, this.replayGroup_ = null, this.replayGroupChanged = !0, this.clipping = !0, this.targetContext_ = null, this.opacity_ = 1;
	}
	renderWorlds(e, t, n) {
		let r = t.extent, i = t.viewState, a = i.center, o = i.resolution, s = i.projection, c = i.rotation, l = s.getExtent(), u = this.getLayer().getSource(), d = this.getLayer().getDeclutter(), f = t.pixelRatio, p = t.viewHints, m = !(p[V.ANIMATING] || p[V.INTERACTING]), h = this.context, g = Math.round(R(r) / o * f), _ = Math.round(Ct(r) / o * f), v = u.getWrapX() && s.canWrapX(), y = v ? R(l) : null, b = v ? Math.ceil((r[2] - l[2]) / y) + (this.extendX_ ? 2 : 1) : 1, x = v ? Math.floor((r[0] - l[0]) / y) - +!!this.extendX_ : 0;
		do {
	...
	resetDrawContext_() {
		if (this.opacity_ !== 1 && this.targetContext_) {
			...
			this.targetContext_.globalAlpha = this.opacity_, this.targetContext_.drawImage(this.context.canvas, 0, 0), this.targetContext_.globalAlpha = e, ye(this.context), Xi.push(this.context.canvas), this.context = this.targetContext_, this.targetContext_ = null;
		}
	}
	renderDeclutter(e) {
	...
	renderFrame(e, t) {
		...
		if (o && n.extent && this.clipping) {
			let t = Nr(n.extent, s);
			o = Ot(t, e.extent), o && !nt(t, e.extent) && (e.declutter ? this.clipExtent_ = t : (this.clipUnrotated(i, e, t), c = !0));
		}
	...
	getFeatures(e) {
		return new Promise((t) => {
			if (this.frameState && !this.hitDetectionImageData_ && !this.animatingOrInteracting_) {
				...
				if (u.getWrapX() && i.canWrapX() && !nt(d, a)) {
					let e = a[0], i = R(d), o = 0, u;
	...
	prepareFrame(e) {
		...
		m === void 0 && (m = Hd);
		let g = c.center.slice(), _ = Qe(s, p * u), v = _.slice(), y = [_.slice()], b = l.getExtent(), x = n.getWrapX() && l.canWrapX();
		if (this.extendX_ = !1, x) {
			let e = n.getExtent();
			e && !kt(e) && (this.extendX_ = e[0] < b[0] || e[2] > b[2]);
		}
		if (x && (!nt(b, e.extent) || this.extendX_)) {
			let e = R(b), t = Math.max(R(_) / 2, e), n = b[0], r = b[2];
		...
		if (this.ready && this.renderedResolution_ == u && this.renderedPixelRatio_ === d && this.renderedRevision_ == f && this.renderedRenderOrder_ == m && this.renderedFrameDeclutter_ === !!e.declutter && nt(this.wrappedRenderedExtent_, _)) return h(this.renderedExtent_, v) || (this.hitDetectionImageData_ = null, this.renderedExtent_ = v), this.renderedCenter_ = g, this.replayGroupChanged = !1, !0;
	...
	updateExecutorGroup_(e, t, n) {
		...
		for (let i = 0, m = f.length; i < m; ++i) {
			let m = f[i];
			if (m.getState() != I.LOADED) continue;
			let h = c.getProjection(), g = m.tileCoord, _ = u.getTileCoordExtent(g);
			n && h && !Sr(n, h) && (_ = Dr(_, h, n, 32));
			let v = wt(d, _), y = Qe(v, r.getRenderBuffer() * o, this.tempExtent), b = ut(_, v) ? null : y, x = new cd(0, v, o, t), S = Ud(o, t), C = function(e, t) {
			...
			for (let e = 0, t = w.length; e < t; ++e) {
				let t = w[e];
				n && m.projection && !Sr(n, m.projection) && (t = t.clone(), t.getGeometry().applyTransform(Tr(m.projection, n))), (!b || Ot(b, t.getGeometry().getExtent())) && C.call(this, t, e);
			}
	...
	forEachFeatureAtCoordinate(e, t, n, r, i) {
		...
		n ??= 0;
		let s = this.getLayer(), c = s.getSource().getTileGridForProjection(t.viewState.projection), l = s.getRenderBuffer(), u = Xe([e]);
		Qe(u, a * (l + n), u);
		...
		foundFeature: for (let t = p.length - 1; t >= 0; --t) {
			let r = p[t];
			if (!Ot(c.getTileCoordExtent(r.wrappedTileCoord), u)) continue;
	...
	getFeatures(e) {
		return this.renderedTiles.length === 0 ? Promise.resolve([]) : new Promise((t, n) => {
			let r = this.getLayer(), i = r.getSource(), a = this.renderedProjection, o = a.getExtent(), s = this.renderedResolution, c = i.getTileGridForProjection(a), l = B(this.renderedPixelToCoordinateTransform_, e.slice()), u = c.getTileCoordForCoordAndResolution(l, s).toString(), d = this.renderedTiles.find((e) => e.tileCoord.toString() === u && e.getState() === I.LOADED);
			if (!d || d.loadingSourceTiles > 0) {
				t([]);
				return;
			}
			i.getWrapX() && a.canWrapX() && !nt(o, c.getTileCoordExtent(d.tileCoord)) && rn(l, a);
			let f = O(r), p = Et(c.getTileCoordExtent(d.wrappedTileCoord)), m = [(l[0] - p[0]) / s, (p[1] - l[1]) / s], h = d.getSourceTiles().reduce((e, t) => e.concat(t.getFeatures()), []), g = d.hitDetectionImageData[f];
			if (!g) {
	...
	getFeaturesInExtent(e) {
		...
		return n.forEach((n) => {
			if (n.tileCoord[0] !== i || n.getState() !== I.LOADED) return;
			...
			for (let n = 0, i = o.length; n < i; ++n) {
				...
				a[s] = !0;
				let c = i.tileCoord;
				if (Ot(e, r.getTileCoordExtent(c))) {
					let n = i.getFeatures();
					if (n) for (let r = 0, i = n.length; r < i; ++r) {
						let i = n[r];
						Ot(e, i.getGeometry().getExtent()) && t.push(i);
					}
				}
			}
		}), t;
	...
	clipTileContext_(e, t, n, r, i, a) {
		let o = [];
		for (let e = 0, a = n.length; e < a; ++e) i < r[e] && Ot(t, n[e]) && o.push(n[e]);
	...
	prepareFrame(e) {
		...
		if (t.extent !== void 0 && (s = wt(s, Nr(t.extent, r.projection))), !o[V.ANIMATING] && !o[V.INTERACTING] && !kt(s)) {
			if (a) {
				...
				t && (this.loadImage(t) ? this.image = t : t.getState() === L.EMPTY && (this.image = null));
	...
	getData(e) {
		...
		let n = this.getLayer(), r = B(t.pixelToCoordinateTransform, e.slice()), i = n.getExtent();
		if (i && !tt(i, r)) return null;
		let a = this.image.getExtent(), o = this.image.getImage(), s = R(a), c = Math.floor(o.width * ((r[0] - a[0]) / s));
	...
	renderFrame(e, t) {
		...
		if (c.extent) {
			...
			y = Ot(t, e.extent), v = y && !nt(t, e.extent), v && this.clipUnrotated(_, e, t);
		}
...
function Ap(e, t, n, r) {
	...
	for (let o = 0, s = n.length; o < s; ++o) {
		let s = n[o];
		a = lt(e, t, s[0], r), i.push((a[0] + a[2]) / 2, (a[1] + a[3]) / 2), t = s[s.length - 1];
	}
	return i;
}
//#endregion
...
var jp = Kr(), Mp = class e {
	...
	getExtent() {
		return this.extent_ ||= this.type_ === "Point" ? ct(this.flatCoordinates_) : lt(this.flatCoordinates_, 0, this.flatCoordinates_.length, this.stride_), this.extent_;
	}
	getFlatInteriorPoint() {
...
function Am(e, t) {
	let n = e.viewState.projection, r = t.getSource().getWrapX() && n.canWrapX(), i = n.getExtent(), a = e.extent, o = r ? R(i) : null, s = r ? Math.ceil((a[2] - i[2]) / o) + 1 : 1;
	return [
...
var jm = {
	...
	prepareFrameInternal(e) {
		...
		let t = this.getLayer(), n = t.getSource(), r = e.viewState, i = !e.viewHints[V.ANIMATING] && !e.viewHints[V.INTERACTING], a = !ut(this.previousExtent_, e.extent), o = this.sourceRevision_ < n.getRevision(), s = this.layerRevision_ < t.getRevision();
		if (this.sourceRevision_ = n.getRevision(), this.layerRevision_ = t.getRevision(), (s || a || o) && (this.skipNextTextRender_ = !1), i && (a || o)) {
			let i = r.projection, a = r.resolution, o = t instanceof cu ? t.getRenderBuffer() : 0, s = Qe(e.extent, o * a), c = kr();
...
var Vm = class extends Oe {
	...
	testLayerVisibility(e) {
		...
		var r = e.getExtent();
		return !r || Ot(this.getMap().getView().calculateExtent(this.getMap().getSize()), r);
	}
	dragOrdering_(e) {
...
var ih = ["fullscreenchange", "webkitfullscreenchange"], ah = {
	...
	handleFullScreen_() {
		...
		if (sh(t)) {
			if (ch(t)) dh(t);
				...
				let n;
				n = this.source_ ? typeof this.source_ == "string" ? t.getElementById(this.source_) : this.source_ : e.getTargetElement(), this.keys_ ? uh(n) : lh(n);
			}
		}
	}
	handleFullScreenChange_() {
		...
		this.isInFullscreen_ = ch(e.getOwnerDocument()), t !== this.isInFullscreen_ && (this.setClassName_(this.button_, this.isInFullscreen_), this.isInFullscreen_ ? (Se(this.labelActiveNode_, this.labelNode_), this.dispatchEvent(ah.ENTERFULLSCREEN)) : (Se(this.labelNode_, this.labelActiveNode_), this.dispatchEvent(ah.LEAVEFULLSCREEN)), e.updateSize());
	}
	setClassName_(e, t) {
	...
	handleMapTargetChange_() {
		...
		if (t) {
			...
			sh(n) ? this.element.classList.remove(te) : this.element.classList.add(te);
			for (let t = 0, r = ih.length; t < r; ++t) e.push(i(n, ih[t], this.handleFullScreenChange_, this));
...
function uh(e) {
	e.webkitRequestFullscreen ? e.webkitRequestFullscreen() : lh(e);
}
function dh(e) {
...
var fh = "projection", ph = "coordinateFormat", mh = class extends Oe {
	constructor(e) {
		e ||= {};
...
function hh({ map: e, viewerApp: t, getSlideSource: n, zoomVisibleInput: r, zoomLevelVisibleInput: i, rotationVisibleInput: a, resetViewButton: o, resetViewControl: s, resetViewVisibleInput: c, fullscreenVisibleInput: l, mousePositionVisibleInput: u, mouseWheelZoomSensitivitySelect: d, zoomButtonStepSelect: f }) {
	let p = {
		low: {
			deltaPerZoom: 600,
			maxDelta: 1
	...
	e.addInteraction(h);
	function g() {
		return new Fe({ delta: Number(f.value) });
	}
	let _ = g();
	e.addControl(_);
...
function kh({ map: e, projection: t, themeSelect: n, gridThemeSelect: r, gridOpacityInput: i, gridOpacityValue: a, gridSpacingSelect: o, gridLabelsVisibleInput: s, graticuleVisibleInput: c, screenSpaceGraticuleVisibleInput: l, onGraticulesChange: u }) {
	function d() {
		return Eh[o.value] ?? Eh.default;
	}
	function f() {
	...
	function h() {
		let t = Oh[f()] ?? Oh.dark, n = Number(i.value) / 100, r = m.getStroke(), o = p;
		r.setColor(Th(t.line, n)), o.getFill().setColor(t.label), o.getStroke().setColor(t.outline), a.textContent = `${i.value}%`, e.renderSync();
	}
	function g() {
...
var Ah = "units", jh = [
	...
	2,
	5
], Mh = 25.4 / .28, Nh = class extends Oe {
	constructor(e) {
		e ||= {};
		let t = document.createElement("div");
		...
		this.innerElement_ = document.createElement("div"), this.innerElement_.className = n + "-inner", this.element.className = n + " " + F, this.element.appendChild(this.innerElement_), this.viewState_ = null, this.minWidth_ = e.minWidth === void 0 ? 64 : e.minWidth, this.maxWidth_ = e.maxWidth, this.renderedVisible_ = !1, this.renderedWidth_ = void 0, this.renderedHTML_ = "", this.addChangeListener(Ah, this.handleUnitsChanged_), this.setUnits(e.units || "metric"), this.scaleBar_ = e.bar || !1, this.scaleBarSteps_ = e.steps || 4, this.scaleBarText_ = e.text || !1, this.dpi_ = e.dpi || void 0;
	}
	getUnits() {
		return this.get(Ah);
	}
	...
	updateElement_() {
		...
		let t = e.center, n = e.projection, r = this.getUnits(), i = r == "degrees" ? "degrees" : "m", a = _r(n, e.resolution, t, i), o = this.minWidth_ * (this.dpi_ || Mh) / Mh, s = this.maxWidth_ === void 0 ? void 0 : this.maxWidth_ * (this.dpi_ || Mh) / Mh, c = o * a, l = "";
		if (r == "degrees") {
			let e = sn.degrees;
		...
		for (;;) {
			p = Math.floor(u / 3);
			let e = 10 ** p;
			if (d = jh[(u % 3 + 3) % 3] * e, f = Math.round(d / a), isNaN(f)) {
	...
	getScaleForResolution() {
		let e = _r(this.viewState_.projection, this.viewState_.resolution, this.viewState_.center, "m"), t = this.dpi_ || Mh;
		return 1e3 / 25.4 * e * t;
	}
	render(e) {
		let t = e.frameState;
...
function Fh({ map: e, hasSlide: t, enabledInput: n, colourInput: r, opacityInput: i, opacityValue: a, sizeSelect: o, unitsSelect: s, onControlChange: c }) {
	function l() {
		let e = Ph[o.value] ?? Ph.default;
		return new Nh({
			units: s.value,
			minWidth: e
		});
	...
	function p() {
		let e = Number(i.value) / 100, t = xh(r.value);
		if (t === null) return;
		let n = Ch(t) === "#ffffff" ? {
			r: 255,
			g: 255,
		...
		u.element.style.backgroundColor = Th(n, e), a.textContent = `${i.value}%`;
	}
	function m() {
...
var Ih = {
	...
	constructor(e) {
		super(), this.on, this.once, this.un, this.options = e, this.id = e.id, this.insertFirst = e.insertFirst === void 0 || e.insertFirst, this.stopEvent = e.stopEvent === void 0 || e.stopEvent, this.element = document.createElement("div"), this.element.className = e.className === void 0 ? "ol-overlay-container " + P : e.className, this.element.style.position = "absolute", this.element.style.pointerEvents = "auto", this.autoPan = e.autoPan === !0 ? {} : e.autoPan || void 0, this.rendered = {
			transform_: "",
			visible: !0
		}, this.mapPostrenderListenerKey = null, this.addChangeListener(Ih.ELEMENT, this.handleElementChanged), this.addChangeListener(Ih.MAP, this.handleMapChanged), this.addChangeListener(Ih.OFFSET, this.handleOffsetChanged), this.addChangeListener(Ih.POSITION, this.handlePositionChanged), this.addChangeListener(Ih.POSITIONING, this.handlePositioningChanged), e.element !== void 0 && this.setElement(e.element), this.setOffset(e.offset === void 0 ? [0, 0] : e.offset), this.setPositioning(e.positioning || "top-left"), e.position !== void 0 && this.setPosition(e.position);
	}
	getElement() {
		return this.get(Ih.ELEMENT);
	}
	getId() {
		return this.id;
	}
	getMap() {
		return this.get(Ih.MAP) || null;
	}
	getOffset() {
		return this.get(Ih.OFFSET);
	}
	getPosition() {
		return this.get(Ih.POSITION);
	}
	getPositioning() {
		return this.get(Ih.POSITIONING);
	}
	...
	handleMapChanged() {
		...
		let e = this.getMap();
		if (e) {
			this.mapPostrenderListenerKey = i(e, De.POSTRENDER, this.render, this), this.updatePixelPosition();
	...
	setElement(e) {
		this.set(Ih.ELEMENT, e);
	}
	setMap(e) {
		this.set(Ih.MAP, e);
	}
	setOffset(e) {
		this.set(Ih.OFFSET, e);
	}
	setPosition(e) {
		this.set(Ih.POSITION, e);
	}
	performAutoPan() {
	...
	panIntoView(e) {
		let t = this.getMap();
		if (!t || !t.getTargetElement() || !this.get(Ih.POSITION)) return;
		let n = this.getRect(t.getTargetElement(), t.getSize()), r = this.getElement(), i = this.getRect(r, [be(r), xe(r)]);
		e ||= {};
...
}, Rh = .75, zh = .1, Bh = class extends Oe {
	constructor(e) {
		e ||= {}, super({
			element: document.createElement("div"),
			render: e.render,
		...
		l.className = "ol-overviewmap-box", l.style.boxSizing = "border-box", this.boxOverlay_ = new Lh({
			position: [0, 0],
	...
	validateExtent_() {
		...
		if (this.viewExtent_ && ut(r, this.viewExtent_)) return;
		this.viewExtent_ = r;
		let i = t.getSize(), a = t.getView().calculateExtentInternal(i), o = t.getPixelFromCoordinateInternal(Et(r)), s = t.getPixelFromCoordinateInternal(vt(r)), c = Math.abs(o[0] - s[0]), l = Math.abs(o[1] - s[1]), u = i[0], d = i[1];
		c < u * zh || l < d * zh || c > u * Rh || l > d * Rh ? this.resetExtent_() : nt(a, r) || this.recenter_();
	}
	resetExtent_() {
		let e = this.getMap(), t = this.ovmap_, n = e.getSize(), r = e.getView().calculateExtentInternal(n), i = t.getView();
		jt(r, 1 / (2 ** (Math.log(Rh / zh) / Math.LN2 / 2) * zh)), i.fitInternal($a(r));
	}
	recenter_() {
	...
	updateBoxAfterOvmapIsRendered_() {
		this.ovmapPostrenderKey_ ||= a(this.ovmap_, De.POSTRENDER, (e) => {
...
function Hh({ map: e, source: t, projection: n, extent: r, sizeSelect: i, visibleInput: a, hasSlide: o }) {
	let s = new Co();
	t !== null && s.setSource(t);
	function c() {
		return Vh[i.value] ?? Vh.default;
	}
	function l(e, t) {
...
function Wh(e) {
	...
	o.className = "viewer-file-select-options", o.id = `viewer-file-select-${Uh}`, o.setAttribute("role", "listbox"), Uh += 1, n.setAttribute("aria-controls", o.id), a.setAttribute("aria-controls", o.id), i.append(a, o), t.append(n, i);
	let s = [], c = "", l = e, u = [], d = -1;
	function f(e) {
...
function Kh({ panel: e, toggle: t, container: n, configuredSlides: r, configuredOverlays: i, getCurrentSlidePath: a, hasSlide: o, hasOverlays: s, onSlideSelected: c, onOverlaySelected: l, onClearSlide: u, onClearOverlays: d, onOpen: f }) {
	let p = document.createElement("div");
	p.className = "viewer-file-selectors";
	let m = Wh("Select slide"), h = Wh("Load overlay");
	p.append(m, h);
...
function qh({ panel: e, toggle: t, list: n, getSlideLayer: r, getCurrentSlidePath: i, getOverlayLayers: a, onRemoveLayer: o, onOpen: s }) {
	function c(n) {
...
function Yh({ panel: e, toggle: t, list: n, showAllButton: r, hideAllButton: i, exportButton: a, colourBySelect: o, propertyField: s, propertySelect: c, propertyLegend: l, propertyLegendCaption: u, propertyMin: d, propertyMax: f, getAnnotationGroups: p, getAnnotationColour: m, getDisplayMode: h, getAnnotationProperties: g, getAnnotationProperty: _, getPropertyRange: v, isAnnotationTypeVisible: y, getAnnotationOpacity: b, onColourChange: x, onVisibilityChange: S, onOpacityChange: C, onDisplayModeChange: w, onPropertyChange: T, onSetAllVisibility: E, onExport: D, onOpen: O }) {
	function k(n) {
		n && (O(), M()), e.classList.toggle("hidden", !n), t.classList.toggle("active", n);
	}
	function A(e) {
		e().then(() => {
			M();
	...
	function M() {
		n.replaceChildren();
		let e = p(), t = h(), w = g(), T = e.length > 0;
		o.value = t, o.disabled = !T, o.closest(".annotations-panel-display-field")?.classList.toggle("disabled", !T);
		let E = o.querySelector("option[value=\"property\"]");
		E.disabled = !T || w.length === 0, s.hidden = t !== "property", j(w);
		let D = _();
		D !== null && w.includes(D) && (c.value = D);
		let O = v(), k = t === "property" && O !== null;
		if (l.hidden = !k, k) {
			let [e, t] = O;
			u.textContent = `${D} values · low → high`, d.textContent = Number(e.toPrecision(4)).toString(), f.textContent = Number(t.toPrecision(4)).toString();
		}
		if (c.disabled = w.length === 0, r.disabled = !T, i.disabled = !T, a.disabled = !T || t === "property", e.length === 0) {
			let e = document.createElement("div");
		...
		for (let { layerName: r, annotationTypes: i } of e) {
			...
			for (let n of i) {
				let r = String(n), i = document.createElement("div");
				i.className = "annotations-panel-item";
				let a = document.createElement("div");
				a.className = "annotations-panel-item-header";
				let o = document.createElement("input");
				o.type = "checkbox", o.className = "annotations-panel-visibility", o.checked = y(n), o.title = `Toggle ${r}`, o.addEventListener("change", () => {
					A(() => S(n, o.checked));
				});
				let s = document.createElement("input");
				s.type = "color", s.className = "annotations-panel-colour", s.value = Jh(m(n)), s.title = `Change ${r} colour`, s.disabled = t === "property", s.addEventListener("change", () => {
					A(() => x(n, s.value));
				});
				let c = document.createElement("span");
				c.className = "annotations-panel-name", c.textContent = r, c.title = r, a.append(o, s, c);
				let l = document.createElement("div");
				l.className = "annotations-panel-opacity";
				let u = document.createElement("span");
				u.className = "annotations-panel-opacity-label", u.textContent = "Fill opacity";
				let d = document.createElement("input");
				d.type = "range", d.className = "annotations-panel-slider", d.min = "0", d.max = "1", d.step = "0.05", d.value = b(n).toString(), d.disabled = t === "property";
				let f = document.createElement("span");
				f.className = "annotations-panel-value", f.textContent = `${Math.round(Number(d.value) * 100)}%`, d.addEventListener("input", () => {
					f.textContent = `${Math.round(Number(d.value) * 100)}%`;
				}), d.addEventListener("change", () => {
					A(() => C(n, Number(d.value)));
				}), l.append(u, d, f), i.append(a, l), e.appendChild(i);
			}
			n.appendChild(e);
		}
	}
...
function Qh({ viewerApp: e, panel: t, toggle: n, closeButton: r, tabs: i, tabPanels: a, resetDefaultsButton: o, themeSelect: s, controlOpacityInput: c, controlOpacityValue: l, annotationInspectionEnabledInput: u, zoomVisibleInput: d, zoomLevelVisibleInput: f, rotationVisibleInput: p, graticuleVisibleInput: m, screenSpaceGraticuleVisibleInput: h, resetViewVisibleInput: g, fullscreenVisibleInput: _, mousePositionVisibleInput: v, overviewMapVisibleInput: y, overviewMapSizeSelect: b, mouseWheelZoomSensitivitySelect: x, zoomButtonStepSelect: S, gridThemeSelect: C, gridOpacityInput: w, gridSpacingSelect: T, gridLabelsVisibleInput: E, scaleBarEnabledInput: D, scaleBarColourInput: O, scaleBarOpacityInput: k, scaleBarSizeSelect: A, scaleBarUnitsSelect: j, onAnnotationInspectionChange: M, onThemeChange: N, onControlVisibilityChange: ee, onReset: P }) {
	...
	function ne() {
		...
		let n = Number(c.value) / 100, r = Ch(t), i = r === "#ffffff" ? {
			...
			g: 255,
			b: 255
		}, o = r === "#ffffff" ? 255 : 0, u = wh(t, o, .08), d = wh(t, o, .16), f = wh(t, o, .28), p = wh(t, o, .4), m = wh(t, o, .58);
		e.style.setProperty("--viewer-control-background", Th(t, n)), e.style.setProperty("--viewer-control-surface-background", Th(u, n)), e.style.setProperty("--viewer-control-hover-background", Th(d, n)), e.style.setProperty("--viewer-control-pressed-background", Th(f, n)), e.style.setProperty("--viewer-control-foreground", r), e.style.setProperty("--viewer-control-hover-foreground", Ch(d)), e.style.setProperty("--viewer-control-pressed-foreground", Ch(f)), e.style.setProperty("--viewer-control-muted-foreground", Th(i, .7)), e.style.setProperty("--viewer-control-subtle-foreground", Th(i, .55)), e.style.setProperty("--viewer-control-border", Th(p, Math.max(n, .7))), e.style.setProperty("--viewer-control-focus-border", Th(m, Math.max(n, .9))), e.style.setProperty("--viewer-control-foreground-shadow", Th(a, .75)), l.textContent = `${c.value}%`;
	}
	function re() {
		let e = {
			theme: s.value,
		...
		try {
			window.localStorage.setItem(Zh, JSON.stringify(e));
		} catch {}
	}
	function ie() {
		let e;
		try {
			let t = window.localStorage.getItem(Zh);
			if (t === null) return;
			e = JSON.parse(t);
		} catch {
			return;
	...
	function oe() {
		try {
			window.localStorage.removeItem(Zh);
		} catch {}
	}
	function se() {
		if (!F) {
...
var ng = document.getElementById("map"), rg = document.querySelector(".viewer-app"), ig = document.getElementById("viewer-panel"), ag = document.getElementById("viewer-panel-toggle"), og = document.getElementById("viewer-files"), sg = document.getElementById("layer-editor"), cg = document.getElementById("layer-editor-toggle"), lg = document.getElementById("layer-editor-list"), ug = document.getElementById("annotations-panel"), dg = document.getElementById("annotations-toggle"), fg = document.getElementById("annotations-panel-list"), pg = document.getElementById("annotations-colour-by"), mg = document.getElementById("annotations-property-field"), hg = document.getElementById("annotations-property"), gg = document.getElementById("annotations-property-legend"), _g = document.getElementById("annotations-property-legend-caption"), vg = document.getElementById("annotations-property-min"), yg = document.getElementById("annotations-property-max"), bg = document.getElementById("annotation-inspector"), xg = document.getElementById("annotation-inspector-header"), Sg = document.getElementById("annotation-inspector-title"), Cg = document.getElementById("annotation-inspector-properties"), wg = document.getElementById("annotation-inspector-close"), Tg = document.getElementById("annotations-show-all"), Eg = document.getElementById("annotations-hide-all"), Dg = document.getElementById("annotations-export-colours"), Og = document.getElementById("settings-panel"), kg = document.getElementById("settings-toggle"), Ag = document.getElementById("settings-close"), jg = document.querySelectorAll(".settings-tab"), Mg = document.querySelectorAll(".settings-tab-panel"), Ng = document.getElementById("settings-annotation-inspection"), Pg = document.getElementById("settings-zoom-visible"), Fg = document.getElementById("settings-zoom-level-visible"), Ig = document.getElementById("settings-rotation-visible"), Lg = document.getElementById("settings-graticule-visible"), Rg = document.getElementById("settings-screen-space-graticule-visible"), zg = document.getElementById("reset-view-button"), Bg = document.querySelector(".reset-view-control"), Vg = document.getElementById("settings-reset-view-visible"), Hg = document.getElementById("settings-fullscreen-visible"), Ug = document.getElementById("settings-mouse-position-visible"), Wg = document.getElementById("settings-overview-map-visible"), Gg = document.getElementById("settings-overview-map-size"), Kg = document.getElementById("settings-mouse-wheel-zoom-sensitivity"), qg = document.getElementById("settings-zoom-button-step"), Jg = document.getElementById("settings-scale-bar-enabled"), Yg = document.getElementById("settings-theme"), Xg = document.getElementById("settings-grid-theme"), Zg = document.getElementById("settings-grid-opacity"), Qg = document.getElementById("settings-grid-opacity-value"), $g = document.getElementById("settings-grid-spacing"), e_ = document.getElementById("settings-grid-labels-visible"), t_ = document.getElementById("settings-control-opacity"), n_ = document.getElementById("settings-control-opacity-value"), r_ = document.getElementById("settings-reset-defaults"), i_ = document.getElementById("settings-scale-bar-colour"), a_ = document.getElementById("settings-scale-bar-opacity"), o_ = document.getElementById("settings-scale-bar-opacity-value"), s_ = document.getElementById("settings-scale-bar-size"), c_ = document.getElementById("settings-scale-bar-units");
if (ng === null || rg === null) throw Error("The OpenLayers viewer could not be found.");
if (ig === null || ag === null || sg === null || cg === null || lg === null || ug === null || dg === null || fg === null || Tg === null || Eg === null || Dg === null || pg === null || mg === null || hg === null || gg === null || _g === null || vg === null || yg === null || bg === null || xg === null || Sg === null || Cg === null || wg === null || Og === null || kg === null || Ag === null || Ng === null || Pg === null || Fg === null || Ig === null || Lg === null || Rg === null || zg === null || Bg === null || Vg === null || Hg === null || Ug === null || Wg === null || Gg === null || Kg === null || qg === null || Yg === null || Xg === null || Zg === null || Qg === null || $g === null || e_ === null || t_ === null || n_ === null || r_ === null || Jg === null || i_ === null || a_ === null || o_ === null || s_ === null || c_ === null || og === null) throw Error("The OpenLayers viewer controls could not be found.");
var l_ = {
	dark: "#ffffff",
	light: "#000000",
	...
	tabs: jg,
	tabPanels: Mg,
	resetDefaultsButton: r_,
	themeSelect: Yg,
	controlOpacityInput: t_,
	controlOpacityValue: n_,
	annotationInspectionEnabledInput: Ng,
	zoomVisibleInput: Pg,
	zoomLevelVisibleInput: Fg,
	rotationVisibleInput: Ig,
	graticuleVisibleInput: Lg,
	screenSpaceGraticuleVisibleInput: Rg,
	resetViewVisibleInput: Vg,
	fullscreenVisibleInput: Hg,
	mousePositionVisibleInput: Ug,
	overviewMapVisibleInput: Wg,
	overviewMapSizeSelect: Gg,
	mouseWheelZoomSensitivitySelect: Kg,
	zoomButtonStepSelect: qg,
	gridThemeSelect: Xg,
	gridOpacityInput: Zg,
	gridSpacingSelect: $g,
	gridLabelsVisibleInput: e_,
	scaleBarEnabledInput: Jg,
	scaleBarColourInput: i_,
	scaleBarOpacityInput: a_,
	scaleBarSizeSelect: s_,
	scaleBarUnitsSelect: c_,
	onAnnotationInspectionChange() {
		Ng.checked || (bg.hidden = !0);
	},
	onThemeChange() {
		i_.value = l_[Yg.value] ?? l_.dark, mv.updateColour(), mv.updateOpacity(), bv.updateAppearance();
	},
...
u_.load(), u_.updateAppearance();
var d_ = qh({
	panel: sg,
	toggle: cg,
	list: lg,
	getSlideLayer: () => ev,
	getCurrentSlidePath: () => __,
	getOverlayLayers: () => v_,
	onRemoveLayer: (e) => Rv(e),
	onOpen() {
		X_.setOpen(!1), Z_.setOpen(!1);
	}
}), f_ = JSON.parse(ng.dataset.layers ?? "[]"), p_ = null, m_ = Date.now(), h_ = Date.now(), g_ = null, __ = null, v_ = {}, y_ = /* @__PURE__ */ new Set(), b_ = /* @__PURE__ */ new Map(), x_ = /* @__PURE__ */ new Map(), S_ = /* @__PURE__ */ new Map(), C_ = /* @__PURE__ */ new Map(), w_ = "type", T_ = null, E_ = [], D_ = /* @__PURE__ */ new Map();
function O_() {
	let e = /* @__PURE__ */ new Set();
	for (let t of x_.values()) for (let n of t) e.add(n);
	return [...e];
}
function k_() {
	return [...x_.entries()].map(([e, t]) => ({
		layerName: e,
		annotationTypes: t
	}));
}
async function A_() {
	...
	for (let t of n) {
		...
		n.length > 0 && n.every((e) => typeof e == "number" && Number.isFinite(e)) && (D_.set(t, [Math.min(...n), Math.max(...n)]), r.push(t));
	}
	return r.sort();
}
function j_(e) {
...
async function M_({ refresh: e = !0 } = {}) {
	await th("type"), await rh(null), await Xm(b_), w_ = "type", T_ = null, e && B_();
}
async function N_() {
	await th("type"), await rh(null);
}
async function P_(e, { refresh: t = !0 } = {}) {
	let n = j_(e);
	await th(e), await nh("viridis"), await rh(n), w_ = "property", T_ = e, t && B_();
}
async function F_({ refresh: e = !0 } = {}) {
	if (y_.size === 0) {
		await N_(), E_ = [], D_.clear(), w_ = "type", T_ = null, Z_.render();
		return;
	}
	E_ = [], D_.clear(), Z_.render(), E_ = await A_(), w_ === "property" && (T_ === null || !E_.includes(T_) ? await M_({ refresh: e }) : await P_(T_, { refresh: e })), Z_.render();
}
function I_() {
	let e = eg(b_, O_()), t = `${JSON.stringify(e, null, 4)}\n`, n = new Blob([t], { type: "application/json" }), r = URL.createObjectURL(n), i = document.createElement("a");
	i.href = r, i.download = "annotation_config.json", document.body.appendChild(i), i.click(), i.remove(), URL.revokeObjectURL(r);
}
function L_(e) {
	for (let t of e) if (S_.has(t) || S_.set(t, !0), !C_.has(t)) {
		C_.set(t, 1);
		let e = b_.get(t);
		e !== void 0 && b_.set(t, [
			e[0],
...
function R_() {
	let e = new Set(O_()), t = /* @__PURE__ */ new Set([...S_.keys(), ...C_.keys()]);
	for (let n of t) {
		if (e.has(n)) continue;
		S_.delete(n), C_.delete(n);
		let t = b_.get(n);
		t !== void 0 && b_.set(n, [
			t[0],
			t[1],
...
function z_() {
	let e = O_(), t = e.filter((e) => S_.get(e) ?? !0);
...
function B_(e = null) {
	...
	for (let t of y_) {
		...
		let r = new Wu({
			url: `/tileserver/layer/${encodeURIComponent(t)}/${p_}/zoomify/{TileGroup}/{z}-{x}-{y}@1x.jpg?v=${h_}`,
			size: g_.slide_dimensions,
			crossOrigin: "anonymous",
			zDirection: -1
		});
		n.setSource(r);
...
async function V_({ refresh: e = !0 } = {}) {
	y_.size !== 0 && (await Ym(z_()), e && B_());
}
async function H_(e) {
	let [t, n] = e, r = [...y_].filter((e) => v_[e]?.getVisible() !== !1).sort((e, t) => (v_[t]?.getZIndex() ?? 0) - (v_[e]?.getZIndex() ?? 0));
	for (let e of r) {
		let r = await eh(e, t, -n);
		if (Object.keys(r).length !== 0 && (r.type === void 0 || S_.get(r.type) !== !1)) return {
			layerName: e,
			properties: r
		};
	}
...
function G_(e, t) {
	let n = Math.max(8, rg.clientWidth - bg.offsetWidth - 8), r = Math.max(8, rg.clientHeight - bg.offsetHeight - 8);
	bg.style.left = `${Math.min(Math.max(e, 8), n)}px`, bg.style.top = `${Math.min(Math.max(t, 8), r)}px`;
}
function K_(e, t) {
	Sg.textContent = e.layerName, Cg.replaceChildren();
	for (let [t, n] of Object.entries(e.properties)) {
		let e = document.createElement("div");
		e.className = "annotation-inspector-property";
		let r = document.createElement("div");
		r.className = "annotation-inspector-property-name", r.textContent = U_(t);
		let i = document.createElement("div");
		i.className = "annotation-inspector-property-value", i.textContent = W_(t, n), e.append(r, i), Cg.append(e);
	}
	bg.hidden = !1;
	let n = ng.getBoundingClientRect(), r = rg.getBoundingClientRect();
	G_(n.left - r.left + t[0] + 12, n.top - r.top + t[1] + 12);
}
var q_ = await Wm("slide"), J_ = await Wm("overlay"), Y_ = J_.config?.color_dict ?? {}, X_ = Kh({
	panel: ig,
	toggle: ag,
	container: og,
	configuredSlides: q_,
	configuredOverlays: J_,
	getCurrentSlidePath: () => __,
	hasSlide: () => g_ !== null,
	hasOverlays: () => Object.keys(v_).length > 0,
	onSlideSelected: (e) => Iv(e),
	onOverlaySelected: (e) => Lv(e),
	onClearSlide: () => Fv(),
	onClearOverlays: () => Mv(),
	onOpen() {
		d_.setOpen(!1), Z_.setOpen(!1);
	}
}), Z_ = Yh({
	panel: ug,
	toggle: dg,
	...
	propertySelect: hg,
	propertyLegend: gg,
	propertyLegendCaption: _g,
	propertyMin: vg,
	propertyMax: yg,
	showAllButton: Tg,
	hideAllButton: Eg,
	exportButton: Dg,
	getAnnotationGroups: k_,
	getDisplayMode: () => w_,
	getAnnotationProperties: () => E_,
	getAnnotationProperty: () => T_,
	getPropertyRange: () => T_ === null ? null : D_.get(T_) ?? null,
	getAnnotationColour: (e) => b_.get(e) ?? [
		0,
		0,
		0,
		1
	],
	isAnnotationTypeVisible: (e) => S_.get(e) ?? !0,
	getAnnotationOpacity: (e) => C_.get(e) ?? 1,
	...
	async onColourChange(e, t) {
		let n = xh(t), r = C_.get(e) ?? 1, i = new Map(b_);
		i.set(e, [
			n.r / 255,
			n.g / 255,
			n.b / 255,
	...
	async onOpacityChange(e, t) {
		...
		r.set(e, [
			...
			n[2],
			t
		]), await zv(r), C_.set(e, t);
	},
	async onSetAllVisibility(e) {
		let t = O_(), n = new Map(t.map((e) => [e, S_.get(e) ?? !0]));
		for (let n of t) S_.set(n, e);
		try {
			await V_();
		} catch (e) {
			for (let [e, t] of n) S_.set(e, t);
			throw e;
		}
	},
	onExport() {
	...
	onOpen() {
		X_.setOpen(!1), d_.setOpen(!1);
	}
});
X_.setOpen(!0);
var Q_ = new URLSearchParams(window.location.search).get("slide") ?? (f_.length === 0 ? q_.files[0]?.path ?? null : null);
if (Q_ !== null) {
	__ = Q_, p_ = await Hm();
	let e = await Um(Q_);
	g_ = e, X_.setSlide(Q_), X_.updateOverlaySelect(), f_ = [{
		name: "slide",
		url: `/tileserver/layer/slide/${p_}/zoomify/{TileGroup}/{z}-{x}-{y}@1x.jpg?v=${m_}`,
		size: e.slide_dimensions,
		mpp: e.mpp[0]
	}];
} else f_.length === 0 && (p_ = await Hm());
X_.updateActionState();
var $_ = f_.map((e) => {
	let t = new Wu({
		url: e.url,
		size: e.size,
...
ev === void 0 && (ev = new Co({ title: "slide" }), $_.push(ev)), ev.setZIndex(0);
var tv = ev.getSource(), nv, rv, iv;
if (tv !== null) {
	let e = tv.getTileGrid();
	nv = e.getResolutions(), rv = e.getExtent(), iv = new cn({
		code: "ZoomifyProjection",
		units: "pixels",
		extent: rv,
		metersPerUnit: f_[0].mpp * 1e-6,
...
var av = .1;
function ov(e) {
	let t = e[2] - e[0], n = e[3] - e[1], r = t * av, i = n * av;
	return [
		e[0] - r,
		e[1] - i,
		e[2] + r,
...
var sv = new uo({
	...
	mouseWheelZoomSensitivitySelect: Kg,
	zoomButtonStepSelect: qg
}), { fullscreen: uv, mousePositionControl: dv, rotate: fv } = lv, pv = null, mv = Fh({
	map: cv,
	hasSlide: () => ev.getSource() !== null,
	enabledInput: Jg,
	colourInput: i_,
	opacityInput: a_,
	opacityValue: o_,
	...
	unitsSelect: c_,
	onControlChange(e) {
		pv = e, window.scaleLineControl = e;
	}
}), hv = Hh({
	map: cv,
	source: tv,
	...
	visibleInput: Wg,
	hasSlide: () => ev.getSource() !== null
}), gv = hv.control, _v = new Vm();
cv.addControl(_v);
var vv = null, yv = null, bv = kh({
	map: cv,
	projection: iv,
	themeSelect: Yg,
	gridThemeSelect: Xg,
	...
	onGraticulesChange(e, t) {
		vv = e, yv = t, window.graticule = vv, window.screenSpaceGraticule = yv;
	}
}), { graticuleToggle: xv, screenSpaceGraticuleToggle: Sv } = bv, Cv = document.createElement("div");
Cv.className = "viewer-tools-group ol-unselectable", cv.getOverlayContainerStopEvent().append(Cv), Cv.append(fv.element, xv.element, Sv.element);
function wv() {
	lv.updateVisibility(), bv.updateVisibility(), hv.updateVisibility();
}
function Tv() {
	u_.resetValues(), u_.updateAppearance(), bv.updateAppearance(), bv.updateSpacing(), bv.updateLabels(), wv(), hv.updateSize(), lv.updateMouseWheelZoomSensitivity(), lv.updateZoomButtonStep(), mv.updateSize(), mv.updateUnits(), mv.updateVisibility(), mv.updateColour(), mv.updateOpacity(), u_.clearSavedSettings();
}
u_.bindEvents();
function Ev(e) {
	lv.setViewerEnabled(e), bv.setViewerEnabled(e), mv.setViewerEnabled(e), hv.setViewerEnabled(e);
}
if (Ev(tv !== null), wv(), tv !== null) {
	cv.getView().fit(rv);
	let e = Nv();
	e !== null && (cv.getView().setCenter(e.center), cv.getView().setZoom(e.zoom));
}
cv.on("moveend", () => {
	Pv(), lv.updateZoomLevel();
}), cv.on("singleclick", async (e) => {
	if (Ng.checked && y_.size !== 0) try {
		let t = await H_(e.coordinate);
		if (t === null) return;
		K_(t, e.pixel);
	} catch (e) {
...
var Dv = !1, Ov = 0, kv = 0;
xg.addEventListener("pointerdown", (e) => {
	if (e.target.closest("button") !== null) return;
	e.preventDefault();
	let t = bg.getBoundingClientRect();
	Dv = !0, Ov = e.clientX - t.left, kv = e.clientY - t.top, xg.setPointerCapture(e.pointerId), bg.classList.add("dragging");
}), xg.addEventListener("pointermove", (e) => {
	if (!Dv) return;
	let t = rg.getBoundingClientRect();
	G_(e.clientX - t.left - Ov, e.clientY - t.top - kv);
});
function Av() {
	Dv = !1, bg.classList.remove("dragging");
}
xg.addEventListener("pointerup", Av), xg.addEventListener("pointercancel", Av);
function jv() {
	for (let e of Object.values(v_)) {
		e.setSource(null), cv.removeLayer(e);
		let t = $_.indexOf(e);
		t !== -1 && $_.splice(t, 1);
	}
	for (let e of Object.keys(v_)) delete v_[e];
	y_.clear(), x_.clear(), bg.hidden = !0, R_(), w_ = "type", T_ = null, E_ = [], D_.clear(), Z_.render(), d_.render(), X_.updateActionState();
}
async function Mv() {
	await Gm(), jv(), await N_();
}
function Nv() {
...
function Pv() {
	...
	r.searchParams.set("slide", __), r.searchParams.set("x", t[0].toFixed(2)), r.searchParams.set("y", t[1].toFixed(2)), r.searchParams.set("zoom", n.toString());
	let i = r.searchParams.toString().replace(/%2F/gi, "/");
	window.history.replaceState({}, "", `${r.pathname}?${i}${r.hash}`);
}
async function Fv() {
	if (p_ === null) throw Error("No TileServer session is available.");
	await Km(), jv(), await N_(), __ = null, g_ = null, f_.length = 0, m_ += 1, h_ += 1, ev.setSource(null), hv.setSource(null), d_.render();
	let e = [
		0,
		-1,
		1,
	...
	cv.setView(r), hv.setView(n, e), bv.setProjection(n, { preserveActive: !1 });
	let i = new URL(window.location.href);
	i.search = "", i.hash = "", window.history.replaceState({}, "", i), Ev(!1), lv.updateZoomLevel(), X_.updateActionState();
}
async function Iv(e) {
	if (p_ === null) throw Error("Dynamic slide switching requires a TileServer session.");
	jv(), await N_();
	let t = await Um(e);
	g_ = t, __ = e, X_.setSlide(e), X_.updateOverlaySelect(), X_.updateActionState(), m_ += 1;
	let n = tg(p_, t, m_), r = n.getTileGrid(), i = r.getExtent(), a = r.getResolutions(), o = new cn({
		code: "ZoomifyProjection",
		units: "pixels",
		extent: i,
	...
	c.fit(i, { size: cv.getSize() }), cv.setView(c), hv.setView(o, i), bv.setProjection(o), ev.setSource(n), hv.setSource(n), d_.render(), Ev(!0), Pv(), lv.updateZoomLevel();
}
d_.render();
async function Lv(e) {
	if (p_ === null || g_ === null) throw Error("Dynamic overlay loading requires a loaded slide.");
	...
	let n = [
		...
		"dat",
		"geojson"
	].includes(t), r = Gh(e), i = y_.has(r);
	if (r === "slide") throw Error("The overlay name \"slide\" is reserved.");
	let a = await qm(e, r);
	if (n) {
		y_.add(r);
		let e = [...new Set(a)];
		x_.set(r, e), R_(), await $h(b_, e, Zm, Y_), L_(e), w_ === "type" && await Xm(b_);
	} else i && (y_.delete(r), x_.delete(r), R_());
	n || i ? (await F_({ refresh: !1 }), await V_({ refresh: !1 }), B_(r)) : h_ += 1;
	let o = new Wu({
		url: `/tileserver/layer/${encodeURIComponent(r)}/${p_}/zoomify/{TileGroup}/{z}-{x}-{y}@1x.jpg?v=${h_}`,
		size: g_.slide_dimensions,
		crossOrigin: "anonymous",
		zDirection: -1
	});
	if (v_[r] !== void 0) v_[r].setSource(o), v_[r].setVisible(!0);
	else {
		let e = [ev, ...Object.values(v_)], t = Math.max(...e.map((e) => e.getZIndex() ?? 0)), n = new Co({
			title: r,
			source: o,
			opacity: .75
		});
		n.setZIndex(t + 1), v_[r] = n, cv.addLayer(n), $_.push(n);
	}
	return d_.render(), X_.updateActionState(), a;
}
async function Rv(e) {
	let t = v_[e], n = y_.has(e);
	...
	let i = $_.indexOf(t);
	i !== -1 && $_.splice(i, 1), y_.delete(e), x_.delete(e), delete v_[e], n && (R_(), await F_({ refresh: !1 }), await V_({ refresh: !1 }), B_()), d_.render(), X_.updateActionState();
}
async function zv(e) {
	if (y_.size === 0) throw Error("No annotation overlay is loaded.");
	let t = e instanceof Map ? [...e.entries()] : Object.entries(e), n = new Map(t);
	await Xm(n), b_.clear();
	for (let [e, t] of n) b_.set(e, t);
	B_();
}
Object.assign(window, {
	...
	loadOverlay: Lv,
	map: cv,
	mousePositionControl: dv,
	overlayLayers: v_,
	overviewMapControl: gv,
	projection: iv,
	removeOverlay: Rv,
	removeSlide: Fv,
	resolutions: nv,
	rotate: fv,
	scaleLineControl: pv,
	screenSpaceGraticule: yv,
	screenSpaceGraticuleToggle: Sv,
	setAnnotationColors: zv,
	switchSlide: Iv,
	view: sv
});
//#endregion
