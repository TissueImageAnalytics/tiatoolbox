...
Anyone wanting to contribute to this repository, please first look at our [Wiki](https://github.com/TIA-Lab/tiatoolbox/wiki) and at our web page for [contributors](https://github.com/TIA-Lab/tiatoolbox/blob/master/README.md). See also the section of this document [Prepare for development](##Prepare-for-development).
