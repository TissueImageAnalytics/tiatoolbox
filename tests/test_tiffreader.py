...
def test_handle_tiff_wsi_returns_tiff_reader(
    ...
    with patch(
        "tiatoolbox.wsicore.wsireader.base.TIFFWSIReader.__init__", return_value=None
    ):
        reader = wsireader.base._handle_tiff_wsi(
            input_path=tiff_path,
            mpp=(0.5, 0.5),
            power=20.0,
            post_proc=None,
...
def raise_openslide_error(*args: object, **kwargs: object) -> None:
    ...
    _ = kwargs
    msg = "mock error"
    raise wsireader.base.openslide.OpenSlideError(msg)
...
def test_handle_tiff_wsi_openslide_error(
    ...
    monkeypatch.setattr(
        wsireader.base.openslide.OpenSlide, "detect_format", lambda _: "SVS"
    )

    # Patch OpenSlideWSIReader to raise OpenSlideError
    monkeypatch.setattr(wsireader.base, "OpenSlideWSIReader", raise_openslide_error)
...
def test_handle_tiff_wsi_openslide_success(
    ...
    with patch.object(wsireader.base.OpenSlideWSIReader, "__init__", return_value=None):
