...
#
#     assert read_region_result.exit_code == 0
#     assert os.path.isfile(str(pathlib.Path(__file__).parent.joinpath("im_region3.jpg")))
#
#
...
# def test_command_line_save_tiles(_response_svs, _response_ndpi, _response_jp2):
