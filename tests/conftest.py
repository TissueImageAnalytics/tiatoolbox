...
def _sample_svs(tmpdir_factory):
    """Sample pytest fixture for svs images. Download svs image for pytest."""
...
def _sample_jp2(tmpdir_factory):
    """Sample pytest fixture for JP2 images. Download jp2 image for pytest."""
...
def _source_image(tmpdir_factory):
    """Sample pytest fixture for src image. Download src image image for pytest."""
...
@pytest.fixture(scope="session")
def _tcga_he_7130(tmpdir_factory):
    """Sample pytest fixture for TCGA-HE-7130-01Z-00-DX1 image.
...
@pytest.fixture(scope="session")
def _patch_extr_noheader(tmpdir_factory):
...
@pytest.fixture(scope="session")
def _patch_extr_read(tmpdir_factory):
...
@pytest.fixture(scope="session")
def _patch_extr_svs(tmpdir_factory):
...
@pytest.fixture(scope="session")
def _patch_extr_svs_read(tmpdir_factory):
