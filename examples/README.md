...
### 1- Reading Whole Slide Images ([01-wsi-reading.ipynb](./01-wsi-reading.ipynb))
...
### 1- Prediction of molecular pathways and key mutations in colorectal cancer from whole slide images ([idars.ipynb](./inference-pipelines/idars.ipynb))
